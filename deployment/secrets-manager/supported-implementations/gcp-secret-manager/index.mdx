...
sidebarTitle: Gcp secret manager
collate: false
---
...
<img noZoom src="/public/images/deployment/secrets-manager/supported-implementations/gcp-secret-manager/gcp-secret-manager-console.png" alt="gcp-secret-manager-console" />
