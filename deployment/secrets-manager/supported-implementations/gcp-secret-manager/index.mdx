...
description: Set up GCP Secret Manager as the secrets manager for OpenMetadata and configure the required permissions and deployment settings.
...
<img src="/public/images/deployment/secrets-manager/supported-implementations/gcp-secret-manager/gcp-secret-manager-console.png" alt="gcp-secret-manager-console" />
