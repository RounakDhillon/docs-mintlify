...
description: Use AWS Secrets Manager to integrate secret storage with your Collate, supporting encrypted access to service credentials.
...
<img noZoom src="/public/images/deployment/secrets-manager/supported-implementations/aws-secrets-manager/secrets-manager-console.png" alt="secrets-manager-console" />
