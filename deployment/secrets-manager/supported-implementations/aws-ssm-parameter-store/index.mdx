...
sidebarTitle: Aws ssm parameter store
collate: false
---
...
<img noZoom src="/public/images/deployment/secrets-manager/supported-implementations/aws-ssm-parameter-store/ssm-parameter-store-console.png" alt="ssm-parameter-store-console" /> 
