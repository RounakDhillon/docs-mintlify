...
<CardGroup cols={2}>
  <Card title="Docker Compose" icon="/images/icons/deploymentTile.svg" href="/deployment/docker">
    Single-node deployment for development and small teams
  </Card>
  <Card title="Kubernetes" icon="/images/icons/deploymentTile.svg" href="/deployment/kubernetes">
    Scalable deployment for production environments
  </Card>
  <Card title="AWS" icon="/images/icons/cloud.svg" href="/deployment/aws">
    Managed deployment on Amazon Web Services
  </Card>
  <Card title="GCP" icon="/images/icons/cloud.svg" href="/deployment/gcp">
