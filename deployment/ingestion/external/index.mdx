...
<CardGroup cols={2}>
<Card title="Airflow" href="/deployment/ingestion/external/airflow" >
  ...
  <Card title="GitHub Actions" href="/deployment/ingestion/external/github-actions" >
...
<Step title="Preparing the Workflow">
...
You can find more information about this workflow [here](/how-to-guides/guide-for-data-users/ingestion/lineage).
...
You can find more information about this workflow [here](/how-to-guides/data-quality-observability/profiler/profiler-workflow).
