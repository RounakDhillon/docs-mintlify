...
<img src="/public/images/deployment/security/enable-jwt/bot.png" alt="Bot settings page" /> 

Click on the `ingestion-bot`. The current token can be revoked, or you can create a new one.

<img src="/public/images/deployment/security/enable-jwt/bot-jwt-token.png" alt="Bot credentials edition" /> 
