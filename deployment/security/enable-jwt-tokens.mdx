---
title: Enable JWT Tokens | Collate Security Features
...
<img noZoom src="/public/images/deployment/security/enable-jwt/settings-bot.png" alt="Settings Page" /> 

<img noZoom src="/public/images/deployment/security/enable-jwt/bot.png" alt="Bot settings page" /> 

Click on the `ingestion-bot`. The current token can be revoked, or you can create a new one.

<img noZoom src="/public/images/deployment/security/enable-jwt/bot-jwt-token.png" alt="Bot credentials edition" /> 
