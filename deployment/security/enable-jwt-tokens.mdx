...
<img src="/images/v1.9/deployment/security/enable-jwt/settings-bot.png" alt="Settings Page" /> 

<img src="/images/v1.9/deployment/security/enable-jwt/bot.png" alt="Bot settings page" /> 

Click on the `ingestion-bot`. The current token can be revoked, or you can create a new one.

<img src="/images/v1.9/deployment/security/enable-jwt/bot-jwt-token.png" alt="Bot credentials edition" /> 
