...
<img noZoom src="/public/images/deployment/security/amazon-cognito-sso/create-server-credentials-1.png" alt="create-account" />
...
<img noZoom src="/public/images/deployment/security/amazon-cognito-sso/create-server-credentials-2.png" alt="create-account" />
...
<img noZoom src="/public/images/deployment/security/amazon-cognito-sso/create-server-credentials-3.png" alt="create-account" />
...
<img noZoom src="/public/images/deployment/security/amazon-cognito-sso/create-server-credentials-4.png" alt="create-account" />
...
<img noZoom src="/public/images/deployment/security/amazon-cognito-sso/create-server-credentials-5.png" alt="create-account" />
...
<img noZoom src="/public/images/deployment/security/amazon-cognito-sso/create-server-credentials-6.png" alt="create-account" />
...
<img noZoom src="/public/images/deployment/security/amazon-cognito-sso/create-server-credentials-7.png" alt="create-account" />

<img noZoom src="/public/images/deployment/security/amazon-cognito-sso/create-server-credentials-8.png" alt="create-account" />

After the applying these steps, you can update the configuration of your deployment:

<CardGroup cols={2}>
<Card title="Public Client" href="/deployment/security/amazon-cognito/public-client" >
  Configure Amazon Cognito SSO using the Public client type.
</Card>
<Card title="Confidential Client" href="/deployment/security/amazon-cognito/confidential-client" >
