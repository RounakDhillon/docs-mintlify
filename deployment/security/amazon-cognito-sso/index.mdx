...
<img src="/images/v1.9/deployment/security/amazon-cognito-sso/create-server-credentials-1.png" alt="create-account" />
...
<img src="/images/v1.9/deployment/security/amazon-cognito-sso/create-server-credentials-2.png" alt="create-account" />
...
<img src="/images/v1.9/deployment/security/amazon-cognito-sso/create-server-credentials-3.png" alt="create-account" />
...
<img src="/images/v1.9/deployment/security/amazon-cognito-sso/create-server-credentials-4.png" alt="create-account" />
...
<img src="/images/v1.9/deployment/security/amazon-cognito-sso/create-server-credentials-5.png" alt="create-account" />
...
<img src="/images/v1.9/deployment/security/amazon-cognito-sso/create-server-credentials-6.png" alt="create-account" />
...
<img src="/images/v1.9/deployment/security/amazon-cognito-sso/create-server-credentials-7.png" alt="create-account" />

<img src="/images/v1.9/deployment/security/amazon-cognito-sso/create-server-credentials-8.png" alt="create-account" />
