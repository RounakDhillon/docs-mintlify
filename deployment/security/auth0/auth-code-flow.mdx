...
<img src="/images/v1.9/deployment/security/auth0/auth-code-flow-1.png" alt="create-app" />
...
<img src="/images/v1.9/deployment/security/auth0/auth-code-flow-2.png" alt="credentials" />
