---
title: Enable SSL at the Collate Server
description: Configure SSL for the Collate server to enable HTTPS, protect authentication flows, and secure backend communications.
...
<img noZoom src="/public/images/deployment/security/enable-ssl/openmetadata-server/keystore-1.png" alt="keystore" />
...
<img noZoom src="/public/images/deployment/security/enable-ssl/openmetadata-server/keystore-2.png" alt="keystore" />
...
<img noZoom src="/public/images/deployment/security/enable-ssl/openmetadata-server/browser.png" alt="browser" />
...
<img noZoom src="/public/images/deployment/security/enable-ssl/openmetadata-server/import-1.png" alt="import" />

Double-click on `localhost`:

<img noZoom src="/public/images/deployment/security/enable-ssl/openmetadata-server/import-2.png" alt="import" />


Click on `Trust` to open and set `Always Trust`:

<img noZoom src="/public/images/deployment/security/enable-ssl/openmetadata-server/import-3.png" alt="import" />
