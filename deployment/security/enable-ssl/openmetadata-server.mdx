...
<img src="/images/v1.9/deployment/security/enable-ssl/openmetadata-server/keystore-1.png" alt="keystore" />
...
<img src="/images/v1.9/deployment/security/enable-ssl/openmetadata-server/keystore-2.png" alt="keystore" />
...
<img src="/images/v1.9/deployment/security/enable-ssl/openmetadata-server/browser.png" alt="browser" />
...
<img src="/images/v1.9/deployment/security/enable-ssl/openmetadata-server/import-1.png" alt="import" />

Double-click on `localhost`:

<img src="/images/v1.9/deployment/security/enable-ssl/openmetadata-server/import-2.png" alt="import" />


Click on `Trust` to open and set `Always Trust`:

<img src="/images/v1.9/deployment/security/enable-ssl/openmetadata-server/import-3.png" alt="import" />
