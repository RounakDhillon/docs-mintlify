...
<img src="/public/images/deployment/security/enable-ssl/openmetadata-server/keystore-1.png" alt="keystore" />
...
<img src="/public/images/deployment/security/enable-ssl/openmetadata-server/keystore-2.png" alt="keystore" />
...
<img src="/public/images/deployment/security/enable-ssl/openmetadata-server/browser.png" alt="browser" />
...
<img src="/public/images/deployment/security/enable-ssl/openmetadata-server/import-1.png" alt="import" />

Double-click on `localhost`:

<img src="/public/images/deployment/security/enable-ssl/openmetadata-server/import-2.png" alt="import" />


Click on `Trust` to open and set `Always Trust`:

<img src="/public/images/deployment/security/enable-ssl/openmetadata-server/import-3.png" alt="import" />
