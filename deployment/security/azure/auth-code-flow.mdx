...
<img noZoom src="/public/images/deployment/security/azure/create-web-registration.png" alt="create-app" />
...
<img noZoom src="/public/images/deployment/security/azure/web-client-secret.png" alt="create-app" />
...
<CardGroup cols={2}>
<Card title="Azure SSO - Public" href="/deployment/security/azure/public-client" >
  Configure Azure SSO using the Public client type.
</Card>
<Card title="Azure SSO - Confidential" href="/deployment/security/azure/confidential-client" >
