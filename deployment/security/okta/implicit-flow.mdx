---
title: Okta SSO | Collate Authentication Integration
...
<CardGroup cols={2}>
<Card title="Public Client" href="/deployment/security/okta/public-client" >
  Configure OKTA SSO using the Public client type.
</Card>
<Card title="Confidential Client" href="/deployment/security/okta/confidential-client" >
