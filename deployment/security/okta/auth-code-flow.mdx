---
title: Okta SSO (Docker) | Collate Deployment Guide
...
<img noZoom src="/public/images/deployment/security/okta/okta-auth-code-1.png" alt="configuring-the-app" />
...
- Click **Save**.
<img noZoom src="/public/images/deployment/security/okta/okta-auth-code-2.png" alt="general-settings-click-save" />

- The app is now configured.
<img noZoom src="/public/images/deployment/security/okta/okta-auth-code-3.1.png" alt="app-is-configured" />
<img noZoom src="/public/images/deployment/security/okta/okta-auth-code-3.2.png" alt="app-is-configured" />
...
<img noZoom src="/public/images/deployment/security/okta/click-security-api.png" alt="click-security-api" />

- From the **Authorization Servers** tab, click on **Add Authorization Server** button.
<img noZoom src="/public/images/deployment/security/okta/click-add-authorization-server.png" alt="click-add-authorization-server" />
...
- **Save** the changes.
<img noZoom src="/public/images/deployment/security/okta/add-auth-server-save-changes.png" alt="add-auth-server-save-changes" />
...
<img noZoom src="/public/images/deployment/security/okta/default-server.png" alt="default-server" />
...
<img noZoom src="/public/images/deployment/security/okta/click-auth-server-from-prev-step.png" alt="click-auth-server-from-prev-step" />

The Issuer URL shows up as Dynamic by default. Change the Issuer URL to Okta URL and save the changes.
<img noZoom src="/public/images/deployment/security/okta/change-issuer-url.png" alt="change-issuer-url" />

### Step 4: Create a Default Scope
- To create a default scope from **Security -> API**, click on the required **Authorization Server**.
<img noZoom src="/public/images/deployment/security/okta/click-req-auth-server.png" alt="click-req-auth-server" />

- In the resulting page, click on the **Scopes** tab
- Click on **Add Scope**
<img noZoom src="/public/images/deployment/security/okta/add-scope.png" alt="add-scope" />

- Set as a **Default Scope**.
<img noZoom src="/public/images/deployment/security/okta/set-default-scope.png" alt="set-default-scope" />
...
<img noZoom src="/public/images/deployment/security/okta/add-new-access-policy.png" alt="add-new-access-policy" />

- To create a policy, add a Name and Description.
- Assign the policy to the required clients.
<img noZoom src="/public/images/deployment/security/okta/assign-policy.png" />
...
<img noZoom src="/public/images/deployment/security/okta/add-rule.png" alt="add-rule" />
...
<img noZoom src="/public/images/deployment/security/okta/see-your-application.png" alt="see-your-application" />
...
<img noZoom src="/public/images/deployment/security/okta/deselect-user-consent.png" alt="deselect-user-consent" />
...
<img noZoom src="/public/images/deployment/security/okta/click-edit-token.png" alt="click-edit-token" />


After the applying these steps, you can update the configuration of your deployment:

<CardGroup cols={2}>
<Card title="Public" href="/deployment/security/okta/public-client" >
  Configure OKTA SSO using the Public client type.
</Card>
<Card title="Confidential" href="/deployment/security/okta/confidential-client" >
  Configure OKTA SSO using the Confidential client type.
</Card>
</CardGroup>
