---
title: Docker Deployment | Collate Container Setup
...
<img noZoom src="/public/images/deployment/docker/om_docker_architecture.png" alt="Docker Deployment Architecture" />
...
```bash
wget https://github.com/open-metadata/OpenMetadata/releases/download/1.9.7-release/docker-compose-openmetadata.yml
```
