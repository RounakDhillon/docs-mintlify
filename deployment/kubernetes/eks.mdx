---
title: AWS EKS Deployment | Collate Kubernetes Guide
description: Deploy the Collate on Amazon EKS for cloud-native scalability with secure identity integration and managed infrastructure support.
