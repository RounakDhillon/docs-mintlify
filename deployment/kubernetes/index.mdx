...
<img noZoom src="/public/images/deployment/kubernetes/kubernetes-architecture-prod.png" alt="Kubernetes Deployment Architecture" />
...
<Card
  ...
  <Card
    icon="cloud" iconType="solid"
    title="Deploy in OnPremises Kubernetes"
