...
description: Learn how to securely connect Collate to AWS RDS using IAM authentication with correct environment variables and configuration best practices.
slug: /deployment/rds-iam-auth
sidebarTitle: Rds iam auth
collate: false
---
