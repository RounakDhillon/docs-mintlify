---
title: Database Schema | Collate Schema
description: This schema defines the Database Schema entity. A Database Schema is a collection of tables, views, stored procedures, and other database objects.
slug: /main-concepts/metadata-standard/schemas/entity/data/databaseschema
sidebarTitle: DatabaseSchema
---
