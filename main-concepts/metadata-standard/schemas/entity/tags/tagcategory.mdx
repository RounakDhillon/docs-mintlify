---
title: TagCategory | Official Documentation
description: Schema defining a tag category and its hierarchy of primary and secondary tags.
slug: /main-concepts/metadata-standard/schemas/entity/tags/tagcategory
sidebarTitle: TagCategory
---

# Tag Category

*This schema defines the TagCategory entity. A tag category contains primary tags, and those primary tags can include secondary tags. Only two levels of tags are currently supported.*
