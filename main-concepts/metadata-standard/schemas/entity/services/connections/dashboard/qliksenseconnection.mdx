---
title: Qlik Sense Connection | Collate Qlik Sense
...
sidebarTitle: QlikSenseConnection
---
...
- **`displayUrl`** *(string, format: uri)*: Qlik Sense Base URL, used for generating dashboard & chat url.
