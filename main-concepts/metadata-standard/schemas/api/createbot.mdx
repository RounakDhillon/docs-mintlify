---
title: Create Bot API | Collate Bot Creation API
description: Create an automated bot user to perform operations like updating descriptions, responding to conversations, and managing metadata on behalf of integrations.
slug: /main-concepts/metadata-standard/schemas/api/createbot
sidebarTitle: CreateBot
---
