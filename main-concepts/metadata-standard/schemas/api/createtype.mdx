...
description: Connect Createtype to enable streamlined access, monitoring, or search of enterprise data using secure and scalable integrations.
slug: /main-concepts/metadata-standard/schemas/api/createtype
sidebarTitle: CreateType
---
