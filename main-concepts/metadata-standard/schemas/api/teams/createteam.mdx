---
title: Create Team API | Collate API for Creating Teams
description: Create a team entity with hierarchy, users, roles, and policies for organizing access control and collaboration within your organization.
slug: /main-concepts/metadata-standard/schemas/api/teams/createteam
sidebarTitle: CreateTeam
---
