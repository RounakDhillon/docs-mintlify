---
title: Create Persona API | Collate Persona API
description: Define a persona entity to represent user roles like Data Steward or Analyst, assigning users and linking them to specific functional domains.
slug: /main-concepts/metadata-standard/schemas/api/teams/createpersona
sidebarTitle: CreatePersona
---
