---
title: Create Tag API | Collate Tagging API
description: Create a new tag within a classification hierarchy with display name, description, styling, parent relationships, and mutually exclusive grouping options.
slug: /main-concepts/metadata-standard/schemas/api/classification/createtag
sidebarTitle: CreateTag
---
