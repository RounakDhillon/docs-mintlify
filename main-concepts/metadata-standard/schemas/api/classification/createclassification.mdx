---
title: Create Classification | Collate Classification API
description: Create a classification system for organizing tags with mutually exclusive or categorization behavior to control how entities are classified or categorized.
slug: /main-concepts/metadata-standard/schemas/api/classification/createclassification
sidebarTitle: CreateClassification
---
