---
title: TemplateValidationResponse | Official Documentation
description: Schema defining the response returned when validating an email template.
slug: /main-concepts/metadata-standard/schemas/email/templatevalidationreponse
sidebarTitle: TemplateValidationResponse
---
