---
title: samlSSOClientConfig | Collate SAML SSO Client
...
sidebarTitle: SamlSSOClientConfig
---
...
- **`idp`** *(object)*: This schema defines the identity provider configuration. Cannot contain additional properties.
...
- **`sp`** *(object)*: This schema defines the service provider configuration. Cannot contain additional properties.
...
- **`security`** *(object)*: This schema defines the security configuration for SAML. Cannot contain additional properties.
