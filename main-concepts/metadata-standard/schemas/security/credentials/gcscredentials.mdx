---
title: GCSCredentials | Collate GCS Credentials
description: Configure GCS credentials for Google Cloud Storage access using the supported credential formats.
slug: /main-concepts/metadata-standard/schemas/security/credentials/gcscredentials
sidebarTitle: GCSCredentials
---
