---
title: Custom Event Schema | Collate Custom Analytics Event
description: Track custom user interaction events like clicks and other actions, capturing URL, session ID, event type, and event value for behavioral analytics and engagement tracking.
