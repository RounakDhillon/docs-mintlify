...
description: Raw cost analysis data capturing entity lifecycle information and storage size in bytes for analyzing data storage costs and resource utilization patterns.
slug: /main-concepts/metadata-standard/schemas/analytics/reportdatatype/rawcostanalysisreportdata
sidebarTitle: RawCostAnalysisReportData
---
