---
title: Entity Report Data | Collate Entity Analytics Data
description: Aggregated analytics data for entity reporting, tracking metadata completeness, ownership, description coverage, and entity counts by service, team, and tier.
slug: /main-concepts/metadata-standard/schemas/analytics/reportdatatype/entityreportdata
sidebarTitle: EntityReportData
---
