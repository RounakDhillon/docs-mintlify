---
title: KPI Schemas | Collate KPI Metrics and Schema Details
description: A KPI entity defines a metric and a target.
...
*A `KPI` entity defines a metric and a target.*
