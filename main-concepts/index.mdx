...
<CardGroup>
  <Card icon="party-horn"
    iconType="solid"
    title="Why Open Metadata is the Right Choice for you?" href="https://blog.open-metadata.org/why-openmetadata-is-the-right-choice-for-you-59e329163cac">
...
<CardGroup>
  <Card icon="party-horn"
    iconType="solid"
    title="High Level Design" href="/main-concepts/high-level-design">
...
<CardGroup cols={2}>
  <Card icon="party-horn"
    iconType="solid"
    title="OpenMetadata Schemas" href="/main-concepts/metadata-standard/schemas">
    Review the standard that powers OpenMetadata with JSON Schema.
  </Card>
  <Card icon="square-list" iconType="solid" title="OpenMetadata APIs" href="/main-concepts/metadata-standard/apis">
