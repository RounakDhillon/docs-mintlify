...
<img src="/public/images/main-concepts/backend-db/db-diagram.png" alt="Backend DB Simplified Diagram" />
...
6. `targetFQNHash`: Hash of the target Entity FQN
