...
description: Optimize Collate Ingestion with multithreading workflows. Learn to configure parallel processing for faster metadata extraction and improved performance.
slug: /how-to-guides/guide-for-data-users/ingestion/workflows/metadata/multithreading
...
<img src="/public/images/features/ingestion/workflows/metadata/multithreading/example-diagram.png" alt="Example: 4 Threads" />
