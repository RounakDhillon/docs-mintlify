...
<img src="/images/v1.9/how-to-guides/discovery/kw.png" alt="Keyword Search" />
...
<img src="/images/v1.9/how-to-guides/discovery/kw2.png" alt="Filter using Multiple Parameters" />
...
<img src="/images/v1.9/how-to-guides/discovery/da1.png" alt="Filter by the Type of Data Asset" />
...
<img src="/images/v1.9/how-to-guides/discovery/owner.png" alt="Filter by Asset Owner" />
...
<img src="/images/v1.9/how-to-guides/discovery/db.png" alt="Filter by Database" />

## Filter based on Importance: Tiers
Using tiers, you can search for data based on importance.

<img src="/images/v1.9/how-to-guides/discovery/tier.png" alt="Filter based on Importance using Tiers" />
...
<img src="/images/v1.9/how-to-guides/discovery/usage.png" alt="Filter based on Importance: Usage" />
...
<img src="/images/v1.9/how-to-guides/discovery/fjt.png" alt="Frequently Joined Tables" />
...
<img src="/images/v1.9/how-to-guides/discovery/lineage.png" alt="Discover Assets through Relationships: Lineage" />
...
<img src="/images/v1.9/how-to-guides/discovery/data-discovery.gif" />

## Discover Data Evolution
By viewing lineage and metadata versioning, users can discover the data evolution of data assets.

<img src="/images/v1.9/how-to-guides/discovery/version.png" alt="Discover Data Evolution: Version History" />
...
<img src="/images/v1.9/how-to-guides/discovery/deleted.png" alt="Filter by Deleted Data Assets" />

Users can click on **Clear** to unselect all the filter options.
<img src="/images/v1.9/how-to-guides/discovery/clear.png" alt="Clear the Filters" />
