...
sidebarTitle: Get a Quick Glance of the Data Assets
---
...
<img noZoom src="/public/images/how-to-guides/discovery/prv8.png" alt="Basic Information about the Data Asset" />

Collate provides a quick preview of the data asset on the right side panel. Just click on the empty space next to the relevant data asset to get a quick preview. 
...
<img noZoom src="/public/images/how-to-guides/discovery/prv1.png" alt="Quick Glance of the Table Details" />
...
<img noZoom src="/public/images/how-to-guides/discovery/prv2.png" alt="Quick Glance of the Topic Details" />

For `ML Models`, it displays the **Algorithm, Target, Server, and Dashboard**.
<img noZoom src="/public/images/how-to-guides/discovery/prv3.png" alt="Quick Glance of the ML Model Details" />

A `glossary` preview displays the **Reviewers, Synonyms, and Children**.
<img noZoom src="/public/images/how-to-guides/discovery/prv4.png" alt="Quick Glance of the Glossary Term Details" />
...
<img noZoom src="/public/images/how-to-guides/discovery/prv5.png" alt="Quick Glance of the Data Quality and Profiler Metrics" />

## Tags

Users can view all the tags associated with a particular data asset.
<img noZoom src="/public/images/how-to-guides/discovery/prv6.png" alt="Quick Glance of the Tags" />

## Schema

The Schema provides the details on the **column names, type of column, and column description**.
<img noZoom src="/public/images/how-to-guides/discovery/prv7.png" alt="Quick Glance of the Schema" />
