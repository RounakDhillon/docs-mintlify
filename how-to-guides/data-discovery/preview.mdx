...
<img src="/images/v1.9/how-to-guides/discovery/prv8.png" alt="Basic Information about the Data Asset" />
...
<img src="/images/v1.9/how-to-guides/discovery/prv1.png" alt="Quick Glance of the Table Details" />
...
<img src="/images/v1.9/how-to-guides/discovery/prv2.png" alt="Quick Glance of the Topic Details" />

For `ML Models`, it displays the **Algorithm, Target, Server, and Dashboard**.
<img src="/images/v1.9/how-to-guides/discovery/prv3.png" alt="Quick Glance of the ML Model Details" />

A `glossary` preview displays the **Reviewers, Synonyms, and Children**.
<img src="/images/v1.9/how-to-guides/discovery/prv4.png" alt="Quick Glance of the Glossary Term Details" />
...
<img src="/images/v1.9/how-to-guides/discovery/prv5.png" alt="Quick Glance of the Data Quality and Profiler Metrics" />

## Tags

Users can view all the tags associated with a particular data asset.
<img src="/images/v1.9/how-to-guides/discovery/prv6.png" alt="Quick Glance of the Tags" />

## Schema

The Schema provides the details on the **column names, type of column, and column description**.
<img src="/images/v1.9/how-to-guides/discovery/prv7.png" alt="Quick Glance of the Schema" />
