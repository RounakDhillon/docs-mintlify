...
<img src="/public/images/how-to-guides/discovery/import1.png" alt="Import a Database Service" />
...
<img src="/public/images/how-to-guides/discovery/import2.png" alt="Upload the Database Service CSV file" />

5. You can now preview the uploaded Database Service CSV file and add or modify data using the inline editor.

<img src="/public/images/how-to-guides/discovery/import3.png" alt="Preview of the Database Service" />
...
<img src="/public/images/how-to-guides/discovery/import4.png" alt="Validate the updated Data Assets" />

7. The Database Service has been updated successfully, and you can now view the changes in the Database Service.

<img src="/public/images/how-to-guides/discovery/import5.png" alt="Database Service Import successful" />
...
<img src="/public/images/how-to-guides/discovery/import6.png" alt="Import a Database" />
...
<img src="/public/images/how-to-guides/discovery/import7.png" alt="Upload the Database CSV file" />

4. You can now preview the uploaded Database CSV file and add or modify data using the inline editor.

<img src="/public/images/how-to-guides/discovery/import8.png" alt="Preview of the Database" />
...
<img src="/public/images/how-to-guides/discovery/import9.png" alt="Validate the updated Data Assets" />

6. The Database has been updated successfully, and you can now view the changes in the Database.

<img src="/public/images/how-to-guides/discovery/import10.png" alt="Database Import successful" />
...
<img src="/public/images/how-to-guides/discovery/import11.png" alt="Import a Database Schema" />
...
<img src="/public/images/how-to-guides/discovery/import12.png" alt="Upload the Database Schema CSV file" />

4. You can now preview the uploaded Database Schema CSV file and add or modify data using the inline editor.

<img src="/public/images/how-to-guides/discovery/import13.png" alt="Preview of the Database Schema" />

5. Validate the updated Data Assets and confirm the changes. A success or failure message will then be displayed based on the outcome.

<img src="/public/images/how-to-guides/discovery/import14.png" alt="Validate the updated Data Assets" />

6. The Database Schema has been updated successfully, and you can now view the changes in the Database Schema.

<img src="/public/images/how-to-guides/discovery/import15.png" alt="Database Schema Import successful" />
...
<img src="/public/images/how-to-guides/discovery/import16.png" alt="Import a Table" />
...
<img src="/public/images/how-to-guides/discovery/import17.png" alt="Upload the Table CSV file" />

4. You can now preview the uploaded Table CSV file and add or modify data using the inline editor.

<img src="/public/images/how-to-guides/discovery/import18.png" alt="Preview of the Table" />

5. Validate the updated Data Assets and confirm the changes. A success or failure message will then be displayed based on the outcome.

<img src="/public/images/how-to-guides/discovery/import19.png" alt="Validate the updated Data Assets" />

6. The Table has been updated successfully, and you can now view the changes in the Table.

<img src="/public/images/how-to-guides/discovery/import20.png" alt="Table Import successful" />
