...
<iframe width="800" height="450" src="https://www.youtube.com/embed/thC9fRDmR_U?start=0&end=90" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>

## Automatic Detection of Relationships

Collate's [**metadata ingestion workflow**](/how-to-guides/guide-for-data-users/ingestion/workflows/metadata) identifies and extracts table relationships, ensuring that **primary key** and **foreign key** constraints are accurately represented. Once ingestion is completed, users can access ER diagrams at both the **table level** and **database schema level**.
...
<img src="/public/images/how-to-guides/discovery/table-relationships.png" alt="Visualizing Table Relationships" />
...
<img src="/public/images/how-to-guides/discovery/table-view.png" alt="Table View for Simplified Insights" />
