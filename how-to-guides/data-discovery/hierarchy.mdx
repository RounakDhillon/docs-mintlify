...
description: Learn to navigate and search data with the Hierarchical View in Collate. Expand layers, explore relationships, and access detailed asset information easily.
slug: /how-to-guides/data-discovery/hierarchy
sidebarTitle: Steps for Searching Using Hierarchy
---

# Steps for Searching Using Hierarchy

## Access the Hierarchy View:
- Navigate to the **Hierarchy View** within the Collate interface, where data is organized in a structured, layered manner.
...
<img noZoom src="/public/images/features/hierarchy.gif" />
