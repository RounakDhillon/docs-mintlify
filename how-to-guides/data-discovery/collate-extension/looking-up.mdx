...
slug: /how-to-guides/data-discovery/collate-extension/looking-up
sidebarTitle: Looking Up Data Assets and Accessing Details
---

# Looking Up Data Assets and Accessing Details

The Collate Chrome extension allows users to easily look up data assets and access detailed metadata directly from their web browser. This feature provides instant access to essential information about data assets, enabling users to better understand the data they are working with without leaving their current context.
...
<img noZoom src="/public/images/how-to-guides/discovery/looking-up-data.png" alt="Looking Up Data Assets" />
...
<img noZoom src="/public/images/how-to-guides/discovery/browser-extension-1.png" alt="Search for the Keyword in the Browser" />
...
### 4. Choose "Search in Collate"
Click on the "Search in Collate" option from the context menu.

<img noZoom src="/public/images/how-to-guides/discovery/browser-extension-2.png" alt="Search in Collate" />

### 5. View Search Results in Collate
The extension will initiate a search in Collate and display results based on the selected text. The search results may include:
...
<img noZoom src="/public/images/how-to-guides/discovery/browser-extension-3.png" alt="View Search Results in Collate" />
...
<img noZoom src="/public/images/how-to-guides/discovery/browser-extension-4.png" alt="Explore the Search Results" />

## Best Practices

- **Pin the Extension for Easy Access**: Pinning the Collate extension ensures that it is readily accessible whenever you need to view activity feeds, manage tasks, or look up data assets.
