...
sidebarTitle: How to Request for Tags
---

# How to Request for Tags

Apart from adding the tags directly to the data assets, users can also request to update tags. This is typically done when the user wants another opinion on the tag being added, or if the user does not have access to add tags directly. Requesting for a tag will create a Task in Collate.

- Click on the **?** icon next to tags

<img noZoom src="/public/images/how-to-guides/governance/tag8.png" alt="Request to Update Tags" />
...
- A Task will be created with some pre-populated details. Fill in the other important information:
 ...
 <img noZoom src="/public/images/how-to-guides/governance/task1.png" alt="Add a Task: Request to Update Tags" />
...
<img noZoom src="/public/images/how-to-guides/governance/task2.png" alt="Task: Accept Suggestion and Comment" />
...
<img noZoom src="/public/images/how-to-guides/governance/ct1.png" alt="Conversations around Tags" />
...
<img noZoom src="/public/images/how-to-guides/governance/ct2.png" alt="Start a Conversation" />

- Further in the conversation, users can **Reply** to discuss further as well as add **Reactions**, **Edit**, or **Delete**.

<img noZoom src="/public/images/how-to-guides/governance/ct3.png" alt="Conversation: Reply, React, Edit or Delete" />
