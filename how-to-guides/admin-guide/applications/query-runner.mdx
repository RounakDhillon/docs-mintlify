...
slug: /how-to-guides/admin-guide/applications/query-runner
sidebarTitle: Query Runner
---
...
<img noZoom src="/public/images/applications/query_runner/marketspace.png" alt="Query Runner in App Marketplace" />
...
<img noZoom src="/public/images/applications/query_runner/install_query_runner.png" alt="Install Query Runner Application" />

3. Click **Schedule** button → Select **On Demand** option

<img noZoom src="/public/images/applications/query_runner/on_demand.png" alt="Select On Demand Scheduling" />
...
<img noZoom src="/public/images/applications/query_runner/installation_success.png" alt="Installation Success Message" />
...
<img noZoom src="/public/images/applications/query_runner/sqlstudio_in_navigation.png" alt="SQL Studio in Navigation" />
