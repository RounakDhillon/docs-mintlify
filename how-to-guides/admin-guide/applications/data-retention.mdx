...
slug: /how-to-guides/admin-guide/applications/data-retention
sidebarTitle: Data Retention Application
collate: true
---
...
<img noZoom src="/public/images/applications/ret.png" alt="Install Data Retention Application" />

2. Select or install the **Data Retention** application.

<img noZoom src="/public/images/applications/ret1.png" alt="Install Data Retention Application" />

3. Configure the desired retention period.

<img noZoom src="/public/images/applications/ret2.png" alt="configuration" />

4. Run manually or let it operate on its default schedule.

<img noZoom src="/public/images/applications/ret3.png" alt="scheduling" />
