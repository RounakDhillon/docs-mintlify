...
<img src="/images/v1.9/how-to-guides/admin-guide/delete1.png" alt="Delete a Service Connection" />

To permanently delete the database, type DELETE and Confirm.
<img src="/images/v1.9/how-to-guides/admin-guide/delete2.png" alt="Permanently Delete the Database" />