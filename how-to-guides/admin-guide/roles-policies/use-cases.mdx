...
sidebarTitle: Use Cases - Creating Roles & Policies in Collate
---

# Use Cases: Creating Roles & Policies in Collate

Collate comes with default configurations such as the Organization Policy and Data Consumer Roles. These roles are setup to foster data collaboration.
...
<img noZoom src="/public/images/how-to-guides/roles-policies/policy1.png" alt="Creating Roles & Policies in Collate" />
...
A data steward in Collate should be able to create Glossaries and Glossary Terms and be able to view all data and manage it for governance purposes.
...
<img noZoom src="/public/images/how-to-guides/roles-policies/policy2.png" alt="Roles for Data Steward" />
...
<img noZoom src="/public/images/how-to-guides/roles-policies/policy3.png" alt="Team Only Policy" />
...
<img noZoom src="/public/images/how-to-guides/roles-policies/policy4.png" alt="PII Sensitive Tag Policy" />
