...
<img src="/images/how-to-guides/admin-guide/permission-debugger/permission1.png" alt="Select a User in Permission Debugger" />
...
<img src="/images/how-to-guides/admin-guide/permission-debugger/permission2.png" alt="Define the Permission Check" />

### 3. **Evaluate** Permission

Click the **Evaluate** button to perform the permission check.

<img src="/images/how-to-guides/admin-guide/permission-debugger/permission3.png" alt="Evaluate Permission" />

## Example 1: DENIED (EditAll on Table)

<img src="/images/how-to-guides/admin-guide/permission-debugger/permission4.png" alt="Permission Debugger Example: DENIED" />
...
<img src="/images/how-to-guides/admin-guide/permission-debugger/permission5.png" alt="Permission Debugger Example: ALLOWED" />
