...
sidebarTitle: Set up Data Observability Alerts and Notifications
---

import Email from '/snippets/how-to-guides/email.mdx'

# Set up Data Observability Alerts and Notifications

Collate has been providing alerts right from the start to notify users of important data lifecycle events: schema modifications, ownership shifts, and tagging updates. Users can define fine-grained alerts and notifications.
...
<img noZoom src="/public/images/how-to-guides/admin-guide/alert1.webp" alt="Create Observability Alerts" />

### Step 2
Configure your alert.

As with most configuration in Collate you will first need to add a **Name** and **Description** for your alert. Once this is completed, we can move on to the configuration. You have 4 steps to configure your alert:
...
<img noZoom src="/public/images/how-to-guides/admin-guide/source.webp" alt="Specify the Data Asset" />
...
<img noZoom src="/public/images/how-to-guides/admin-guide/filter.webp" alt="Define the Filter" />

<img noZoom src="/public/images/how-to-guides/admin-guide/filter2.webp" alt="Include/Exclude the Filter" />
...
<img noZoom src="/public/images/how-to-guides/admin-guide/trigger.webp" alt="Select Important Trigger Events" />

4. **Destination**: Specify the destination for the alerts. Collate supports sending alerts to the users within Collate, i.e., **Internal** such as Admins, Followers, Owners, Teams and Users.

<img noZoom src="/public/images/how-to-guides/admin-guide/internal.webp" alt="Send Alerts to the Users and Teams within Collate" />
...
<img noZoom src="/public/images/how-to-guides/admin-guide/external.webp" alt="Send Alerts to Email, Slack, Teams, G Chat, & Webhooks" />
...
<img noZoom src="/public/images/how-to-guides/admin-guide/notify.webp" alt="Add Notifications for Change Events" />

<img noZoom src="/public/images/how-to-guides/admin-guide/alert2.webp" alt="Add an Alert" />
...
<img noZoom src="/public/images/how-to-guides/admin-guide/source2.webp" alt="Specify the Data Asset" />
...
<img noZoom src="/public/images/how-to-guides/admin-guide/filter3.webp" alt="Define the Filter" />

3. **Destination**: Specify the destination for the notifications. Collate supports sending notifications to the users within Collate, i.e., **Internal** such as Admins, Followers, Owners, Teams and Users. Notifications can be sent to **External** sources like Email, G Chat, Generic Webhooks, MS Teams, and Slack. Add the endpoint URL for the destinations. Notifications can be sent to multiple destinations.
...
For these destinations type (Webhook, Slack, Microsoft Teams, Google Chat), Collate provides **Advanced Configuration** options that allow you to customize the request details sent to the destination endpoint.
