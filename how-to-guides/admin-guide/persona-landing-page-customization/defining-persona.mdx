...
<img src="/images/v1.9/how-to-guides/admin-guide/persona-1.png" alt="Settings > Personas" />

2. **Create a new persona** or modify an existing one.

<img src="/images/v1.9/how-to-guides/admin-guide/persona-3.png" alt="create a new persona*" />

3. **Associate users** with the appropriate persona to customize their experience based on their roles.

<img src="/images/v1.9/how-to-guides/admin-guide/persona-4.png" alt="Associate users" />
