...
<img src="/images/v1.9/how-to-guides/admin-guide/landing-1.png" alt="Set Up Personas" />

<img src="/images/v1.9/how-to-guides/admin-guide/landing-2.png" alt="Customize Landing Page" />

2. **Select a Persona**:  
   Customize a landing page for a specific persona (e.g., data consumer) by adding, removing, or rearranging panels.

<img src="/images/v1.9/how-to-guides/admin-guide/landing-3.png" alt="Select a Persona" />
...
<img src="/images/v1.9/how-to-guides/admin-guide/landing-4.png" alt="Pluggable Panels" />

4. **Rearrange and Save**:  
   Adjust the layout based on user preferences and save the configuration.

<img src="/images/v1.9/how-to-guides/admin-guide/landing-5.png" alt="Rearrange and Save" />
