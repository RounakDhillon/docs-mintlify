...
sidebarTitle: How to Customize a Landing Page
---

# Customizable Landing Page with Pluggable Panels

Collate's customizable landing page allows admins to tailor the layout based on the user's persona, providing a more relevant and enriched experience. The landing page is built using **pluggable panels**, which can be added, removed, or rearranged to meet the unique needs of different personas, such as **data scientists**, **data engineers**, or **data stewards**.
...
<img noZoom src="/public/images/how-to-guides/admin-guide/landing-1.png" alt="Set Up Personas" />

2. **Select a Persona**:
   Customize a landing page for a specific persona (e.g., data steward) and then select homepage to customize it.

<img noZoom src="/public/images/how-to-guides/admin-guide/landing-3.png" alt="Select a Persona" />

<img noZoom src="/public/images/how-to-guides/admin-guide/landing-2.png" alt="Customize Landing Page" />

3. Click on Add widget

<img noZoom src="/public/images/how-to-guides/admin-guide/landing-5.png" alt="Select Homepage" />
...
<img noZoom src="/public/images/how-to-guides/admin-guide/landing-4.png" alt="Pluggable Panels" />

4. **Rearrange and Save**:
   Adjust the layout based on user preferences and save the configuration.

<img noZoom src="/public/images/how-to-guides/admin-guide/landing-6.png" alt="Rearrange and Save" />
...
Collate plans to expand persona-based customization beyond landing pages to **entity pages** as well. For example:
