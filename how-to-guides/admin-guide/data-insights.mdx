...
<img src="/images/v1.9/how-to-guides/admin-guide/data-insights1.png" alt="Data Insights Application" />

- If not, click `Add Apps` and install **Data Insights Application**.

<img src="/images/v1.9/how-to-guides/admin-guide/data-insights2.png" alt="Add Apps" />

### 2. Run the Data Insights Application

- Click `Configure` to set parameters.

<img src="/images/v1.9/how-to-guides/admin-guide/data-insights3.png" alt="Configure to set parameters" />

- Click `Schedule` to define execution timing.

<img src="/images/v1.9/how-to-guides/admin-guide/data-insights4.png" alt="Schedule" />

- Click `Run Now` to execute the Data Insights workflow.

<img src="/images/v1.9/how-to-guides/admin-guide/data-insights5.png" alt="Data Insights workflow" />
...
<img src="/images/v1.9/how-to-guides/admin-guide/data-insights6.png" alt="Backfill Configuration" />
