...
<img src="/images/how-to-guides/teams-and-users/add-user3.png" alt="Team & User Management" />

<img src="/images/how-to-guides/teams-and-users/add-user3.1.png" alt="Teams" />

<img src="/images/how-to-guides/teams-and-users/change-team1.png" alt="Digital_Marketing Team" />

**2.** On the `Digital_Marketing` team details page, you will see the `Type - Department` with an edit icon.

<img src="/images/how-to-guides/teams-and-users/change-team2.png" alt="Type - Department" />

**3.** Click on the edit button. You will get a set of options, from which you can select `Division`.Click on ✅ to save it.

<img src="/images/how-to-guides/teams-and-users/change-team3.png" alt="select-team-type" />
