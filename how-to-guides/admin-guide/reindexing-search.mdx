...
sidebarTitle: Reindexing Search
---

import Reindex from '/snippets/deployment/reindex.mdx'
...
<img noZoom src="/public/images/deployment/upgrade/reindex.png" alt="Reindex Configuration" />
