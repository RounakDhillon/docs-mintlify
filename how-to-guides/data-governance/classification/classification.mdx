...
description: Get an overview of classification features to understand how data is organized, labeled, and governed across your Collate.
slug: /how-to-guides/data-governance/classification/overview
sidebarTitle: Overview of Classification
---
...
## Classification in Collate

For Classification in Collate, we use a flat list of terms from knowledge organization systems. Classification groups together a set of similar terms called **Tags**, which can be accessed from **Govern > Classification**.

In the below example, PersonalData is a Classification and it further has Tags under it. `PersonalData` is also a **System** Classification. System classifications are an important part of Collate and therefore cannot be deleted. The descriptions for the System tags can be modified. They can also be disabled. `PII` and `Tiers` are the other important system classifications in Collate.

<img noZoom src="/public/images/how-to-guides/governance/tag4.png" alt="Classification: Groups together Tags" />

## Classification and Categorization Tags

Collate supports both Classification and Categorization tags.
...
<Tip>
**Pro Tip:** The Global Search in Collate also helps discover related Glossary Terms and Tags.
<img noZoom src="/public/images/how-to-guides/governance/tag1.png" alt="Search for Glossary Terms and Tags" />
</Tip>
...
Collate has extensive classification APIs to automate tagging. These APIs support two kinds of entities - Classification and Tags. These entities are identified by a Unique ID. Tags have a fully qualified name in the form of `classification.tagTerm`

Refer the **[API Documentation on Classification](https://sandbox.open-metadata.org/docs#tag/Classifications)**.

<Card title="How to Classify Data Assets" href="/how-to-guides/data-governance/classification/assets" >
