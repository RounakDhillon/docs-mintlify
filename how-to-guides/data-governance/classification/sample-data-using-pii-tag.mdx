...
<img src="/images/v1.9/how-to-guides/governance/pii-tags.png" alt="PII Tag Application at Column Level" />

- If a **PII tag** is applied at the **table level**:
  - **All columns** within that table will have their sample data masked automatically.

<img src="/images/v1.9/how-to-guides/governance/pii-tags2.png" alt="PII Tag Application at Table Level" />
...
<img src="/images/v1.9/how-to-guides/governance/pii-tags1.png" alt="PII.Sensitive Tagging" />
