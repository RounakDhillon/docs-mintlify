...
sidebarTitle: Best Practices for Classification
---
...
When classification tags have typos, users tend to delete the term. All the effort spent in tagging the data assets is lost when terms are deleted. Collate supports renaming Classification tags. Simply rename them.
