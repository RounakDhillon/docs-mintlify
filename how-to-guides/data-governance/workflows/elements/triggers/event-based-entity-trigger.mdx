...
sidebarTitle: Event Based Entity Trigger
collate: true
---
...
<img noZoom src="/public/images/how-to-guides/governance/workflows-event-based-entity-trigger.png" alt="event-based-entity-trigger-example" />
