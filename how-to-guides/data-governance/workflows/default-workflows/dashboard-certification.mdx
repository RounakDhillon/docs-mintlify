...
<img src="/images/v1.9/how-to-guides/governance/workflows-table-certification.png" alt="dashboard-certification" />
...
<img src="/images/v1.9/how-to-guides/governance/workflows-table-certification3.png" />

- On a **scheduled basis** (e.g., daily, weekly)
- **On-demand** via the user interface

<img src="/images/v1.9/how-to-guides/governance/workflows-table-certification1.png" alt="dashboard-certification-trigger" />
