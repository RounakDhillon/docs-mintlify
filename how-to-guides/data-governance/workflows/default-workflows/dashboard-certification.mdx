...
sidebarTitle: Dashboard Certification Workflow
collate: true
---
...
<img noZoom src="/public/images/how-to-guides/governance/workflows-table-certification.png" alt="dashboard-certification" />
...
<img noZoom src="/public/images/how-to-guides/governance/dashboard-asset-selection.png" alt="dashboard-certification-workflow" />

- On a **scheduled basis** (e.g., daily, weekly)

<img noZoom src="/public/images/how-to-guides/governance/dashboard-schedule.png" alt="dashboard-certification-trigger" />

- **On-demand** via the user interface

<img noZoom src="/public/images/how-to-guides/governance/workflows-table-certification1.png" alt="dashboard-certification-trigger" />
