---
title: Data Governance Glossary Troubleshooting | Collate Guide
...
**Issue:**  
When running Collate behind NGINX with SSL (HTTPS proxy to port 8585), glossary bulk import and export operations may remain stuck in the "Import is in progress" state.
