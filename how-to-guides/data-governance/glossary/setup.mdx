...
sidebarTitle: How to Setup a Glossary
---

# How to Setup a Glossary

To create a glossary manually in Collate:
...
<img noZoom src="/public/images/how-to-guides/governance/owner.png" alt="Add Owner and Reviewers" />
...
<Card title="How to Create Glossary Terms" href="/how-to-guides/data-governance/glossary/create-terms" >
    Setup Glossary Terms to define the terminology. Add tags, synonyms, related terms, links, etc.
  </Card>

<Card title="How to Bulk Import a Glossary" href="/how-to-guides/data-governance/glossary/import" >
    Save time and effort by bulk uploading glossary terms using a CSV file.
  </Card>

<Card title="How to Add Assets to Glossary Terms" href="/how-to-guides/data-governance/glossary/assets" >
