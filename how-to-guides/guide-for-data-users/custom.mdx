...
sidebarTitle: How to Create a Custom Property for a Data Asset
---

# How to Create a Custom Property for a Data Asset

Collate uses a schema-first approach, and that's why we support custom properties for all types of data assets. Organizations can extend the attributes as required to capture custom metadata. You can view the Custom Properties tab in the detailed view for all types of data assets.
...
To create a Custom Property in Collate:
- Navigate to **Settings** >> **Custom Properties**
- Click on the type of data asset you would like to create a custom property for.
- Click on **Add Property**

<img noZoom src="/public/images/how-to-guides/discovery/custom1.png" alt="Create a Custom Property" />
...
<img noZoom src="/public/images/how-to-guides/discovery/custom2.png" alt="Define a Custom Property" />
...
<img noZoom src="/public/images/how-to-guides/discovery/custom4.png" alt="Delete a Custom Property" />
