...
slug: /how-to-guides/guide-for-data-users/ingestion/workflows/dbt
...
<CardGroup cols={3}>
<Card title="Configure dbt workflow from OpenMetadata UI" href="/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/configure-dbt-workflow" >
    Configure the dbt Workflow.
  </Card>

<Card title="Run dbt Workflow Externally" href="/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/run-dbt-workflow-externally" >
    Configure the dbt Workflow from the CLI.
  </Card>

<Card title="Auto Ingest dbt Artifacts (dbt-core)" href="/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/auto-ingest-dbt-core" >
...
For more information on how lineage is extracted from dbt take a look [here](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-lineage)
...
Please refer [here](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-tags) for adding dbt tags
...
Please refer [here](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-owner) for adding dbt owner
...
For more information and to control how the table and column descriptions are updated from dbt please take a look [here](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-descriptions)
...
Please refer [here](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-tier) for adding dbt tiers
...
Please refer [here](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-glossary) for adding dbt glossary
...
For any issues please refer to the troubleshooting documentation [here](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/dbt-troubleshooting)
