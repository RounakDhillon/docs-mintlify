---
title: dbt Troubleshooting | Collate Integration Support
description: Troubleshoot dbt ingestion for configuration issues, parsing errors, or incomplete metadata syncing.
slug: /how-to-guides/guide-for-data-users/ingestion/workflows/dbt/dbt-troubleshooting
sidebarTitle: dbt troubleshooting
---
...
- Follow to docs [here](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-lineage) to see if necessary details are present in the manifest.json file.
