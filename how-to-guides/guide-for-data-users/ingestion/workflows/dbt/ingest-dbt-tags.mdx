---
title: Ingest Tags from dbt | Collate Metadata Tagging Guide
description: Ingest dbt tags to enhance metadata with labels that support classification, governance, and searchability.
slug: /how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-tags
sidebarTitle: Ingest dbt Tags
---
...
<img src="/public/images/features/ingestion/workflows/dbt/dbt-features/dbt-tags.png" alt="dbt_tags" />
