---
title: Ingest Tiers from dbt | Collate Data Tiering Guide
description: Ingest dbt tier metadata to support quality scoring and classification for critical datasets and models.
slug: /how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-tier
sidebarTitle: Ingest dbt Tiers
---
...
<img src="/public/images/features/ingestion/workflows/dbt/dbt-features/dbt-tier.png" alt="dbt_tier" />
