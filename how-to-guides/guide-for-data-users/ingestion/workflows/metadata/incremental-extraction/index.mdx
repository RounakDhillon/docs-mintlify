...
slug: /how-to-guides/guide-for-data-users/ingestion/workflows/metadata/incremental-extraction
...
We implemented the Incremental Extraction feature to improve performance by reducing the extraction and comparison of unneeded data.
...
<Card title="BigQuery" icon="/public/images/connectors/bigquery.webp" href="/how-to-guides/guide-for-data-users/ingestion/workflows/metadata/incremental-extraction/bigquery" horizontal>
  **BETA** | OpenMetadata
</Card>
<Card title="Redshift" icon="/public/images/connectors/redshift.webp" href="/how-to-guides/guide-for-data-users/ingestion/workflows/metadata/incremental-extraction/redshift" horizontal>
  **BETA** | OpenMetadata
</Card>
<Card title="Snowflake" icon="/public/images/connectors/snowflakes.webp" href="/how-to-guides/guide-for-data-users/ingestion/workflows/metadata/incremental-extraction/snowflake" horizontal>
  **BETA** | OpenMetadata
</Card>
