---
title: Lineage Workflow | Collate Data Lineage Guide
description: Discover how to set up data lineage workflows in Collate. Learn to track data flow, configure connectors, and visualize dependencies across your data pipeline.
slug: /how-to-guides/guide-for-data-users/ingestion/workflows/lineage
...
<CardGroup cols={1}>
<Card title="Lineage Workflow through Query Logs" href="/how-to-guides/guide-for-data-users/ingestion/workflows/lineage/lineage-workflow-query-logs" >
...
<img src="/public/images/features/ingestion/workflows/lineage/table-entity-page.png" alt="table-entity-page" />
...
<img src="/public/images/features/ingestion/workflows/lineage/add-ingestion.png" alt="add-ingestion" />

### 2. Configure the Lineage Ingestion

Here you can enter the Lineage Ingestion details:

<img src="/public/images/features/ingestion/workflows/lineage/configure-lineage-ingestion.png" alt="configure-lineage-ingestion" />
...
<img src="/public/images/features/ingestion/workflows/lineage/scheule-and-deploy.png" alt="schedule-and-deploy" />
