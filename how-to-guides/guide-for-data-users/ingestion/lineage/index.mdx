---
title: Lineage Ingestion | Collate Data Lineage Setup Guide
description: Track data lineage using Collate connectors. Visualize flow, dependencies, and transformations across your entire data ecosystem.
slug: /how-to-guides/guide-for-data-users/ingestion/lineage
...
![gif](/public/images/features/ingestion/lineage/lineage-ingestion.gif)
...
![query-parser](/public/images/features/ingestion/lineage/query-parser.png)
...
the [workflow](/how-to-guides/guide-for-data-users/ingestion/workflows/usage/usage-workflow-query-logs).
...
<img src="/public/images/features/ingestion/lineage/dashboard-ingestion-lineage.png" alt="Dashboard Lineage" />
...
<CardGroup cols={1}>
<Card title="Manual Lineage" href="/how-to-guides/guide-for-data-users/ingestion/lineage/edit-lineage-manually" >
