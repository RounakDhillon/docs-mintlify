...
slug: /how-to-guides/guide-for-data-users/ingestion/great-expectations
...
- `config_file_path`: this is the path to your `config.yaml` file that holds the configuration of your Collate server
