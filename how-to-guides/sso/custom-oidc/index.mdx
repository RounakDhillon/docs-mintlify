---
title: Custom OIDC SSO Configuration | Collate
description: Step-by-step guide to configure Custom OIDC-based SSO using ADFS, Okta, or Shibboleth for secure enterprise authentication and federated login in Collate.
slug: /how-to-guides/sso/custom-oidc
sidebarTitle: Custom OIDC SSO 
---
...
<img noZoom src="/public/images/deployment/security/custom-oidc/custom1.png" alt="Custom OIDC Configuration" />
...
- **Definition:** Maps JWT claims to Collate user profile fields.
