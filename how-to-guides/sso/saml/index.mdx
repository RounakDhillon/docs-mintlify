---
title: SAML SSO Configuration | Collate
description: Step-by-step guide to configure SAML-based SSO using ADFS, Okta, or Shibboleth for secure enterprise authentication and federated login in Collate.
slug: /how-to-guides/sso/saml
...
<img noZoom src="/public/images/deployment/security/saml/saml1.png" alt="SAML SSO Configuration" />
