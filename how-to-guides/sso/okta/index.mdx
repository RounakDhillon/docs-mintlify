...
Okta Single Sign-On (SSO) enables users to log in to Collate with their Okta credentials using **OAuth 2.0** and **OpenID Connect (OIDC)** protocols.
...
<img noZoom src="/public/images/deployment/security/okta/okta2.png" alt="Okta SSO Configuration - Confidential Client" />
