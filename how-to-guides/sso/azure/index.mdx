...
slug: /how-to-guides/sso/azure
sidebarTitle: Azure SSO
collate: false
---
...
<img noZoom src="/public/images/deployment/security/azure/azure2.png" alt="Azure AD SSO Configuration - Confidential Client" />
...
- **Definition:** Maps JWT claims to Collate user fields.
- **Example:**
  ```json
  ["email:email", "name:displayName", "firstName:given_name"]
- **Why it matters:** Controls user profile mapping in Collate.
