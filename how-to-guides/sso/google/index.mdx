...
<img noZoom src="/public/images/deployment/security/google/google2.png" alt="Google SSO Configuration - Confidential Client" />
...
- **Why it matters:** Maps identity information to Collate user profiles.
