...
This is an example YAML of a Data Contract applied to a table in Collate. Note that while Collate brings full UI support for creating and managing Data Contracts, you can still use the API to manage them programmatically.
...
<Card title="Creating Data Contracts" href="/how-to-guides/data-contracts/create" >
    Create Data Contracts in the Collate UI.
  </Card>
