...
<img src="/images/v1.9/how-to-guides/contracts/create1.png" alt="Adding a Data Contract to an OpenMetadata Table" />
...
<img src="/images/v1.9/how-to-guides/contracts/create2.png" alt="Adding Contract Details" />
...
<img src="/images/v1.9/how-to-guides/contracts/create3.png" alt="Selecting a schema for an OpenMetadata Data Contract" />
...
<img src="/images/v1.9/how-to-guides/contracts/create4.png" alt="Adding rules to an OpenMetadata Data Contract" />

- Once a rule is created, you can **+ Add New Rule** to create more, or select **Quality**

<img src="/images/v1.9/how-to-guides/contracts/create5.png" alt="Adding more rules to an OpenMetadata Data Contract" />
...
<img src="/images/v1.9/how-to-guides/contracts/create6.png" alt="Adding data quality tests to an OpenMetadata Data Contract" />

- Once your new data contract has been created successfully, you can run it by selecting **> Run now**

<img src="/images/v1.9/how-to-guides/contracts/create7.png" alt="Running an OpenMetadata Data Contract" />
