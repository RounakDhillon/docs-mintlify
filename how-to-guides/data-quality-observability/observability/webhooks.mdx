...
In 0.13.1 , webhooks have been deprecated. You should instead use [Collate alerts](/how-to-guides/data-quality-observability/observability/alerts)
...
Collate provides out-of-the-box support for webhooks.
Collate also allows the user to customise the webhook with a wide range of filters to listen to only selected type of events.


## Collate supports 4 webhook types:
1. **Generic**
2. **Slack**
3. **Microsoft Teams**
4. **Google Chat**
...
<img noZoom src="/public/images/how-to-guides/observability/webhook.png" alt="Generic Webhook" />
...
<img noZoom src="/public/images/how-to-guides/observability/gchat.png" alt="Gchat Webhook" />