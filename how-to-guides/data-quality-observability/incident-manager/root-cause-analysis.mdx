---
title: Root Cause Analysis | Collate Incident Management
...
<img noZoom src="/public/images/features/ingestion/workflows/data-quality/sample-row-failure-deletion.png" alt="set compute row count" />

### Example

<img noZoom src="/public/images/features/ingestion/workflows/data-quality/set_compute_row_count.png" alt="set compute row count" />

![test definition](/public/images/features/ingestion/workflows/data-quality/failed_rows_sample_1.png)
![failed rows sampls](/public/images/features/ingestion/workflows/data-quality/failed_rows_sample_2.png)
...
## Inspection Query
 ...
 ![inspection query](/public/images/features/ingestion/workflows/data-quality/inspection-query.png)