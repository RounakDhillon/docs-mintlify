---
title: Test Library | Custom SQL-Based Data Quality Tests
...
slug: /how-to-guides/data-quality-observability/quality/test-library
sidebarTitle: Test Library
---
...
<img src="/public/images/how-to-guides/quality/rule_library_main_page.png" alt="Test Library Main Page" />
...
<img src="/public/images/how-to-guides/quality/rule_library_edit_test.png" alt="Test Definition Form" />
...
| **Test Platforms** | The platforms that can execute this test (e.g., Collate, dbt, Soda) | Yes |
| **Parameters** | User-defined arguments for the SQL expression | No |

<Note>
**Important:** If you want the test to run natively within Collate, the **Test Platforms** field must include `Collate`. Tests configured with other platforms (e.g., dbt, Soda, GreatExpectations) are intended for tracking results from external test frameworks and will not be executed by Collate's data quality engine.
</Note>
...
<img src="/public/images/how-to-guides/quality/rule_library_disabled_test.png" alt="Disabled Test Definition" />
