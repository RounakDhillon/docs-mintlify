...
sidebarTitle: Dimensional Validation
---
...
This guide walks you through creating your first dimensional test from the Collate UI and will focus only on the specifics of the dimensional tests.
...
<img src="/public/images/how-to-guides/quality/dimensional-add-test.png" alt="Dimensional Level" />
...
<img src="/public/images/how-to-guides/quality/dimensional-select-test.png" alt="Configure Test" />
...
<img src="/public/images/how-to-guides/quality/dimensional-results.png" alt="View Dimensional Results" />
...
<img src="/public/images/how-to-guides/quality/dimensional-trends.png" alt="Dimensional Quality Trends" />
...
For detailed sampling configuration, see [Profiler Workflow - Profile Sample](/how-to-guides/data-quality-observability/profiler/profiler-workflow#profiler-options).

### Use Partitioning

For large tables with partitioning columns, enable **partitioning** to focus tests on meaningful data
For detailed partitioning configuration, see [Profiler Workflow - Enable Partition](/how-to-guides/data-quality-observability/profiler/profiler-workflow#profiler-options).
