...
sidebarTitle: Adding test cases
---
...
**Note:** you will need to make sure you have the right permission in Collate to create a test.
...
<img noZoom src="/public/images/features/ingestion/workflows/data-quality/add-test-case.png" alt="Write your first test" />
...
<img noZoom src="/public/images/features/ingestion/workflows/data-quality/add-test-defintion.png" alt="Write your first test" />
...
<img noZoom src="/public/images/features/ingestion/workflows/data-quality/add-ingestion.png" alt="Create an ingestion pipeline" />

<img noZoom src="/public/images/features/ingestion/workflows/data-quality/ingestion-page.png" alt="Schedule you test execution" />
