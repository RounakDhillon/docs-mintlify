...
2. **From OpenMetadata**: Load test definitions configured in the Collate UI
...
<CardGroup cols={2}>
  ...
  <Card
    title="TestRunner – Table Testing"
  ...
  <Card
    title="Run Tutorials with Examples"
...
2. **Execution Engine**: Leverages Collate's proven test execution engine
