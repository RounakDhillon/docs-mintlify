...
sidebarTitle: Adding test suites
---
...
<img noZoom src="/public/images/features/ingestion/workflows/data-quality/profiler-tab-view.png" alt="Write your first test" />


On the next page, enter the name and description (optional) of your test suite.

<img noZoom src="/public/images/features/ingestion/workflows/data-quality/test-suite-page.png" alt="Create test suite" />
...
<img noZoom src="/public/images/features/ingestion/workflows/data-quality/test-case-page.png" alt="Create test case" />
