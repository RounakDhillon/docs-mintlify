---
title: Spark Engine Prerequisites | Collate Spark Profiling Setup
description: Learn about the required infrastructure, network connectivity, and setup for using Spark Engine in Collate.
