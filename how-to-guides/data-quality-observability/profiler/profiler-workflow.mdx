...
<img src="/images/v1.9/features/ingestion/workflows/profiler/profiler-summary-table.png" alt="Table profile summary page" />

<img src="/images/v1.9/features/ingestion/workflows/profiler/profiler-summary-column.png" alt="Column profile summary page" />

### 1. Add a Profiler Agent
From the Service Page, go to the Agents tab to add a new ingestion and click on Add Profiler Agent.

<img src="/images/v1.9/features/ingestion/workflows/profiler/add-profiler-workflow.png" alt="Add a profiler service" />

### 2. Configure the Profiler Agent
Here you can enter the Profiler Agent details.

<img src="/images/v1.9/features/ingestion/workflows/profiler/configure-profiler-workflow.png" alt="Set profiler configuration" />
...
<img src="/images/v1.9/features/ingestion/workflows/profiler/accessing-table-profile-settings.png" alt="table profile settings" />

<img src="/images/v1.9/features/ingestion/workflows/profiler/table-profile-summary-view.png" alt="table profile settings" />
...
<img src="/images/v1.9/features/ingestion/workflows/profiler/profiler-global-configuration.png" alt="table profile global settings" />
...
<img src="/images/v1.9/features/ingestion/workflows/profiler/disable-metric-computation.png" alt="table profile global settings" />
...
<img src="/images/v1.9/features/ingestion/workflows/profiler/disable-specific-metric-computation.png" alt="table profile global settings" />
