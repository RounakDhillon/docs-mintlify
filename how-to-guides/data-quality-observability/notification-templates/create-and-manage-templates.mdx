...
slug: /how-to-guides/data-quality-observability/notification-templates/create-and-manage-templates
...
**Check:**
1. Are you using the correct property names? See [Template Context Reference](/how-to-guides/data-quality-observability/notification-templates/template-context-reference)
2. Is the data available for this entity type?
3. Are you using conditionals for optional fields?

## Next Steps

- **Learn about available data** → [Template Context Reference](/how-to-guides/data-quality-observability/notification-templates/template-context-reference)
- **Master Handlebars** → [Handlebars Templating Guide](/how-to-guides/data-quality-observability/notification-templates/handlebars-templating-guide)
- **Get help with issues** → [Troubleshooting Guide](/how-to-guides/data-quality-observability/notification-templates/troubleshooting)