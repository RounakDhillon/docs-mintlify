---
title: Email Alerts Configuration | Collate
description: Configure email as an alert destination in Collate.
slug: /how-to-guides/data-quality-observability/alerts-notifications/email-alerts-configuration
sidebarTitle: Email Alerts Configuration
---
...
To configure email notifications in Collate, navigate to **Settings > Preferences > Email**.

<img noZoom src="/public/images/how-to-guides/admin-guide/email.webp" alt="Email Configuration" />
...
#### Emailing Entity
The name of the entity that appears in email subjects and content. By default, this is set to "Collate".

For example, if you set this to "JohnDoe", emails will show "JohnDoe" instead of "Collate" in the subject lines and email body.
