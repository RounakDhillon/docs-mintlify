---
title: Google Chat Alerts Configuration | Collate
description: Configure Google Chat as an alert destination in Collate.
slug: /how-to-guides/data-quality-observability/alerts-notifications/google-chat-alerts-configuration
sidebarTitle: Google Chat Alerts Configuration 
---

## Google Chat Alerts Configuration

Collate integrates with Google Chat using **Webhooks** to deliver alert messages directly to your Google Chat Spaces. This allows you to receive real-time notifications within your Google Chat workspace.
...
1. Enter a **Name** for the webhook (e.g., "Collate Alerts")
...
### Configuring Google Chat Webhooks in Collate

Once you have your Google Chat Webhook URL, follow these steps to configure it in Collate:
