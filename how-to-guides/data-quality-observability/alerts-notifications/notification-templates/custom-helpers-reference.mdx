...
- **Learn Handlebars basics** → [Handlebars Templating Guide](/how-to-guides/data-quality-observabilit/alerts-notifications/notification-templates/handlebars-templating-guide)
