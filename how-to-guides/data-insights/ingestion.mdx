...
<img noZoom src="/public/images/how-to-guides/insights/apps-1.png" alt="Applications" />

<img noZoom src="/public/images/how-to-guides/insights/apps.png" alt="Add Apps" />

- Click on read more for **Data Insights** application.

<img noZoom src="/public/images/how-to-guides/insights/apps2.png" alt="Data Insights Application" />

- Install the Data Insights application.

<img noZoom src="/public/images/how-to-guides/insights/di.png" alt="Install Data Insights" />
...
<img noZoom src="/public/images/how-to-guides/insights/di5.png" alt="configure Data Insights" />

<img noZoom src="/public/images/how-to-guides/insights/configure.png" alt="Schedule Data Insights" />
...
<img noZoom src="/public/images/how-to-guides/insights/di6.png" alt="Set Up Data Insights Ingestion Schedule" />

This will successfully install the Data Insights application. Click on **Configure** to view the details.

<img noZoom src="/public/images/how-to-guides/insights/apps3.png" alt="Installed the Data Insights Application" />

- Click on **Run now** to setup the ingestion pipeline.

<img noZoom src="/public/images/how-to-guides/insights/dpy.png" alt="Run the Data Insights Pipeline" />
...
<img noZoom src="/public/images/how-to-guides/insights/history.png" alt="Recent Runs of the Data Insights Pipeline" />
