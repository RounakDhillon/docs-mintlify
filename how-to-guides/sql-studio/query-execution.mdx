...
sidebarTitle: Query Execution
---

# Query Execution

SQL Studio is an integrated SQL query interface that allows you to write, execute, and manage SQL queries directly against your configured database services (BigQuery, Snowflake, Trino, Redshift, PostgreSQL, MSSQL).
...
<img src="/public/images/how-to-guides/sql_studio/sql_studio_query.png" alt="SQL Studio Query Interface" />
