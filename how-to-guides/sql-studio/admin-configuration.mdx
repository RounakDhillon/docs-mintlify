...
sidebarTitle: Admin Configuration
---
...
<img src="/public/images/how-to-guides/sql_studio/default_admin_page.png" alt="Database Services List" />
...
<img src="/public/images/how-to-guides/sql_studio/admin_auth_types.png" alt="Query Runner Configuration - Authentication Types" />
...
<img src="/public/images/how-to-guides/sql_studio/admin_collatesso_auth.png" alt="Collate SSO Configuration" />
...
<img src="/public/images/how-to-guides/sql_studio/page_after_admin_config_done.png" alt="Query Runner Configuration Complete" />
...
<img src="/public/images/how-to-guides/sql_studio/admin_oauth_auth.png" alt="OAuth Configuration" />
...
<img src="/public/images/how-to-guides/sql_studio/admin_basic_auth.png" alt="Basic Authentication Configuration" />
...
**Recommended for**: Username + Password OR Username + Key Pair authentication
...
**User Requirements**:
- Users must have Snowflake credentials (Username + Password OR Username + Key Pair)
...
Trino (Starburst) supports OAuth and Basic Authentication.
...
**Recommended for**: Username + Password authentication when OAuth is not available
...
**User Requirements**:
- Users must have Trino credentials (Username + Password)

---

## Redshift / PostgreSQL / MSSQL Configuration

Redshift, PostgreSQL, and MSSQL support Basic Authentication only.

### Authentication Method: Basic Authentication

<Tip>

**Recommended for**: Username + Password authentication
...
**User Requirements**:
- Users must have valid credentials (Username + Password) for the respective database service
- Users must have appropriate permissions on the database
...
| **Trino/Starburst with OAuth** | OAuth |
| **Trino/Starburst without OAuth** | Basic Authentication |
| **Redshift** | Basic Authentication |
| **PostgreSQL** | Basic Authentication |
| **MSSQL** | Basic Authentication |
...
<img src="/public/images/how-to-guides/sql_studio/enable_sql_studio.png" alt="Enable SQL Studio" />
