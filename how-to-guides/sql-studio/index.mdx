...
1. **Install the Application**: Admins install the SQL Studio ([Query Runner](/how-to-guides/admin-guide/applications/query-runner)) application from the App Marketplace
...
### Authentication Options per Service

| Service | Basic | Collate SSO | External OAuth | Minimum Version |
|---------|-------|-------------|----------------|-------------|
| **BigQuery** | ✅ | ✅ | ✅ | v1.11 |
| **Snowflake** | ✅ | - | ✅ | v1.11 |
| **Trino** | ✅ | - | ✅ | v1.11 |
...
Basic Authentication allows users to provide direct credentials such as Username + Password or Service Account JSON.
...
- **Snowflake** (Username + Password OR Username + Key Pair)
...
1. **[Query Runner Application](/how-to-guides/admin-guide/applications/query-runner)** - Install the Query Runner application to enable SQL Studio (admins only)
...
- **Admins**: Start with [Query Runner Application](/how-to-guides/admin-guide/applications/query-runner) to install and enable SQL Studio
