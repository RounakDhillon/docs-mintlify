...
<img noZoom src="/public/images/how-to-guides/lineage/l1.png" alt="Data Asset: Lineage Tab" />

- Search and select the relevant data asset.
- Create an edge between these two data assets.

<img noZoom src="/public/images/how-to-guides/lineage/l2.png" alt="Link the Table to the Dashboard to Add Lineage Manually" />
...
<img noZoom src="/public/images/how-to-guides/lineage/l3.png" alt="Column-Level Lineage" />
