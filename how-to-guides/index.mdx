...
<Columns cols={2}>
<Card icon='/images/icons/discovery.svg' title="MCP Server" href="/how-to-guides/mcp">
...
<Card icon='/images/icons/discovery.svg' title="Data Contracts" href="/how-to-guides/data-contracts">
