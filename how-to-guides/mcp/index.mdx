...
<img noZoom src="/public/images/how-to-guides/mcp/install-mcp.jpg" alt="Add MCP app" />
...
- Go to `&lt;YOUR-OpenMetadata-SERVER&gt;/users/&lt;YOUR-USERNAME&gt;/access-token` and select *Generate New Token*. This will give your AI agent the same role and access policy that is assign to you in Collate, if you would like it to have different role-based access controls, create a new user.

<img noZoom src="/public/images/how-to-guides/mcp/generate-new-token.jpg" alt="Generate New Token" />

- Set your *Token Expiration*. Once your new token is created copy it.

<img noZoom src="/public/images/how-to-guides/mcp/generate-new-token-2.jpg" alt="Set Token Lifespan" />
...
<Card
 ...
 <Card
    icon="magnifying-glass"
    iconType="solid"
    title="Getting Started with Goose"
