...
<CardGroup cols={2}>
<Card title="Collate MCP Server Connection Guide" href="/how-to-guides/mcp/connect" >
    Connect to your MCP Server.
  </Card>
 <Card title="Collate MCP Tools Reference" href="/how-to-guides/mcp/reference" >
    Detailed examples and usage patterns for all available Collate MCP tools.
  </Card>
 <Card title="Getting Started with Claude Desktop" href="/how-to-guides/mcp/claude" >
    Connect your Collate to Anthropic's popular AI assistant.
  </Card>
 <Card title="Getting Started with Goose" href="/how-to-guides/mcp/goose" >
