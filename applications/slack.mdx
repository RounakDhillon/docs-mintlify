...
<img src="/public/images/applications/slack1.png" alt="Configuration" />

2. Search for **Slack** and install the application.

<img src="/public/images/applications/slack2.png" alt="Configuration" />
...
<img src="/public/images/applications/slack3.png" alt="Configuration" />
...
<img src="/public/images/applications/slack4.png" alt="Configuration" />

3. Select **From scratch**.

<img src="/public/images/applications/slack5.png" alt="Configuration" />

4. Enter the **App Name** (e.g., `Collate Integration`) and choose your **Slack workspace**.
5. Click **Create App**.

<img src="/public/images/applications/slack6.png" alt="Configuration" />
...
<img src="/public/images/applications/slack-basic.png" alt="Basic Information page" />

### Configure OAuth & Permissions

1. In your app’s dashboard, navigate to **OAuth & Permissions**.

<img src="/public/images/applications/slack7.png" alt="Configuration" />

2. Under **Scopes**, configure the following:

<img src="/public/images/applications/slack8.png" alt="Configuration" />
...
<img src="/public/images/applications/slack-redirect.png" alt="Configure Redirect URLs" />
...
<img src="/public/images/applications/enable-events.png" alt="Enable Events" />
...
<img src="/public/images/applications/bot-events.png" alt="Subscribe to bot events" />
...
<img src="/public/images/applications/subscribe-events.png" alt="Subscribe to events on behalf of users" />
...
<img src="/public/images/applications/create-command.png" alt="Create Edit New Command" />
...
<img src="/public/images/applications/slash-commands.png" alt="Slash Commands" />
...
<img src="/public/images/applications/slack9.png" alt="Configuration" />
