...
<img src="/images/v1.9/applications/slack1.png" alt="Configuration" />

2. Search for **Slack** and install the application.

<img src="/images/v1.9/applications/slack2.png" alt="Configuration" />
...
<img src="/images/v1.9/applications/slack3.png" alt="Configuration" />
...
<img src="/images/v1.9/applications/slack4.png" alt="Configuration" />

3. Select **From scratch**.

<img src="/images/v1.9/applications/slack5.png" alt="Configuration" />

4. Enter the **App Name** (e.g., `Collate Integration`) and choose your **Slack workspace**.
5. Click **Create App**.

<img src="/images/v1.9/applications/slack6.png" alt="Configuration" />
...
<img src="/images/v1.9/applications/slack-basic.png" alt="Basic Information page" />

### Configure OAuth & Permissions

1. In your app’s dashboard, navigate to **OAuth & Permissions**.

<img src="/images/v1.9/applications/slack7.png" alt="Configuration" />

2. Under **Scopes**, configure the following:

<img src="/images/v1.9/applications/slack8.png" alt="Configuration" />
...
<img src="/images/v1.9/applications/slack-redirect.png" alt="Configure Redirect URLs" />
...
<img src="/images/v1.9/applications/enable-events.png" alt="Enable Events" />
...
<img src="/images/v1.9/applications/bot-events.png" alt="Subscribe to bot events" />
...
<img src="/images/v1.9/applications/subscribe-events.png" alt="Subscribe to events on behalf of users" />
...
<img src="/images/v1.9/applications/create-command.png" alt="Create Edit New Command" />
...
<img src="/images/v1.9/applications/slash-commands.png" alt="Slash Commands" />
...
<img src="/images/v1.9/applications/slack9.png" alt="Configuration" />
