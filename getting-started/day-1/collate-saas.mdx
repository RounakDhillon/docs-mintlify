...
<img src="/images/getting-started/add-service.png" alt="Adding Database Service" />
...
<img src="/images/getting-started/select-service.png" alt="Selecting Database Service" />
...
<img src="/images/getting-started/configure-connector.png" alt="Updating Connection Details" />
...
<img src="/images/getting-started/collate-saas-ip.png" alt="Collate SaaS IP" />

5. **Test the connection** to verify the status. The test connection will check if the Service is reachable from Collate.

<img src="/images/getting-started/test-connection.png" alt="Verifying the Test Connection" />
