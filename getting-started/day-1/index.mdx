...
<Columns cols={2}>
<Card title="Run the connector in Collate SaaS" href="/getting-started/day-1/collate-saas">
...
- Build [no-code data quality tests](how-to-guides/data-quality-observability/quality/tab) to ensure its technical and
  business quality, and set up an [alert](/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts) for any test case failures to be quickly notified of critical data issues.
