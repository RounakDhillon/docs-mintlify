...
description: Learn how to run Collate Ingestion workflows using Python, Docker, or Virtualenv operators in Airflow for secure and flexible metadata ingestion.
