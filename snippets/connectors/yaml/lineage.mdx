...
<ContentSection id={2} title="Lineage Config Type" lines="4-6">
...
<ContentSection id={15} title="Threads" lines="36">

**threads**: Number of Threads to use in order to parallelize lineage ingestion.

</ContentSection>

<ContentSection id={16} title="Sink Configuration" lines="37-39">
