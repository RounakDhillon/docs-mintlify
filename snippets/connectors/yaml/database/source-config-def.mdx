...
**overrideMetadata** *(boolean)*: Set the 'Override Metadata' toggle to control whether to override the existing metadata in the Collate server with the metadata fetched from the source. If the toggle is set to true, the metadata fetched from the source will override the existing metadata in the Collate server. If the toggle is set to false, the metadata fetched from the source will not override the existing metadata in the Collate server. This is applicable for fields like description, tags, owner and displayName.
...
**databaseFilterPattern**, **schemaFilterPattern**, **tableFilterPattern**: Note that the filter supports regex as include or exclude. You can find examples [here](/how-to-guides/guide-for-data-users/ingestion/workflows/metadata/filter-patterns/database)
...
- [BigQuery](/how-to-guides/guide-for-data-users/ingestion/workflows/metadata/incremental-extraction/bigquery)
- [Redshift](/how-to-guides/guide-for-data-users/ingestion/workflows/metadata/incremental-extraction/redshift)
- [Snowflake](/how-to-guides/guide-for-data-users/ingestion/workflows/metadata/incremental-extraction/snowflake)
