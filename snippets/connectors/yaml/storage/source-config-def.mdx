...
**containerFilterPattern**: Note that the filter supports regex as include or exclude. You can find examples [here](/how-to-guides/guide-for-data-users/ingestion/workflows/metadata/filter-patterns/database).
