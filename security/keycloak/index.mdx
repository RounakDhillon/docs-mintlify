...
<img noZoom src="/public/images/deployment/security/keycloak/1-login-page.png" alt="login-page" />
...
<img noZoom src="/public/images/deployment/security/keycloak/2-change-realm.png" alt="change-realm" />
...
<img noZoom src="/public/images/deployment/security/keycloak/3-add-client.png" alt="add-client" />
...
<img noZoom src="/public/images/deployment/security/keycloak/4-edit-settings-client.png" alt="edit-settings-client" />
...
<img noZoom src="/public/images/deployment/security/keycloak/5-edit-settings-url.png" alt="edit-settings-url.png" />
...
<img noZoom src="/public/images/deployment/security/keycloak/6-client-credentials.png" alt="client-credentials" />
