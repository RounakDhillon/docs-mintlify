...
<img noZoom src="/public/images/deployment/security/okta/create-oidc-app-integration.png" alt="create-oidc-app-integration" />

- Click on **Applications -> Applications** in the left navigation panel.
<img noZoom src="/public/images/deployment/security/okta/click-applications.png" alt="click-applications" />

- Click on the **Create App Integration** button.
<img noZoom src="/public/images/deployment/security/okta/create-app-integration.png" alt="create-app-integration" />
...
<img noZoom src="/public/images/deployment/security/okta/configuring-the-app.png" alt="configuring-the-app" />
...
- Click **Save**.
<img noZoom src="/public/images/deployment/security/okta/general-settings-click-save.png" alt="general-settings-click-save" />

- The app is now configured.
<img noZoom src="/public/images/deployment/security/okta/app-is-configured.png" alt="app-is-configured" />
