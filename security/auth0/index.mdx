...
<img src="/public/images/deployment/security/auth0/create-account-1.png" alt="create-account" />

- Provide the Tenant Domain, select the region and click on Create Account.

<img src="/public/images/deployment/security/auth0/create-account-2.png" alt="create-account" />

- Once done, you will land on the dashboard page.

<img src="/public/images/deployment/security/auth0/create-account-3.png" alt="create-account" />
