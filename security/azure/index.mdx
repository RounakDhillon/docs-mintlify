...
<img src="/images/v1.9/deployment/security/azure/create-app-1.png" alt="create-app" /> 

- Click on `New Registration`. This step is for registering the OpenMetadata UI.

<img src="/images/v1.9/deployment/security/azure/create-app-2.png" alt="create-app" />
...
<img src="/images/v1.9/deployment/security/azure/where-to-find-credentials.png" alt="create-app" />
