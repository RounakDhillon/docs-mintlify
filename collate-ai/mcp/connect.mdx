...
### 2. Authentication
The MCP server requires [JWT authentication](/collate-ai/mcp#adding-a-personal-access-token-to-your-mcp-client). Include your token in the Authorization header:
```http
