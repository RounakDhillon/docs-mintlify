...
3. **[MCP Application and Personal Access Token](/collate-ai/mcp#adding-a-personal-access-token-to-your-mcp-client)** - Follow this guide to generate your PAT
...
5. **Token expired**: [Generate a new PAT](/collate-ai/mcp#adding-a-personal-access-token-to-your-mcp-client) and update your configuration
