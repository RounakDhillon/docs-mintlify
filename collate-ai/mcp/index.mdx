...
<CardGroup cols={2}>
<Card title="Collate MCP Server Connection Guide" href="/collate-ai/mcp/connect" >
    Connect to your MCP Server.
  </Card>
 <Card title="Collate MCP Tools Reference" href="/collate-ai/mcp/reference" >
    Detailed examples and usage patterns for all available Collate MCP tools.
  </Card>
 <Card title="Getting Started with Claude Desktop" href="/collate-ai/mcp/claude" >
    Connect your Collate to Anthropic's popular AI assistant.
  </Card>
 <Card title="Getting Started with Goose" href="/collate-ai/mcp/goose" >
