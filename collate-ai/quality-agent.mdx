...
<img src="/images/v1.9/collate-ai/collate-ai-quality-agent.png" alt="Installation" />
...
<img src="/images/v1.9/collate-ai/collate-ai-quality-agent1.png" alt="Configuration" />

4. **Scheduling**: Set up regular intervals for the agent to run and update metadata.

<img src="/images/v1.9/collate-ai/collate-ai-quality-agent2.png" alt="Scheduling" />
