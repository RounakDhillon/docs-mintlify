...
<Card icon='/public/images/icons/askcollate.svg' title="AskCollate" href="/collateai/ask-collate" horizontal>
  Your conversational interface for querying metadata, documentation, lineage, and governance controls.
</Card>
<Card icon='/public/images/icons/data-discovery.svg' title="Collate AI Tier Agent" href="/collateai/tier-agent" horizontal>
  Classify Business-Critical Data with Collate AI Tier Agent.
</Card>
<Card icon="/public/images/icons/data-quality.svg" title="Collate AI Quality Agent" href="/collateai/quality-agent" horizontal>
  Enhance Data Quality with Collate AI Quality Agent.
</Card>
<Card icon='/public/images/icons/data-governance.svg' title="Autopilot" href="/collateai/collate-ai-autopilot-workflows" horizontal>
  Streamlining Metadata with Collate AI and Autopilot Integration.
</Card>
<Card icon='/public/images/icons/data-discovery.svg' title="Collate AI Documentation Agent" href="/collateai/documentation-agent" horizontal>
