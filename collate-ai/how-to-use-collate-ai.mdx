...
slug: /collate-ai/how-to-use-collate-ai
sidebarTitle: How to Use Collate AI
collate: true
---
...
<img noZoom src="/public/images/collate-ai/setting-up-collate-ai-1.png" alt="setting up Collate AI" />

- Install Collate AI by following the on-screen instructions.

<img noZoom src="/public/images/collate-ai/setting-up-collate-ai-2.png" alt="Install Collate AI" />
...
<img noZoom src="/public/images/collate-ai/setting-up-collate-ai-3.png" alt="automatically generate descriptions" />

- **Scheduling**: Schedule Collate AI to run regularly, automatically generating metadata at predefined intervals (e.g., weekly).

<img noZoom src="/public/images/collate-ai/setting-up-collate-ai-4.png" alt="Schedule Collate AI" />

## 2. Using the Collate AI Chatbot
- The Collate AI chatbot icon appears on every page after installation.

<img noZoom src="/public/images/collate-ai/using-collate-ai-chatbot-1.png" alt="chatbot icon" />
...
<img noZoom src="/public/images/collate-ai/using-collate-ai-chatbot-2.png" alt="natural language questions" />
...
<img noZoom src="/public/images/collate-ai/fixing-sql-queries-1.png" alt="metadata usage workflows" />

- If a query runs inefficiently, ask the chatbot to optimize it by typing: “Optimize this query.”

<img noZoom src="/public/images/collate-ai/fixing-sql-queries-3.png" alt="Optimize this query" />
...
<img noZoom src="/public/images/collate-ai/fixing-sql-queries-4.png" alt="Can you fix this query" />
...
<img noZoom src="/public/images/collate-ai/reviewing-generated-metadata.png" alt="reviewing Generated Metadata" />
