...
<img src="/images/v1.9/collate-ai/setting-up-collate-ai-1.png" alt="setting up Collate AI" />

- Install Collate AI by following the on-screen instructions.

<img src="/images/v1.9/collate-ai/setting-up-collate-ai-2.png" alt="Install Collate AI" />
...
<img src="/images/v1.9/collate-ai/setting-up-collate-ai-3.png" alt="automatically generate descriptions" />

- **Scheduling**: Schedule Collate AI to run regularly, automatically generating metadata at predefined intervals (e.g., weekly).

<img src="/images/v1.9/collate-ai/setting-up-collate-ai-4.png" alt="Schedule Collate AI" />

## 2. Using the Collate AI Chatbot
- The Collate AI chatbot icon appears on every page after installation.

<img src="/images/v1.9/collate-ai/using-collate-ai-chatbot-1.png" alt="chatbot icon" />
...
<img src="/images/v1.9/collate-ai/using-collate-ai-chatbot-2.png" alt="natural language questions" />
...
<img src="/images/v1.9/collate-ai/fixing-sql-queries-1.png" alt="metadata usage workflows" />

- If a query runs inefficiently, ask the chatbot to optimize it by typing: “Optimize this query.”

<img src="/images/v1.9/collate-ai/fixing-sql-queries-3.png" alt="Optimize this query" />
...
<img src="/images/v1.9/collate-ai/fixing-sql-queries-4.png" alt="Can you fix this query" />
...
<img src="/images/v1.9/collate-ai/reviewing-generated-metadata.png" alt="reviewing Generated Metadata" />
