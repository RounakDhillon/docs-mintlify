...
<img src="/images/collate-ai/collate-ai-agent.png" alt="Navigate to Applications" />

2. **Install the Agent**: Click on "Add Apps" to access the marketplace and install the Collate AI Documentation Agent.

<img src="/images/collate-ai/collate-ai-documentation-agent.png" alt="Installation" />
...
<img src="/images/collate-ai/collate-ai-documentation-agent1.png" alt="Configuration" />

4. **Scheduling**: Set up regular intervals for the agent to run and update metadata.

<img src="/images/collate-ai/collate-ai-documentation-agent2.png" alt="Scheduling" />
