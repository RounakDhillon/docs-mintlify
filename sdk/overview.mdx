...
<CardGroup cols={3}>
  <Card title="Type Safe" icon="/images/icons/quality.svg" color="#16a34a">
    Generated from API schemas for type safety
  </Card>
  <Card title="Full Featured" icon="/images/icons/celebration.svg" color="#f59e0b">
    Complete API coverage and authentication
  </Card>
  <Card title="Production Ready" icon="/images/icons/puzzle.svg" color="#3b82f6">
...
<CardGroup cols={3}>
  <Card title="Python SDK" icon="/images/icons/puzzle.svg" href="/sdk/python/overview">
    Full-featured Python client
  </Card>
  <Card title="Java SDK" icon="/images/icons/puzzle.svg" href="/sdk/java/overview">
    Enterprise Java integration
  </Card>
  <Card title="Go SDK" icon="/images/icons/puzzle.svg" href="/sdk/go/overview">
