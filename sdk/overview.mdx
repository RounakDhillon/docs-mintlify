...
<CardGroup cols={3}>
  ...
  <Card title="Java SDK" icon="/public/images/icons/puzzle.svg" href="/sdk/java/overview">
    Enterprise Java integration
  </Card>
  <Card title="Go SDK" icon="/public/images/icons/puzzle.svg" href="/sdk/go/overview">
