---
title: Java SDK for Lineage | Collate Docs
description: Learn to manage data lineage with the Collate Java SDK. Fluent API for querying, creating, deleting and exporting lineage with column-level mapping and impact analysis.
slug: /sdk/java/lineage
