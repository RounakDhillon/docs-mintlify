...
1. Go to the settings page from the navbar and then scroll down to the Integrations Section. Click on the Bots and you will see the list of bots, then click on the ingestion-bot. <img src="/images/apis/bots/bots.png" alt="bot-list" />

2. You will be redirected to the ingestion-bot details page. there you will get the JWT token, click on the copy button and copy the JWT token. <img src="/images/apis/bots/bots-token.png" alt="bot-token" />
...
2. Go to logged in user profile by clicking on User's profile image on top right corner. <img src="/images/apis/users/user-profile-page.png" alt="user-profile" />

3. Click on Access Token tab, Generate a New token. <img src="/images/apis/users/user-profile-access-token.png" alt="user-profile" />
