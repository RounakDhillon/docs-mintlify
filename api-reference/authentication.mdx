...
description: Authenticate API requests to Collate using JWT Bearer tokens obtained from SSO, service accounts, or bot authentication for secure access to metadata endpoints.
...
# configure() reads OPENMETADATA_HOST and OPENMETADATA_JWT_TOKEN from env
configure()
