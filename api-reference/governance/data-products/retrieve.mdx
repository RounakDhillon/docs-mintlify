...
description: Retrieve a data product by UUID or fully qualified name with optional field expansion for assets, owners, experts, and governance metadata using the Collate REST API.
sidebarTitle: Retrieve Data Product
