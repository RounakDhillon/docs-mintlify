...
description: Update data product properties using JSON Patch operations (add, remove, replace) to modify metadata fields like description, owners, assets, and policies via the Collate REST API.
sidebarTitle: Update Data Product
