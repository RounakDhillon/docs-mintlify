...
description: Create a new data product within a domain to represent a business-aligned collection of data assets with owners, experts, and governance policies using the Collate REST API.
sidebarTitle: Create Data Product
