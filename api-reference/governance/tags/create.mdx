---
title: Create a Tag
description: Create a new tag within a classification hierarchy with display name, description, parent relationships, and styling for data asset categorization using the Collate REST API.
