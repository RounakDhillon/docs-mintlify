...
description: Retrieve a tag by UUID or fully qualified name with optional field expansion for related entities and metadata using the Collate REST API.
sidebarTitle: Retrieve Tag
api: GET /v1/tags/{id}
---
