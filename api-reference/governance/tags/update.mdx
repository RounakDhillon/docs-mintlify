---
title: Update a Tag
description: Update tag properties using JSON Patch operations (add, remove, replace) to modify metadata fields like description, style, and parent relationships via the Collate REST API.
