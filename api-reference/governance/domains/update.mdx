...
description: Update domain properties using JSON Patch operations (add, remove, replace) to modify metadata fields like description, owners, experts, and custom properties via the Collate REST API.
