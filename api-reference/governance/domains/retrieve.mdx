...
description: Retrieve a domain by UUID or fully qualified name with optional field expansion for data products, owners, and related entities using the Collate REST API.
