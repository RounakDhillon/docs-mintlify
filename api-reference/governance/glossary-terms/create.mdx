...
description: Create a new glossary term with definition, synonyms, related terms, references, and governance metadata within a glossary hierarchy using the Collate REST API.
sidebarTitle: Create Glossary Term
