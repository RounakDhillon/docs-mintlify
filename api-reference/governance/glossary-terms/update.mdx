...
description: Update glossary term properties using JSON Patch operations (add, remove, replace) to modify definition, synonyms, relationships, and metadata via the Collate REST API.
sidebarTitle: Update Glossary Term
