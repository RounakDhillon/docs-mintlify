...
description: Retrieve a glossary term by UUID or fully qualified name with optional field expansion for relationships, tags, and governance metadata using the Collate REST API.
sidebarTitle: Retrieve Glossary Term
