...
description: Retrieve a glossary by UUID or fully qualified name with optional field expansion for terms, ownership, and related metadata using the Collate REST API.
sidebarTitle: Retrieve Glossary
