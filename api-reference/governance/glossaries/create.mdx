...
description: Create a new glossary entity to organize business terminology, definitions, and hierarchical term relationships for consistent data understanding using the Collate REST API.
sidebarTitle: Create Glossary
