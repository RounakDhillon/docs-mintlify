...
description: Create a classification system for organizing tags with mutually exclusive or multi-select behavior to categorize data assets for governance using the Collate REST API.
sidebarTitle: Create Classification
