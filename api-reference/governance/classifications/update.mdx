...
description: Update classification properties using JSON Patch operations to modify display name, description, mutually exclusive settings, and domains via the Collate REST API.
sidebarTitle: Update Classification
