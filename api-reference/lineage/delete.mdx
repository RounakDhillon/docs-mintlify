...
description: Remove a lineage edge between two entities to delete a data flow relationship while preserving entity metadata using the Collate REST API for lineage graph maintenance.
