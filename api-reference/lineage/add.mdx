---
title: Add Lineage
description: Add a lineage edge between two entities to represent data flow, transformation dependencies, or upstream/downstream relationships using the Collate REST API for impact analysis.
