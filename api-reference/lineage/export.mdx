...
description: Export the complete upstream and downstream lineage graph for an entity as CSV including all connected entities and relationships for external analysis or visualization.
