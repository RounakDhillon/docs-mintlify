---
title: Errors
description: Learn about Collate REST API error codes, response formats, common error scenarios, and troubleshooting strategies for authentication, validation, and request failures.
sidebarTitle: Errors
mode: "wide"
---
