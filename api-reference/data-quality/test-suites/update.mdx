...
description: Update test suite properties using JSON Patch operations (add, remove, replace) to modify metadata fields like description, owners, and test configuration via the Collate REST API.
sidebarTitle: Update Test Suite
