...
description: Retrieve a test suite by UUID or fully qualified name with optional field expansion for test cases, execution history, and configuration using the Collate REST API.
sidebarTitle: Retrieve Test Suite
