...
description: Create executable or logical test suite entities to group related data quality test cases for organized quality monitoring and testing workflows using the Collate REST API.
