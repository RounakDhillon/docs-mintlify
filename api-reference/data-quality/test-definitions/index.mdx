...
|--------|----------|-------------|
| `POST` | `/v1/dataQuality/testDefinitions` | [Create a custom test definition](/api-reference/data-quality/test-definitions/create) |
| `GET` | `/v1/dataQuality/testDefinitions` | [List test definitions](/api-reference/data-quality/test-definitions/list) |
| `GET` | `/v1/dataQuality/testDefinitions/{id}` | [Get by ID](/api-reference/data-quality/test-definitions/retrieve) |
| `GET` | `/v1/dataQuality/testDefinitions/name/{name}` | [Get by name](/api-reference/data-quality/test-definitions/retrieve) |
