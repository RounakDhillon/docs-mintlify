...
description: Retrieve a test definition by UUID or name to access predefined data quality test types and their parameter specifications using the Collate REST API.
sidebarTitle: Retrieve Test Definition
