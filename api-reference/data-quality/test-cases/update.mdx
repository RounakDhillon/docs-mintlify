...
description: Update test case properties using JSON Patch operations (add, remove, replace) to modify metadata fields like description, owners, and configuration via the Collate REST API.
sidebarTitle: Update Test Case
