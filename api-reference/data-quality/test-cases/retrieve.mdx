...
description: Retrieve a test case by UUID or fully qualified name with optional field expansion for execution history and configuration using the Collate REST API.
sidebarTitle: Retrieve Test Case
