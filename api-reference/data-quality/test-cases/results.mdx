...
description: Retrieve historical test case execution results and submit new test run outcomes with pass/fail status and metrics for data quality monitoring using the Collate REST API.
