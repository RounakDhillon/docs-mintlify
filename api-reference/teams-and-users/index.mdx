---
title: Teams & Users
description: REST API endpoints for creating, retrieving, updating, and deleting users and teams with roles, permissions, and organizational hierarchy for access control and collaboration.
