---
title: Team Versions
description: List and retrieve historical versions of a team entity to track changes in membership, roles, policies, and organizational structure over time via the Collate REST API.
