...
description: Retrieve a team entity by UUID or fully qualified name with optional field expansion for users, roles, policies, and parent/child team relationships using the Collate REST API.
sidebarTitle: Retrieve Team
api: GET /v1/teams/{id}
---
