---
title: Update a Team
description: Update team properties using JSON Patch operations to modify team type, users, roles, policies, domains, and organizational hierarchy via the Collate REST API.
sidebarTitle: Update Team
