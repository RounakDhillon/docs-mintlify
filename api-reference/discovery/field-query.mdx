---
title: Field Query
description: Search and filter entities by specific field values using advanced query syntax to find tables, dashboards, pipelines, and other assets matching exact criteria via the Collate REST API.
