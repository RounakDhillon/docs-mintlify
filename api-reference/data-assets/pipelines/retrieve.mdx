...
description: Retrieve a pipeline entity by UUID or fully qualified name with optional field expansion for owners, tags, tasks, and lineage using the Collate REST API.
sidebarTitle: Retrieve Pipeline
