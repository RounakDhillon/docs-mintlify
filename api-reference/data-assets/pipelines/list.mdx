...
description: List all pipeline entities with optional filtering by service, schedule type, owner, tag, domain, and pagination support via the Collate REST API.
