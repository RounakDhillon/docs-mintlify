...
description: Create a new pipeline entity with tasks, schedules, owners, tags, and lineage information within a pipeline service using the Collate REST API for orchestration tracking.
sidebarTitle: Create Pipeline
