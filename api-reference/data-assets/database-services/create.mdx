...
description: Create a new database service connection with authentication, configuration, owners, and tags using the Collate REST API for metadata ingestion and discovery.
sidebarTitle: Create Database Service
