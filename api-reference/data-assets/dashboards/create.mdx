...
description: Create a new dashboard entity with charts, owners, tags, domains, and metadata within a dashboard service using the Collate REST API for visualization tracking.
