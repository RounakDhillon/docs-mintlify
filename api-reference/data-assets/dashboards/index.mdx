---
title: Dashboards
description: Create, retrieve, update, list, and delete dashboard entities with charts, owners, tags, and domains within a dashboard service using the Collate REST API.
