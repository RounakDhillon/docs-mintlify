...
description: Create a new machine learning model entity with algorithm, features, owners, tags, and version metadata within an ML model service using the Collate REST API.
sidebarTitle: Create ML Model
