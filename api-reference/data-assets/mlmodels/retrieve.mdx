...
description: Retrieve a machine learning model entity by UUID or fully qualified name with optional field expansion for owners, tags, features, and metadata using the Collate REST API.
sidebarTitle: Retrieve ML Model
