...
description: Create a new ML model service connection with authentication, endpoint configuration, owners, and tags using the Collate REST API for model registry integration.
sidebarTitle: Create ML Model Service
