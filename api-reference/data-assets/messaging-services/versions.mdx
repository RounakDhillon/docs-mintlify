...
description: List and retrieve historical versions of a messaging service connection to track changes over time including configuration modifications and metadata updates via the Collate REST API.
