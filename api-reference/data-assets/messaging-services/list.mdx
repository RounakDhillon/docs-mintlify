...
description: List all messaging service connections with optional filtering by service type, owner, status, and pagination support for browsing integrations via the Collate REST API.
