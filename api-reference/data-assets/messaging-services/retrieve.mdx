...
description: Retrieve a messaging service connection by UUID or fully qualified name with optional field expansion for configuration and metadata using the Collate REST API.
sidebarTitle: Retrieve Messaging Service
