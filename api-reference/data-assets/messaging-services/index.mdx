...
description: Create, retrieve, update, and delete messaging service connections with authentication and configuration for metadata ingestion across your data infrastructure using the Collate REST API.
