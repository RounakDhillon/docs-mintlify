...
description: Create a new table entity with columns, constraints, owners, tags, domains, and custom properties within a database schema using the Collate REST API.
