...
description: Add and delete custom metrics for tables to track business KPIs, data quality measures, and usage statistics beyond standard metadata using the Collate REST API.
