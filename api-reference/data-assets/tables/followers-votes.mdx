...
description: Add or remove followers and manage upvotes/downvotes for tables to track popularity and enable change notifications using the Collate REST API.
