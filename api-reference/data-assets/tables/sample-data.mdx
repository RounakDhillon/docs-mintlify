...
description: Retrieve, upload, or delete sample data rows for a table to provide data previews and examples for discovery and understanding using the Collate REST API.
