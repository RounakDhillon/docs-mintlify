...
description: Soft delete or permanently remove a chart entity by UUID or fully qualified name, controlling cascade behavior and maintaining audit trails via the Collate REST API.
sidebarTitle: Delete Chart
