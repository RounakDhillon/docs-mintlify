...
description: List all API collection entities with optional filtering by service, owner, tag, domain, and pagination support for browsing large catalogs via the Collate REST API.
