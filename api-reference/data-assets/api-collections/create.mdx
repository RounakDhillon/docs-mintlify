...
description: Create a new API collection entity with endpoints, authentication methods, owners, tags, and metadata within an API service using the Collate REST API.
sidebarTitle: Create API Collection
