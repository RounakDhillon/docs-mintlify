...
description: Retrieve an API collection entity by UUID or fully qualified name with optional field expansion for endpoints, owners, tags, and metadata using the Collate REST API.
sidebarTitle: Retrieve API Collection
