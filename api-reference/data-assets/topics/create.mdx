...
description: Create a new topic entity with schema, partitions, owners, tags, and message configuration within a messaging service using the Collate REST API for event streaming.
sidebarTitle: Create Topic
api: POST /v1/topics
---
