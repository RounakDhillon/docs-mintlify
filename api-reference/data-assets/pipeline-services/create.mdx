...
description: Create a new pipeline service connection with authentication, configuration, owners, and tags using the Collate REST API for metadata ingestion and discovery.
sidebarTitle: Create Pipeline Service
