...
description: Soft delete or permanently remove a pipeline service connection by UUID or name, controlling cascade behavior and maintaining audit trails via the Collate REST API.
sidebarTitle: Delete Pipeline Service
