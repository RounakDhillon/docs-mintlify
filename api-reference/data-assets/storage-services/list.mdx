...
description: List all storage service connections with optional filtering by service type, owner, status, and pagination support for browsing integrations via the Collate REST API.
