...
description: Update storage service connection properties using JSON Patch operations to modify configuration, authentication, owners, and tags via the Collate REST API.
sidebarTitle: Update Storage Service
