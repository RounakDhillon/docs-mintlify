...
description: Add or remove followers and manage upvotes/downvotes for search indexes to track popularity and enable change notifications using the Collate REST API.
