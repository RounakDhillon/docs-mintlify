...
description: Create a new search index entity with fields, mappings, owners, tags, and configuration within a search service using the Collate REST API for search infrastructure.
sidebarTitle: Create Search Index
