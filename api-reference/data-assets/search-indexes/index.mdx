...
description: Create, retrieve, update, list, and delete search index entities with fields, mappings, owners, and tags within a search service using the Collate REST API.
sidebarTitle: Search Indexes
---
