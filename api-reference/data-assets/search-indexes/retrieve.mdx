...
description: Retrieve a search index entity by UUID or fully qualified name with optional field expansion for owners, tags, fields, and configuration using the Collate REST API.
sidebarTitle: Retrieve Search Index
