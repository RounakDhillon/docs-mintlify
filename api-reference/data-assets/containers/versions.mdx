...
description: List and retrieve historical versions of a container entity to track changes over time including field modifications, metadata updates, and change authors via the Collate REST API.
