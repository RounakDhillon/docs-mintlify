...
description: Retrieve a container entity by UUID or fully qualified name with optional field expansion for owners, tags, domains, and custom properties using the Collate REST API.
sidebarTitle: Retrieve Container
