...
description: Create a new container entity with data structure, owners, tags, domains, and custom properties within a storage service using the Collate REST API for object storage.
sidebarTitle: Create Container
