...
|----------|-----------|-------------|
| [Database Services](/api-reference/data-assets/database-services/index) | `/v1/services/databaseServices` | Manage database platform connections |
| [Databases](/api-reference/data-assets/databases/index) | `/v1/databases` | Manage databases within a service |
| [Database Schemas](/api-reference/data-assets/database-schemas/index) | `/v1/databaseSchemas` | Manage schemas within a database |
| [Tables](/api-reference/data-assets/tables/index) | `/v1/tables` | Manage tables within a schema |
| [Stored Procedures](/api-reference/data-assets/stored-procedures/index) | `/v1/storedProcedures` | Manage stored procedures within a schema |
