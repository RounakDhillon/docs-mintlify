...
description: Import and export dashboard service connection metadata as CSV files for bulk operations, backup, migration, or external processing using the Collate REST API.
