...
description: Create, retrieve, update, and delete dashboard service connections with authentication and configuration for metadata ingestion across your data infrastructure using the Collate REST API.
