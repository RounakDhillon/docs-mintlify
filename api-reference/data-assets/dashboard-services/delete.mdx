...
description: Soft delete or permanently remove a dashboard service connection by UUID or name, controlling cascade behavior and maintaining audit trails via the Collate REST API.
sidebarTitle: Delete Dashboard Service
