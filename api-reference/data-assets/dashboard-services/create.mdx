...
description: Create a new dashboard service connection with authentication, configuration, owners, and tags using the Collate REST API for metadata ingestion and discovery.
sidebarTitle: Create Dashboard Service
