...
description: Create a new database entity with schema, owners, tags, retention settings, and custom properties within a database service using the Collate REST API.
