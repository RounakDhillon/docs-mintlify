...
description: Soft delete or permanently remove an API endpoint entity by UUID or fully qualified name, controlling cascade behavior and maintaining audit trails via the Collate REST API.
sidebarTitle: Delete API Endpoint
