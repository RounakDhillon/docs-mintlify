...
description: Create a new API endpoint entity with HTTP method, parameters, responses, owners, tags, and metadata within an API collection using the Collate REST API.
sidebarTitle: Create API Endpoint
