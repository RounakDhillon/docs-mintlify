...
description: Update API endpoint properties using JSON Patch operations (add, remove, replace) to modify metadata fields like description, owners, tags, and custom properties via the Collate REST API.
sidebarTitle: Update API Endpoint
