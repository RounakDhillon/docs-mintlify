...
description: List all API endpoint entities with optional filtering by collection, method, status code, owner, tag, and pagination support via the Collate REST API.
