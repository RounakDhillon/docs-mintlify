...
description: Add or remove followers, manage upvotes/downvotes, and configure profiler settings for database schemas to track popularity and data quality monitoring via the Collate REST API.
