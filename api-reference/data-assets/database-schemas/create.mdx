...
description: Create a new database schema entity with tables, owners, tags, retention policies, and custom properties within a database using the Collate REST API.
