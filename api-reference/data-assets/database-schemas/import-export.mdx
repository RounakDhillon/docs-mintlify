...
description: Import and export database schema metadata as CSV files for bulk operations, backup, migration, or external processing using the Collate REST API.
