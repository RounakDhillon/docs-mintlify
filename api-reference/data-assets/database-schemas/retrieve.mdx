...
description: Retrieve a database schema entity by UUID or fully qualified name with optional field expansion for tables, owners, tags, and custom properties using the Collate REST API.
sidebarTitle: Retrieve Schema
