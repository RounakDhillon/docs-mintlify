...
description: Create a new data contract defining quality expectations, SLAs, schema requirements, and ownership agreements for a data asset using the Collate REST API.
sidebarTitle: Create
