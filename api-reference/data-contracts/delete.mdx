...
description: Soft delete or restore a data contract to deactivate quality agreements without losing historical records, maintaining audit trails using the Collate REST API.
sidebarTitle: Delete
