...
description: Track version history of data contract changes over time including rule modifications, SLA adjustments, and ownership updates to maintain audit trails via the Collate REST API.
