...
description: Update data contract properties using JSON Patch operations to modify quality rules, SLAs, schema definitions, and ownership agreements via the Collate REST API.
sidebarTitle: Update
