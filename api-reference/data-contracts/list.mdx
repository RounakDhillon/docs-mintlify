...
description: List and filter data contracts with query parameters for ownership, status, entity type, and date ranges to manage data quality agreements using the Collate REST API.
sidebarTitle: List
