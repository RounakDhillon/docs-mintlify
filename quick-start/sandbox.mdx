---
title: Sandbox Quickstart | Collate Sandbox Environment
description: Get started with Collate in minutes using our interactive sandbox environment. Explore data discovery, lineage, and governance features hands-on.
...
<img noZoom src="/public/images/quickstart/sandbox/login.png" alt="login" />


### 2. Add yourself as a user. Pick a few teams to be part of: Data is a team game.

<img noZoom src="/public/images/quickstart/sandbox/create-user.png" alt="user" />
