...
description: deploy Collate locally on Kubernetes in minutes! Step-by-step guide with commands, configurations, and troubleshooting for your metadata platform.
slug: /quick-start/local-kubernetes-deployment
sidebarTitle: Local kubernetes deployment
---
...
<CardGroup cols={1}>
<Card title="Deploy in Cloud" href="/deployment/kubernetes" >
