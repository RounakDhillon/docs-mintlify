---
title: Getting Started with Collate for Data cataloging
...
<Columns cols={2}>
<Card icon="/public/images/icons/discovery.svg" title="Day 1: Connect your Data Sources and invite users" href="/quick-start/getting-started/day-1">
