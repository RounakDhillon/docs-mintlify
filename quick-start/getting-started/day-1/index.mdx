...
<img src="/images/v1.9/getting-started/add-ingestion0.png" alt="Ingestion Navigation" />

- Go to the **Agents** tab and click **Add Metadata Agent**.

<img src="/images/v1.9/getting-started/add-ingestion.png" alt="Adding Ingestion" />
...
<img src="/images/v1.9/getting-started/ingestion-config.png" alt="Configure Ingestion" />

- Schedule the pipeline to ingest metadata at regular intervals.

<img src="/images/v1.9/getting-started/schedule-ingesgtion.png" alt="Schedule Ingestion" />
...
<img src="/images/v1.9/getting-started/explore-tab.png" alt="Ingested Data" />
...
<img src="/images/v1.9/how-to-guides/admin-guide/email.png" alt="Email Configuration" />
...
<img src="/images/v1.9/getting-started/users.png" alt="Users Navigation" />

- Click **Add User**, then enter their email and other required details to grant access to the platform.

<img src="/images/v1.9/getting-started/add-users.png" alt="Adding New User" height="750px" />
...
<img src="/images/v1.9/getting-started/update-user.png" alt="Users Profile" />
...
<Columns cols={2}>
<Card title="Data Discovery" href="/how-to-guides/data-discovery">
  Discover the right data assets to make timely business decisions.
</Card>
<Card title="Data Collaboration" href="/how-to-guides/data-collaboration">
  Foster data team collaboration to enhance data understanding.
</Card>
<Card icon="/images/icons/check.svg" title="Data Quality & Observability" href="/how-to-guides/data-quality-observability">
  Trust your data with quality tests & monitor the health of your data systems.
</Card>
<Card icon="/images/icons/arrow-right.svg" title="Data Lineage" href="/how-to-guides/data-lineage">
  Trace the path of data across tables, pipelines, and dashboards.
</Card>
<Card title="Data Insights" href="/how-to-guides/data-insights">
  Define KPIs and set goals to proactively hone the data culture of your company.
</Card>
<Card title="Data Governance" href="/how-to-guides/data-governance">
...
<Columns cols={2}>
<Card title="Admin Guide" href="/how-to-guides/admin-guide">
  Admin users can get started with OpenMetadata with just three quick and easy steps & know-it-all with the advanced guides.
</Card>
<Card title="Guide for Data Users" href="/how-to-guides/guide-for-data-users">
