---
title: Day 1 Getting Started | Collate Day 1 Guide
...
<Columns cols={2}>
<Card icon="/public/images/icons/discovery.svg" title="Run the connector in OpenMetadata" href="/quick-start/getting-started/day-1/database-service-setup">
...
<img noZoom src="/public/images/getting-started/add-ingestion0.png" alt="Ingestion Navigation" />

- Go to the **Agents** tab and click **Add Metadata Agent**.

<img noZoom src="/public/images/getting-started/add-ingestion.png" alt="Adding Ingestion" />
...
<img noZoom src="/public/images/getting-started/ingestion-config.png" alt="Configure Ingestion" />

- Schedule the pipeline to ingest metadata at regular intervals.

<img noZoom src="/public/images/getting-started/schedule-ingesgtion.png" alt="Schedule Ingestion" />
...
<img noZoom src="/public/images/getting-started/explore-tab.png" alt="Ingested Data" />
...
<img noZoom src="/public/images/how-to-guides/admin-guide/email.png" alt="Email Configuration" />
...
<img noZoom src="/public/images/getting-started/users.png" alt="Users Navigation" />

- Click **Add User**, then enter their email and other required details to grant access to the platform.

<img noZoom src="/public/images/getting-started/add-users.png" alt="Adding New User" height="750px" />
...
<img noZoom src="/public/images/getting-started/update-user.png" alt="Users Profile" />
...
<Columns cols={2}>
<Card icon="/public/images/icons/data-discovery.svg" title="Data Discovery" href="/how-to-guides/data-discovery">
  Discover the right data assets to make timely business decisions.
</Card>
<Card icon="/public/images/icons/data-collaboration.svg" title="Data Collaboration" href="/how-to-guides/data-collaboration">
  Foster data team collaboration to enhance data understanding.
</Card>
<Card icon="/public/images/icons/data-quality.svg" title="Data Quality & Observability" href="/how-to-guides/data-quality-observability">
  Trust your data with quality tests & monitor the health of your data systems.
</Card>
<Card icon="/public/images/icons/data-lineage.svg" title="Data Lineage" href="/how-to-guides/data-lineage">
  Trace the path of data across tables, pipelines, and dashboards.
</Card>
<Card icon="/public/images/icons/data-insights.svg" title="Data Insights" href="/how-to-guides/data-insights">
  Define KPIs and set goals to proactively hone the data culture of your company.
</Card>
<Card icon="/public/images/icons/data-governance.svg" title="Data Governance" href="/how-to-guides/data-governance">
...
<Columns cols={2}>
<Card icon="/public/images/icons/admin-guide.svg" title="Admin Guide" href="/how-to-guides/admin-guide">
  Admin users can get started with OpenMetadata with just three quick and easy steps & know-it-all with the advanced guides.
</Card>
<Card icon="/public/images/icons/data-user.svg" title="Guide for Data Users" href="/how-to-guides/guide-for-data-users">
