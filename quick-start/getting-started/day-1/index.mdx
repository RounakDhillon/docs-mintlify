...
<Columns cols={2}>
<Card icon="/images/icons/discovery.svg" title="Run the connector in OpenMetadata" href="/quick-start/getting-started/day-1/database-service-setup">
...
<img src="/images/getting-started/add-ingestion0.png" alt="Ingestion Navigation" />
...
<img src="/images/how-to-guides/admin-guide/email.png" alt="Email Configuration" />
