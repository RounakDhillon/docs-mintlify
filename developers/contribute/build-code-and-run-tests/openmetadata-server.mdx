---
title: Collate Server | Developer Guide & Setup
...
sidebarTitle: Openmetadata server
---
...
<img noZoom src="/public/images/developers/contribute/build-code-and-run-tests/intellij-runtime-config.png" alt="Intellij Runtime Configuration" />
...
<img noZoom src="/public/images/developers/contribute/build-code-and-run-tests/intellij-openmetadata-service.png" alt="Open project" />

Click on "Open Module Settings"

<img noZoom src="/public/images/developers/contribute/build-code-and-run-tests/intellij-open-settings.png" alt="Open Module Settings" />

Go to "Dependencies"

<img noZoom src="/public/images/developers/contribute/build-code-and-run-tests/intellij-dependencies.png" alt="Go to dependencies" />

Click “+” at the bottom of the dialog box and click "Add"

<img noZoom src="/public/images/developers/contribute/build-code-and-run-tests/intellij-add-dependencies.png" alt="Add dependency" />

Click on Library

<img noZoom src="/public/images/developers/contribute/build-code-and-run-tests/intellij-library.png" alt="Click on Library" />

In that list look for "jersey-client:2.25.1"

<img noZoom src="/public/images/developers/contribute/build-code-and-run-tests/intellij-jersey-dependency.png" alt="Add jersey-client dependency" />
