---
title: Ingestion Framework | Collate Developer Guide
...
sidebarTitle: Ingestion framework
---
...
<img noZoom src="/public/images/developers/contribute/build-code-and-run-tests/pycharm-python-interpreter.png" alt="PyCharm env" />

Then, you can prepare `Run Configurations` to execute the ingestion as you would run the CLI:

<img noZoom src="/public/images/developers/contribute/build-code-and-run-tests/pycharm-run-config.png" alt="PyCharm run config" />
