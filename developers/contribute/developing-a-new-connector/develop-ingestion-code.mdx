...
<Card title="OpenMetadata 1.6.0 or later" href="/deployment" >
    Starting from 1.6.0, the OpenMetadata Ingestion Framework uses a ServiceSpec specification
to define the entry points for the ingestion process.
  </Card>
...
<Card title="Apply the UI Changes" href="/developers/contribute/developing-a-new-connector/apply-ui-changes" >
