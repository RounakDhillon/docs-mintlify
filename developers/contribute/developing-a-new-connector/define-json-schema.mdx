...
sidebarTitle: Define json schema
---
...
<Step title="additionalProperties">
...
<Steps>
<Step title="databaseServiceType">
...
<Card title="Develop the Ingestion Code" href="/developers/contribute/developing-a-new-connector/develop-ingestion-code" >
