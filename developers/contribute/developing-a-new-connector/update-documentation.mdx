...
sidebarTitle: Update documentation
---
...
Beware that any version that is suffixed with `-SNAPSHOT` is not shown. So in order to check it out you will need to remove the suffix and add it again afterwards.
</Tip>
