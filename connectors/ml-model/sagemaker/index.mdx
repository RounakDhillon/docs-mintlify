---
title: Sagemaker Connector | Collate ML Model Services
description: Connect your AWS SageMaker ML models to Collate for complete model lineage, metadata management, and data governance. Easy setup guide included.
