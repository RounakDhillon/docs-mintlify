...
<IngestionModeTiles yamlPath="/snippets/connectors/ml-model/sagemaker/yaml" />
...
<MetadataIngestionUi connector={"SageMaker"} selectServicePath={"/images/connectors/sagemaker/select-service.png"} addNewServicePath={"/images/connectors/sagemaker/add-new-service.png"} serviceConnectionPath={"/images/connectors/sagemaker/service-connection.png"} />
