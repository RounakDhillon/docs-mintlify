---
title: Sagemaker Hybrid Runner | Collate ML Model Services
description: Connect your AWS SageMaker ML models to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/ml-model/sagemaker/hybrid-runner
...
## Metadata Ingestion
<MetadataIngestionUi connector={"SageMaker"} selectServicePath={"/public/images/connectors/sagemaker/select-service.png"} addNewServicePath={"/public/images/connectors/sagemaker/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/sagemaker/service-connection.png"} />
# Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    title="SageMaker Troubleshooting"
    href="/connectors/ml-model/sagemaker/troubleshooting">
