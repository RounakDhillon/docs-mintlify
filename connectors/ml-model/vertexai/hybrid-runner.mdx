---
title: Vertexai Hybrid Runner | Official Docs
description: Connect VertexAI to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/ml-model/vertexai/hybrid-runner
...
## Metadata Ingestion
<MetadataIngestionUi connector={"Vertex AI"} selectServicePath={"/public/images/connectors/vertexai/select-service.png"} addNewServicePath={"/public/images/connectors/vertexai/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/vertexai/service-connection.png"} />
<Steps>
#### Connection Options
**GCP Credentials**:
...
<Columns cols={2}>
  <Card
    title="VertexAI Troubleshooting"
    href="/connectors/ml-model/vertexai/troubleshooting">
