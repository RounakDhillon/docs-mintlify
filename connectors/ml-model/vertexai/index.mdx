...
<IngestionModeTiles yamlPath="/snippets/connectors/ml-model/vertexai/yaml" />
...
<MetadataIngestionUi connector={"Vertex AI"} selectServicePath={"/images/connectors/vertexai/select-service.png"} addNewServicePath={"/images/connectors/vertexai/add-new-service.png"} serviceConnectionPath={"/images/connectors/vertexai/service-connection.png"} />
