...
<IngestionModeTiles yamlPath="/snippets/connectors/ml-model/mlflow/yaml" />
...
<MetadataIngestionUi connector={"MLflow"} selectServicePath={"/images/connectors/mlflow/select-service.png"} addNewServicePath={"/images/connectors/mlflow/add-new-service.png"} serviceConnectionPath={"/images/connectors/mlflow/service-connection.png"} />
