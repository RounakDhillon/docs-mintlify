---
title: MLflow Hybrid Runner | Collate ML Model Integration
description: Connect MLflow to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/ml-model/mlflow/hybrid-runner
...
Configure and schedule MLflow metadata and profiler workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="MLflow Troubleshooting"
    href="/connectors/ml-model/mlflow/troubleshooting">
