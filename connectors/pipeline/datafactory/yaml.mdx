...
<CodePreview>
<ContentPanel>
<ContentSection id={1} title="subscription_id" lines="8-13">
...
<ContentSection id={2} title="resource_group_name" lines="14">
...
<ContentSection id={3} title="factory_name" lines="15">
...
<ContentSection id={4} title="run_filter_days" lines="16">
