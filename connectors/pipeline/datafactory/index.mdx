...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/datafactory/yaml" />
...
<MetadataIngestionUi connector={"Data Factory"} selectServicePath={"/images/connectors/datafactory/select-service.png"} addNewServicePath={"/images/connectors/datafactory/add-new-service.png"} serviceConnectionPath={"/images/connectors/datafactory/service-connection.png"} />
