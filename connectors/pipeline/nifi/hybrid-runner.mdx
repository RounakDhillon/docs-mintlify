---
title: Nifi Hybrid Runner | Collate Data Pipeline Integration
description: Connect Apache NiFi to Collate seamlessly. Complete setup guide for NiFi pipeline connector with step-by-step configuration and metadata extraction.
slug: /connectors/pipeline/nifi/hybrid-runner
...
Configure and schedule NiFi metadata workflows from the Collate UI:
...
## Metadata Ingestion
<MetadataIngestionUi connector={"NiFi"} selectServicePath={"/public/images/connectors/nifi/select-service.png"} addNewServicePath={"/public/images/connectors/nifi/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/nifi/service-connection.png"} />
## Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    title="NiFi Troubleshooting"
    href="/connectors/pipeline/nifi/troubleshooting">
    Learn more about how to troubleshoot common NiFi connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
