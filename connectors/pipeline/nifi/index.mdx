...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/nifi/yaml" />
...
<MetadataIngestionUi connector={"NiFi"} selectServicePath={"/images/connectors/nifi/select-service.png"} addNewServicePath={"/images/connectors/nifi/add-new-service.png"} serviceConnectionPath={"/images/connectors/nifi/service-connection.png"} />
