---
title: Matillion Hybrid Runner | Official Documentation
description: Get started with matillion. Setup instructions, features, and configuration details inside.
slug: /connectors/pipeline/matillion/hybrid-runner
...
Configure and schedule Matillion metadata and profiler workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="Matillion Troubleshooting"
    href="/connectors/pipeline/matillion/troubleshooting">
    Learn more about how to troubleshoot common Matillion connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
