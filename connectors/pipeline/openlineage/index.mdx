...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/openlineage/yaml" />
...
<MetadataIngestionUi connector={"OpenLineage"} selectServicePath={"/images/connectors/openlineage/select-service.png"} addNewServicePath={"/images/connectors/openlineage/add-new-service.png"} serviceConnectionPath={"/images/connectors/openlineage/service-connection.png"} />
