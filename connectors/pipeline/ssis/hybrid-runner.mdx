---
title: SSIS Hybrid Runner
description: Ingest SSIS pipeline metadata, pipeline status, and lineage using the Hybrid Runner.
slug: /connectors/pipeline/ssis/hybrid-runner
...
- To retrieve lineage data, make the SSIS package XML files available through a local path or an S3 bucket.
## Metadata Ingestion
...
<Columns cols={2}>
  <Card
    title="SSIS Troubleshooting"
    href="/connectors/pipeline/ssis/troubleshooting">
