...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/ssis/yaml" />
...
<MetadataIngestionUi connector={"SSIS"} selectServicePath={"/images/connectors/ssis/select-service.png"} addNewServicePath={"/images/connectors/ssis/add-new-service.png"} serviceConnectionPath={"/images/connectors/ssis/service-connection.png"} />
