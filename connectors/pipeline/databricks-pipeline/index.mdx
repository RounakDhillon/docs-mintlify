...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/databricks-pipeline/yaml" />

## Metadata Ingestion

<MetadataIngestionUi connector={"Databricks Pipeline"} selectServicePath={"/images/connectors/databricks-pipeline/select-service.png"} addNewServicePath={"/images/connectors/databricks-pipeline/add-new-service.png"} serviceConnectionPath={"/images/connectors/databricks-pipeline/service-connection.png"} />
