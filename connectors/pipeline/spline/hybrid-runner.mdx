---
title: Spline Hybrid Runner | Collate Data Lineage Integration
...
slug: /connectors/pipeline/spline/hybrid-runner
...
Configure and schedule Spline metadata and profiler workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="Spline Troubleshooting"
    href="/connectors/pipeline/spline/troubleshooting">
    Learn more about how to troubleshoot common Spline connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
