...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/spline/yaml" />
...
<MetadataIngestionUi connector={"Spline"} selectServicePath={"/images/connectors/spline/select-service.png"} addNewServicePath={"/images/connectors/spline/add-new-service.png"} serviceConnectionPath={"/images/connectors/spline/service-connection.png"} />
