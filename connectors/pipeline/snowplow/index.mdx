...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/snowplow/yaml" />
...
<MetadataIngestionUi connector={"Snowplow"} selectServicePath={"/images/connectors/snowplow/select-service.png"} addNewServicePath={"/images/connectors/snowplow/add-new-service.png"} serviceConnectionPath={"/images/connectors/snowplow/service-connection.png"} />
