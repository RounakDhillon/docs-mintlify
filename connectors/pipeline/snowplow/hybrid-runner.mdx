---
title: Snowplow Hybrid Runner | Collate Pipeline Metadata
...
slug: /connectors/pipeline/snowplow/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="Snowplow Troubleshooting"
    href="/connectors/pipeline/snowplow/troubleshooting">
