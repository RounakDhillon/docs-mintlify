...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/stitch/yaml" />
...
<MetadataIngestionUi connector={"Stitch"} selectServicePath={"/images/connectors/stitch/select-service.png"} addNewServicePath={"/images/connectors/stitch/add-new-service.png"} serviceConnectionPath={"/images/connectors/stitch/service-connection.png"} />
