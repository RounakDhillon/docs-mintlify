...
Configure and schedule Wherescape metadata workflows from the Collate UI:
...
<ContentSection id={2} title="connection" lines="4-7">
**connection**:
...
<ContentSection id={2} title="SourceConfig" lines="15-34">
<SourceConfigDef />
</ContentSection>
<IngestionSinkDef />
<WorkflowConfigDef />
