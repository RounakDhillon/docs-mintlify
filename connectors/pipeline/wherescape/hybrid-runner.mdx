...
Configure and schedule Wherescape metadata workflow from the Collate UI:
- [Requirements](#requirements)
- [Metadata Ingestion](#metadata-ingestion)
    - [Connection Details](#connection-details)
- [Troubleshooting](/connectors/pipeline/wherescape/troubleshooting)
## Requirements
To extract Wherescape metadata, we need the database connection details where the metadata is stored.
...
<Columns cols={2}>
  <Card
    title="Wherescape Troubleshooting"
    href="/connectors/pipeline/wherescape/troubleshooting">
    Learn more about how to troubleshoot common Wherescape connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
