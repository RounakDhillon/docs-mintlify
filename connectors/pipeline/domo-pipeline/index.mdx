...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/domo-pipeline/yaml" />
...
<MetadataIngestionUi connector={"Domo Pipeline"} selectServicePath={"/images/connectors/domo-pipeline/select-service.png"} addNewServicePath={"/images/connectors/domo-pipeline/add-new-service.png"} serviceConnectionPath={"/images/connectors/domo-pipeline/service-connection.png"} />
