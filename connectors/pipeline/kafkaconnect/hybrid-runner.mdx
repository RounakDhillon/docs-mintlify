---
title: KafkaConnect Hybrid Runner | Collate Messaging Pipeline Connector
description: Configure Kafka Connect for metadata ingestion from real-time event streams, schema updates, and topic usage using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/pipeline/kafkaconnect/hybrid-runner
...
OpenMetadata is integrated with kafkaconnect up to version [3.6.1](https://kafka.apache.org/36/documentation/#connect) and will continue to work for future kafkaconnect versions.
...
<Columns cols={2}>
  <Card
    title="Kafka Connect Troubleshooting"
    href="/connectors/pipeline/kafkaconnect/troubleshooting">
