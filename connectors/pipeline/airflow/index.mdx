...
<MetadataIngestionUi connector={"Airflow"} selectServicePath={"/images/connectors/airflow/select-service.png"} addNewServicePath={"/images/connectors/airflow/add-new-service.png"} serviceConnectionPath={"/images/connectors/airflow/service-connection.png"} />
