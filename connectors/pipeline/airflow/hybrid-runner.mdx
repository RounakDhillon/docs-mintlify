---
title: Airflow Hybrid Runner | Collate Workflow Orchestration
description: Connect Apache Airflow to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/pipeline/airflow/hybrid-runner
...
Configure and schedule Airflow metadata workflow from the Collate UI:
...
Extract metadata from Airflow in AWS MWAA environments.
</Card>
<Card title="GCP Composer" href="/deployment/ingestion/external/gcp-composer">
Extract metadata from Airflow in Google Cloud Composer.
</Card>
</CardGroup>
## Requirements
<Tip>
...
<Columns cols={2}>
  <Card
    ...
    href="/connectors/pipeline/airflow/troubleshooting">
    Learn more about how to troubleshoot common Airflow connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
