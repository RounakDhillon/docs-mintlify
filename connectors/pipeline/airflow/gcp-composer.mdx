...
[here](/connectors/pipeline/airflow/yaml).
...
once they are released. Also, the image version should be aligned with your Collate server version to avoid
incompatibilities.
