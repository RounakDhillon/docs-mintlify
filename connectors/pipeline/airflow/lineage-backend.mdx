...
Where `x.y.z` is the version of your Collate server, e.g., 1.2.2. **It is important that server and client
versions match**.
...
<img src="/public/images/connectors/airflow/lineage-backend-dag.png" alt="DAG" />

<img src="/public/images/connectors/airflow/lineage-backend-lineage.png" alt="Lineage" />
