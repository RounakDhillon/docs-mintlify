...
<MetadataIngestionUi connector={"DBT Cloud"} selectServicePath={"/images/connectors/dbtcloud/select-service.png"} addNewServicePath={"/images/connectors/dbtcloud/add-new-service.png"} serviceConnectionPath={"/images/connectors/dbtcloud/service-connection.png"} />
...
<img src="/images/v1.9/connectors/dbtcloud/lineage.png" alt="dbt Cloud Lineage" />
