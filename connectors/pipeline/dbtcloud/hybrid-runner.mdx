---
title: dbt Cloud Connector Hybrid Runner | Collate Pipeline Integration
description: Connect dbt Cloud to Collate with our comprehensive pipeline connector guide using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction. Setup instructions, configuration examples, and troubleshooting tips.
slug: /connectors/pipeline/dbtcloud/hybrid-runner
...
Configure and schedule dbt Cloud metadata workflows from the Collate UI:
...
## Metadata Ingestion
<MetadataIngestionUi connector={"DBT Cloud"} selectServicePath={"/public/images/connectors/dbtcloud/select-service.png"} addNewServicePath={"/public/images/connectors/dbtcloud/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/dbtcloud/service-connection.png"} />
## Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    title="dbt Cloud Troubleshooting"
    href="/connectors/pipeline/dbtcloud/troubleshooting">
