---
title: Glue Pipeline Hybrid Runner | Collate Data Integration Pipeline
description: Set up metadata ingestion from Glue pipelines to track source-to-target flows, logic, and job parameters using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/pipeline/glue-pipeline/hybrid-runner
...
Configure and schedule Glue metadata workflows from the Collate UI:
...
- `glue:GetJobRuns`
## Metadata Ingestion
<MetadataIngestionUi connector={"Glue Pipeline"} selectServicePath={"/public/images/connectors/glue-pipeline/select-service.png"} addNewServicePath={"/public/images/connectors/glue-pipeline/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/glue-pipeline/service-connection.png"} />
## Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    title="Glue Pipeline Troubleshooting"
    href="/connectors/pipeline/glue-pipeline/troubleshooting">
    Learn more about how to troubleshoot common Glue Pipeline connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
