...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/glue-pipeline/yaml" />
...
<MetadataIngestionUi connector={"Glue Pipeline"} selectServicePath={"/images/connectors/glue-pipeline/select-service.png"} addNewServicePath={"/images/connectors/glue-pipeline/add-new-service.png"} serviceConnectionPath={"/images/connectors/glue-pipeline/service-connection.png"} />
