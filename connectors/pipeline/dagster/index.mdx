...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/dagster/yaml" />
...
<MetadataIngestionUi connector={"Dagster"} selectServicePath={"/images/connectors/dagster/select-service.png"} addNewServicePath={"/images/connectors/dagster/add-new-service.png"} serviceConnectionPath={"/images/connectors/dagster/service-connection.png"} />
