---
title: Dagster Hybrid Runner | Collate Pipeline Integration
description: Connect Dagster to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/pipeline/dagster/hybrid-runner
...
Configure and schedule Dagster metadata workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    ...
    href="/connectors/pipeline/dagster/troubleshooting">
    Learn more about how to troubleshoot common Dagster connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
