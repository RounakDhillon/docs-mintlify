---
title: Fivetran Connector Hybrid Runner | Collate Data Integration
description: Connect Fivetran pipelines to Collate for automated data lineage tracking, metadata discovery, and comprehensive pipeline monitoring and governance using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/pipeline/fivetran/hybrid-runner
...
Configure and schedule Fivetran metadata workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="Fivetran Troubleshooting"
    href="/connectors/pipeline/fivetran/troubleshooting">
    Learn more about how to troubleshoot common Fivetran connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
