...
<IngestionModeTiles yamlPath="/snippets/connectors/pipeline/fivetran/yaml" />
...
<MetadataIngestionUi connector={"Fivetran"} selectServicePath={"/images/connectors/fivetran/select-service.png"} addNewServicePath={"/images/connectors/fivetran/add-new-service.png"} serviceConnectionPath={"/images/connectors/fivetran/service-connection.png"} />
