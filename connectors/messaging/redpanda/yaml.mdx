...
<ContentSection id={8} title="consumerConfig" lines="15">
...
<ContentSection id={9} title="schemaRegistryConfig" lines="16">
...
<ContentSection id={10} title="securityProtocol" lines="17">
**securityProtocol**: security.protocol consumer config property. It accepts `PLAINTEXT`,`SASL_PLAINTEXT`, `SASL_SSL`, `SSL`.
</ContentSection>
<ContentSection id={11} title="supportsMetadataExtraction" lines="18">
