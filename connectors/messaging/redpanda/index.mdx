...
<IngestionModeTiles yamlPath="/snippets/connectors/messaging/redpanda/yaml" />
...
<MetadataIngestionUi connector={"Redpanda"} selectServicePath={"/images/connectors/redpanda/select-service.png"} addNewServicePath={"/images/connectors/redpanda/add-new-service.png"} serviceConnectionPath={"/images/connectors/redpanda/service-connection.png"} />
