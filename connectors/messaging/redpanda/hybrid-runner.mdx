...
slug: /connectors/messaging/redpanda/hybrid-runner
...
Configure and schedule Redpanda metadata and profiler workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="Redpanda Troubleshooting"
    href="/connectors/messaging/redpanda/troubleshooting">
    Learn more about how to troubleshoot common Redpanda connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
