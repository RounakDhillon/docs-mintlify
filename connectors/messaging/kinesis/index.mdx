...
<IngestionModeTiles yamlPath="/snippets/connectors/messaging/kinesis/yaml" />
...
<MetadataIngestionUi connector={"Kinesis"} selectServicePath={"/images/connectors/kinesis/select-service.png"} addNewServicePath={"/images/connectors/kinesis/add-new-service.png"} serviceConnectionPath={"/images/connectors/kinesis/service-connection.png"} />
