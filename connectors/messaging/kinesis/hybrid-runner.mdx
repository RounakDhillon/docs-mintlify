---
title: Kinesis Connector | Collate Streaming Integration
description: Connect Amazon Kinesis to Collate with our comprehensive connector guide. Set up real-time streaming data ingestion and metadata extraction easily.
slug: /connectors/messaging/kinesis/hybrid-runner
...
Configure and schedule Kinesis metadata workflows from the Collate UI:
...
As AWS can have instances in multiple regions, we need to know which region the service you want to reach belongs to.
...
<Columns cols={2}>
  <Card
    title="Kinesis Troubleshooting"
    href="/connectors/messaging/kinesis/troubleshooting">
    Learn more about how to troubleshoot common Kinesis connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
