...
<ContentSection id={7} title="basicAuthUserInfo" lines="14">
...
<ContentSection id={8} title="consumerConfig" lines="15-19">
...
<ContentSection id={9} title="schemaRegistryConfig" lines="20-23">
...
<ContentSection id={10} title="securityProtocol" lines="24">
**securityProtocol**: security.protocol consumer config property. It accepts `PLAINTEXT`,`SASL_PLAINTEXT`, `SASL_SSL`, `SSL`.
</ContentSection>
<ContentSection id={11} title="schemaRegistryTopicSuffixName" lines="25">
...
<ContentSection id={12} title="schemaRegistrySSL" lines="32-35">
**schemaRegistrySSL**: Schema Registry SSL Config. Configuration for enabling SSL for the Schema Registry connection.
</ContentSection>
<ContentSection id={13} title="supportsMetadataExtraction" lines="36">
