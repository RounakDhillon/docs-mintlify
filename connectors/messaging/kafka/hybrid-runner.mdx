...
slug: /connectors/messaging/kafka/hybrid-runner
...
Configure and schedule Kafka metadata and profiler workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    ...
    href="/connectors/messaging/kafka/troubleshooting">
    Learn more about how to troubleshoot common Kafka connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
