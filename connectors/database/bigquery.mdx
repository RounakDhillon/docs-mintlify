...
<Card icon="user-gear" iconType="solid" title="Create Custom GCP Role" icon="/public/images/icons/administration.svg" href="/connectors/database/bigquery/create-credentials">
