...
description: 'Connect Google BigQuery to Collate for comprehensive cloud data warehouse integration. Advanced features including query logs, incremental extraction, and native GCP authentication.'
---

# Google BigQuery Connector

<CardGroup cols={3}>
  <Card title="Cloud Native" icon="/images/icons/cloud.svg" color="#4285f4">
    Native Google Cloud Platform integration
  </Card>
  <Card title="Advanced Analytics" icon="/images/icons/celebration.svg" color="#34a853">
    Query logs and usage analytics
  </Card>
  <Card title="Enterprise Scale" icon="/images/icons/puzzle.svg" color="#ea4335">
...
The BigQuery connector provides deep integration with Google Cloud's serverless data warehouse, offering comprehensive metadata discovery, advanced query analysis, and seamless authentication with Google Cloud services.

### Supported Features

- ✅ **Metadata Discovery**: Complete dataset, table, and column discovery
- ✅ **Query Usage**: Advanced query logs analysis and usage patterns
- ✅ **Data Lineage**: Table and view relationship tracking through query analysis
- ✅ **Column-level Lineage**: Detailed column dependency mapping
- ✅ **Data Profiler**: Statistical analysis across all BigQuery table types
- ✅ **Data Quality**: Custom quality tests and continuous monitoring
- ✅ **dbt Integration**: Native dbt model and lineage support
- ✅ **Tags**: BigQuery labels and tag discovery
- ✅ **Stored Procedures**: Function and procedure discovery
...
- ❌ **Owners**: Owner information extraction not supported by BigQuery API
...
You need to create a service account in order to ingest metadata from BigQuery. Refer to [this](/connectors/database/bigquery/create-credentials) guide on how to create a service account.

<Card title="Create Custom GCP Role" icon="/images/icons/administration.svg" href="/connectors/database/bigquery/create-credentials">
...
<Accordion title="Data Catalog API Access">
...
<Accordion title="External Tables Permissions">
...
<Accordion title="Sharded vs Partitioned Tables">
...
If you have attached policy tags to the columns of table available in BigQuery, then Collate will fetch those tags and attach it to the respective columns.
...
<Accordion title="Application Default Credentials (ADC) Authentication">
...
The Reverse Metadata feature allows you to push metadata changes from Collate back to BigQuery, ensuring your source system stays synchronized with any updates made in the data catalog.