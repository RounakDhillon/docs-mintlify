...
description: Learn how to connect ClickHouse databases to Collate with our comprehensive connector guide. Setup instructions, configuration options, and troubleshooting guidance.
slug: /connectors/database/clickhouse/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="ClickHouse Troubleshooting"
    href="/connectors/database/clickhouse/troubleshooting">
    Learn more about how to troubleshoot common ClickHouse connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
