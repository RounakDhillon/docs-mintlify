...
<IngestionModeTiles yamlPath="/snippets/connectors/database/clickhouse/yaml" />
...
<MetadataIngestionUi connector={"ClickHouse"} selectServicePath={"/images/connectors/clickhouse/select-service.png"} addNewServicePath={"/images/connectors/clickhouse/add-new-service.png"} serviceConnectionPath={"/images/connectors/clickhouse/service-connection.png"} />
