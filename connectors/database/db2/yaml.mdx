...
<ContentSection id={8} title="Connection Options" lines="13-14">

**Connection Options (Optional)**: Enter the details for any additional connection options that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={9} title="Connection Arguments" lines="15-16">
...
<ContentSection id={10} title="Source Config" lines="17-19">

<SourceConfigDef />

</ContentSection>

<ContentSection id={11} title="Sink Configuration" lines="20-22">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={12} title="Workflow Configuration" lines="23-39">
