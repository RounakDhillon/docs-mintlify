...
## Metadata Ingestion
<MetadataIngestionUi connector={"DB2"} selectServicePath={"/images/connectors/db2/select-service.png"} addNewServicePath={"/images/connectors/db2/add-new-service.png"} serviceConnectionPath={"/images/connectors/db2/service-connection.png"} />
