---
title: Iceberg Connector | Collate Data Lake Integration Guide
description: Learn how to connect Apache Iceberg with Collate using our comprehensive connector guide. Configure metadata extraction, lineage tracking, and data...
...
## Metadata Ingestion
<MetadataIngestionUi connector={"Iceberg"} selectServicePath={"/public/images/connectors/iceberg/select-service.png"} addNewServicePath={"/public/images/connectors/iceberg/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/iceberg/service-connection.png"} />
<Steps>
...
<img noZoom src="/public/images/connectors/restcatalog_ssl.png" alt="SSL Configuration" height="450px" />
<Related />
