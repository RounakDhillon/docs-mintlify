...
<MetadataIngestionUi connector={"Iceberg"} selectServicePath={"/images/connectors/iceberg/select-service.png"} addNewServicePath={"/images/connectors/iceberg/add-new-service.png"} serviceConnectionPath={"/images/connectors/iceberg/service-connection.png"} />
...
<img src="/images/v1.9/connectors/restcatalog_ssl.png" alt="SSL Configuration" height="450px" />
