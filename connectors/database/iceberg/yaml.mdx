...
<ContentSection id={2} title="Catalog Name" lines="8">

**name**: Enter the catalog name of choice.

</ContentSection>

<ContentSection id={3} title="AWS Configuration" lines="9-12">
...
<ContentSection id={4} title="Database Name" lines="13">

**databaseName (optional)**: Enter the database name of choice. If not it will be set as 'default'.

</ContentSection>

<ContentSection id={5} title="Ownership Property" lines="14">

**ownershipProperty (optional)**: Property to use when searching for the owner. It defaults to 'owner'.

</ContentSection>

<ContentSection id={6} title="Source Config" lines="15-17">

<SourceConfigDef />

</ContentSection>

<ContentSection id={7} title="Sink Configuration" lines="18-20">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={8} title="Workflow Configuration" lines="21-37">
...
<ContentSection id={3} title="Table Name" lines="9">

**tableName**: Enter the name of the table where the Iceberg Catalog is stored.

</ContentSection>

<ContentSection id={4} title="AWS Configuration" lines="10-13">
...
<ContentSection id={5} title="Database Name" lines="14">

**databaseName (optional)**: Enter the database name of choice. If not it will be set as 'default'.

</ContentSection>

<ContentSection id={6} title="Ownership Property" lines="15">

**ownershipProperty (optional)**: Property to use when searching for the owner. It defaults to 'owner'.

</ContentSection>

<ContentSection id={7} title="Source Config" lines="16-18">

<SourceConfigDef />

</ContentSection>

<ContentSection id={8} title="Sink Configuration" lines="19-21">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={9} title="Workflow Configuration" lines="22-38">
...
<ContentSection id={3} title="URI" lines="9">

**uri**: Enter the uri to the Hive Metastore. Example: 'thrift://localhost:9083'.

</ContentSection>

<ContentSection id={4} title="File System" lines="10-21">
...
<ContentSection id={5} title="Database Name" lines="22">

**databaseName (optional)**: Enter the database name of choice. If not it will be set as 'default'.

</ContentSection>

<ContentSection id={6} title="Ownership Property" lines="23">

**ownershipProperty (optional)**: Property to use when searching for the owner. It defaults to 'owner'.

</ContentSection>

<ContentSection id={7} title="Source Config" lines="24-26">

<SourceConfigDef />

</ContentSection>

<ContentSection id={8} title="Sink Configuration" lines="27-29">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={9} title="Workflow Configuration" lines="30-46">
...
<ContentSection id={4} title="Credential" lines="10-12">
...
<ContentSection id={5} title="Token" lines="13">

**token (Optional)**: Enter the Bearer token for the 'Authorization' header.

</ContentSection>

<ContentSection id={6} title="SSL Configuration" lines="14-17">
...
<ContentSection id={7} title="SigV4" lines="18-20">
...
<ContentSection id={8} title="File System" lines="21-32">
...
<ContentSection id={9} title="Database Name" lines="33">

**databaseName (optional)**: Enter the database name of choice. If not it will be set as 'default'.

</ContentSection>

<ContentSection id={10} title="Warehouse Location" lines="34-35">
...
<ContentSection id={11} title="Ownership Property" lines="36">

**ownershipProperty (optional)**: Property to use when searching for the owner. It defaults to 'owner'.

</ContentSection>

<ContentSection id={12} title="Source Config" lines="37-39">

<SourceConfigDef />

</ContentSection>

<ContentSection id={13} title="Sink Configuration" lines="40-42">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={14} title="Workflow Configuration" lines="43-59">
