...
<ContentSection id={3} title="FHIR Version" lines="7">

**fhirVersion**: FHIR specification version supported (`R4`, `STU3`, or `DSTU2`).

</ContentSection>

<ContentSection id={4} title="Database Name" lines="2">

**databaseName**: Optional name for the database in OpenMetadata. Defaults to `epic`.

</ContentSection>

<ContentSection id={5} title="Filter Patterns" lines="7">
...
<ContentSection id={6} title="Sink Configuration" lines="24-26">
