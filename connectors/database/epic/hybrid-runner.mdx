---
title: Epic FHIR Hybrid Runner | Collate Healthcare Integration Guide
description: Connect Epic FHIR to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/epic/hybrid-runner
...
- [Troubleshooting](/connectors/database/epic/troubleshooting)
## Requirements
...
<Columns cols={2}>
  <Card
    title="Epic Troubleshooting"
    href="/connectors/database/epic/troubleshooting">
    Learn more about how to troubleshoot common Epic connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
