---
title: Dremio Hybrid Runner | Collate Database Integration Guide
description: Connect Dremio to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/dremio/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="Dremio Troubleshooting"
    href="/connectors/database/dremio/troubleshooting">
    Learn more about how to troubleshoot common Dremio connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
