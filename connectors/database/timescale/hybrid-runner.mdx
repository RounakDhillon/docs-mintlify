---
title: TimescaleDB Hybrid Runner | Collate Database Integration
description: Connect TimescaleDB to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/timescale/hybrid-runner
...
Configure and schedule TimescaleDB metadata and profiler workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    ...
    href="/connectors/database/timescale/troubleshooting">
    Learn more about how to troubleshoot common TimescaleDB connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
