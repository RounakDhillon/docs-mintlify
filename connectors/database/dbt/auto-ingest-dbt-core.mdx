...
slug: /connectors/database/dbt/auto-ingest-dbt-core
...
2. **Configure additional dbt features** like [tags](/connectors/database/dbt/ingest-dbt-tags), [tiers](/connectors/database/dbt/ingest-dbt-tier), and [glossary](/connectors/database/dbt/ingest-dbt-glossary)
3. **Set up data governance** policies and workflows
4. **Schedule regular ingestion** for keeping metadata up-to-date

For additional troubleshooting, refer to the [dbt Troubleshooting Guide](/connectors/database/dbt/dbt-troubleshooting).