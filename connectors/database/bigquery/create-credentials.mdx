---
title: BigQuery Connector | Set Up Credentials in Collate
description: Learn how to create and configure BigQuery credentials for Collate Database Connector. Step-by-step guide with authentication setup and best practices.
slug: /connectors/database/bigquery/create-credentials
sidebarTitle: Create Credentials
---
...
<img noZoom src="/public/images/connectors/bigquery/create-role-1.png" alt="Navigate to Roles" />
...
<img noZoom src="/public/images/connectors/bigquery/create-role-2.png" alt="Create Role Button" />
...
<img noZoom src="/public/images/connectors/bigquery/create-role-3.png" alt="Create Role" />
...
<img noZoom src="/public/images/connectors/bigquery/create-role-4.png" alt="Add Permissions" />

Once you have added all the required permissions, you can create the role by clicking on the create button.

<img noZoom src="/public/images/connectors/bigquery/create-role-5.png" alt="Add Permissions" />
...
<img noZoom src="/public/images/connectors/bigquery/bq-service-account-search.png" alt="Navigate to Service Accounts" />
...
<img noZoom src="/public/images/connectors/bigquery/bq-create-service-account.png" alt="Create Service Accounts" />

Fill the service account details

<img noZoom src="/public/images/connectors/bigquery/bq-create-service-account-1.png" alt="Create Service Accounts" />

Grant a role to service account which has all the required permission to ingest BigQuery metadata in OpenMetadata.

<img noZoom src="/public/images/connectors/bigquery/bq-service-account-grant-role.png" alt="Grant Role to Service Account" />
...
<img noZoom src="/public/images/connectors/bigquery/bq-service-account-manage-keys.png" alt="Service Account Manage Keys" />
...
<img noZoom src="/public/images/connectors/bigquery/bq-create-service-account-key.png" alt="Create New Key" />

<img noZoom src="/public/images/connectors/bigquery/bq-create-key-modal.png" alt="Download json Key" />
