...
<ContentSection id={9} title="Connection Options" lines="27">

**Connection Options (Optional)**: Enter the details for any additional connection options that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={10} title="Connection Arguments" lines="29">
...
<ContentSection id={11} title="Source Config" lines="31-74">

<SourceConfigDef />

</ContentSection>

<ContentSection id={12} title="Sink Configuration" lines="75-77">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={13} title="Workflow Configuration" lines="78-94">
