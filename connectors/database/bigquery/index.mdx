...
<Columns cols={2}>
<Card icon="user-gear" iconType="solid" title="Create Custom GCP Role" href="/connectors/database/bigquery/create-credentials">
...
<MetadataIngestionUi connector={"BigQuery"} selectServicePath={"/images/connectors/bigquery/select-service.png"} addNewServicePath={"/images/connectors/bigquery/add-new-service.png"} serviceConnectionPath={"/images/connectors/bigquery/service-connection.png"} />
