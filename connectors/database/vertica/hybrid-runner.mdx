---
title: Vertica Hybrid Runner | Collate Analytics Database Guide
description: Connect Vertica to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/vertica/hybrid-runner
...
Configure and schedule Vertica metadata and profiler workflows from the Collate UI:
...
```
## Metadata Ingestion
<MetadataIngestionUi connector={"Vertica"} selectServicePath={"/public/images/connectors/vertica/select-service.png"} addNewServicePath={"/public/images/connectors/vertica/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/vertica/service-connection.png"} />
# Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    title="Vertica Troubleshooting"
    href="/connectors/database/vertica/troubleshooting">
    Learn more about how to troubleshoot common Vertica connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
