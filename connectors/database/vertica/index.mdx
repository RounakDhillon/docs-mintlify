---
title: Vertica Connector | Collate Analytics Database Guide
description: Connect Vertica database to Collate with our comprehensive connector guide. Easy setup, configuration steps, and metadata extraction for your data catalog.
