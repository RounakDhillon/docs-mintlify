...
## Metadata Ingestion
<MetadataIngestionUi connector={"Vertica"} selectServicePath={"/images/connectors/vertica/select-service.png"} addNewServicePath={"/images/connectors/vertica/add-new-service.png"} serviceConnectionPath={"/images/connectors/vertica/service-connection.png"} />
