...
<CardGroup cols={3}>
  <Card title="AWS Native" icon="/images/icons/cloud.svg" color="#ff9900">
    Native AWS authentication and integration
  </Card>
  <Card title="Enterprise Scale" icon="/images/icons/puzzle.svg" color="#3b82f6">
    Optimized for large-scale data warehouses
  </Card>
  <Card title="Query Analytics" icon="/images/icons/celebration.svg" color="#8b5cf6">
