...
slug: /connectors/database/athena/hybrid-runner
---
...
<Columns cols={2}>
  <Card
    title="Athena Troubleshooting"
    href="/connectors/database/athena/troubleshooting">
    Learn more about how to troubleshoot common Athena connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
