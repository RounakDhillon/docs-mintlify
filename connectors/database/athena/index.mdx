---
title: "Athena | Collate Database Connector Configuration"
sidebarTitle: Overview
description: Connect Amazon Athena to Collate effortlessly. Complete setup guide, configuration steps, and best practices for database metadata ingestion.
slug: /connectors/database/athena
---
import ReverseMetadata from '/snippets/connectors/database/athena/reverse-metadata.mdx'
...
Configure and schedule Athena metadata and profiler workflows from the Collate UI:
...
```
### LF-Tags
Athena connector ingests and creates LF-tags in OpenMetadata with LF-tag key mapped to Collate's classification and the values mapped to tag labels. To ingest LF-tags provide the appropriate permissions as to the resources as mentioned above and enable the `includeTags` toggle in the ingestion config.
<Tip>If you have external services other than glue and facing permission issues, add the permissions to the list above.</Tip>
## Metadata Ingestion
<MetadataIngestionUi connector="Athena" selectServicePath="/public/images/connectors/athena/select-service.png" addNewServicePath="/public/images/connectors/athena/add-new-service.png" serviceConnectionPath="/public/images/connectors/athena/service-connection.png" />
## Connection Details
