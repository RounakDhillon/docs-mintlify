...
Configure and schedule ADLS Datalake metadata and profiler workflows from the Collate UI:
...
In order to create and run a Metadata Ingestion workflow, we will follow the steps to create a YAML configuration able to connect to the source, process the Entities if needed, and reach the Collate server.
