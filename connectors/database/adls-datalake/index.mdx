...
<MetadataIngestionUi connector={"ADLS Datalake"} selectServicePath={"/public/images/connectors/adls-datalake/select-service.png"} addNewServicePath={"/public/images/connectors/adls-datalake/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/adls-datalake/service-connection.png"} />
