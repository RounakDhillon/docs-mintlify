...
<IngestionModeTiles yamlPath="/snippets/connectors/database/oracle/yaml" />
...
<MetadataIngestionUi connector={"Oracle"} selectServicePath={"/images/connectors/oracle/select-service.png"} addNewServicePath={"/images/connectors/oracle/add-new-service.png"} serviceConnectionPath={"/images/connectors/oracle/service-connection.png"} />
