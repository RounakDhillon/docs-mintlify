---
title: Oracle Connector | Collate Enterprise Database Guide
description: Connect Oracle Collate to Collate effortlessly. Complete setup guide, configuration steps, and troubleshooting tips for seamless data catalog integration.
slug: /connectors/database/oracle
sidebarTitle: Overview
---
import ReverseMetadata from '/snippets/connectors/database/oracle/reverse-metadata.mdx'
...
Configure and schedule Oracle metadata and profiler workflows from the Collate UI:
...
## Metadata Ingestion
<MetadataIngestionUi connector={"Oracle"} selectServicePath={"/public/images/connectors/oracle/select-service.png"} addNewServicePath={"/public/images/connectors/oracle/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/oracle/service-connection.png"} />
## Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    ...
    href="/connectors/database/oracle/troubleshooting">
    Learn more about how to troubleshoot common Oracle connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
