...
<ContentSection id={7} title="Connection Options" lines="15-16">
...
<ContentSection id={8} title="Connection Arguments" lines="17-18">
...
<ContentSection id={9} title="Source Config" lines="19-21">

<SourceConfigDef />

</ContentSection>

<ContentSection id={10} title="Sink Configuration" lines="22-24">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={11} title="Workflow Configuration" lines="25-41">
