---
title: Oracle Hybrid Runner | Collate Enterprise Database Guide
description: Connect Oracle Collate to Collate using the Hybrid Runner deployment. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/oracle/hybrid-runner
