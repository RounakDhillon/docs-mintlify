...
<ContentSection id={2} title="Security Config" lines="7-20">
...
<ContentSection id={5} title="Filter Patterns" lines="28">
...
<ContentSection id={6} title="Source Config" lines="21-64">

<SourceConfigDef />

</ContentSection>

<ContentSection id={7} title="Sink Configuration" lines="65-67">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={8} title="Workflow Configuration" lines="68-84">
