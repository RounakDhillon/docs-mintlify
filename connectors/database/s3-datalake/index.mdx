...
```
## Metadata Ingestion
<MetadataIngestionUi connector={"S3 Datalake"} selectServicePath={"/public/images/connectors/s3-datalake/select-service.png"} addNewServicePath={"/public/images/connectors/s3-datalake/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/s3-datalake/service-connection.png"} />
<Steps>
