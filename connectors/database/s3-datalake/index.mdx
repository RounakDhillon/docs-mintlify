...
<MetadataIngestionUi connector={"S3 Datalake"} selectServicePath={"/images/connectors/s3-datalake/select-service.png"} addNewServicePath={"/images/connectors/s3-datalake/add-new-service.png"} serviceConnectionPath={"/images/connectors/s3-datalake/service-connection.png"} />
