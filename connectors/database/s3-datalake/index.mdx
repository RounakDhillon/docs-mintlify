---
title: S3 Datalake Connector | Collate Cloud Storage Guide
description: Connect your S3 data lake to Collate with our comprehensive database connector guide. Setup instructions, configuration examples, and best practices included.
...
Configure and schedule S3 Datalake metadata and profiler workflows from the Collate UI:
...
```
## Metadata Ingestion
<MetadataIngestionUi connector={"S3 Datalake"} selectServicePath={"/public/images/connectors/datalake/select-service.png"} addNewServicePath={"/public/images/connectors/datalake/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/datalake/service-connection.png"} />
## Connection Details
<Steps>
<Step title="Connection Details for AWS">
...
<Columns cols={2}>
  <Card
    title="S3 Datalake Troubleshooting"
    href="/connectors/database/s3-datalake/troubleshooting">
    Learn more about how to troubleshoot common S3 Datalake connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
