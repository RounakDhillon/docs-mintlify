---
title: Greenplum Hybrid Runner | Collate Database Integration Guide
description: Connect Greenplum to Collate using the Hybrid Runner deployment. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/greenplum/hybrid-runner
...
## Metadata Ingestion
<MetadataIngestionUi connector={"Greenplum"} selectServicePath={"/public/images/connectors/greenplum/select-service.png"} addNewServicePath={"/public/images/connectors/greenplum/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/greenplum/service-connection.png"} />
# Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    title="Greenplum Troubleshooting"
    href="/connectors/database/greenplum/troubleshooting">
    Learn more about how to troubleshoot common Greenplum connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
