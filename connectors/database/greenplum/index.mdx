...
<MetadataIngestionUi connector={"Greenplum"} selectServicePath={"/images/connectors/greenplum/select-service.png"} addNewServicePath={"/images/connectors/greenplum/add-new-service.png"} serviceConnectionPath={"/images/connectors/greenplum/service-connection.png"} />
