...
Configure and schedule Greenplum metadata and profiler workflows from the Collate UI:
...
<ContentSection id={4} title="IAM Based Authentication" lines="10-14">
...
<ContentSection id={8} title="SSL Configuration" lines="19">
...
<ContentSection id={9} title="Connection Options" lines="20">

**Connection Options (Optional)**: Enter the details for any additional connection options that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={10} title="Connection Arguments" lines="21">
...
## dbt Integration
You can learn more about how to ingest dbt models' definitions and their lineage [here](/connectors/database/dbt).
