...
slug: /connectors/database/bigtable/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="BigTable Troubleshooting"
    href="/connectors/database/bigtable/troubleshooting">
    Learn more about how to troubleshoot common BigTable connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
