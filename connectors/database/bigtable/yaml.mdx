...
<ContentSection id={3} title="Credentials" lines="7-21">
...
<ContentSection id={4} title="GCP Configuration" lines="8-21">
...
<ContentSection id={5} title="Connection Options" lines="22">

**Connection Options (Optional)**: Enter the details for any additional connection options that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={6} title="Connection Arguments" lines="24">
