...
description: Learn how to Configure OpenMetadata'sBigtable database connector using YAML. Complete setup guide with examples, parameters, and best practices.
...
<Columns cols={2}>
<Card icon="user-gear" iconType="solid" title="Create Custom GCP Role" href="/connectors/database/bigtable/roles">
