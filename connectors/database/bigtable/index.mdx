...
<Columns cols={2}>
<Card
  icon="user-gear" iconType="solid"
  title="Create Custom GCP Role"
  href="/connectors/database/bigtable/roles">
...
<MetadataIngestionUi connector={"BigTable"} selectServicePath={"/images/connectors/bigtable/select-service.png"} addNewServicePath={"/images/connectors/bigtable/add-new-service.png"} serviceConnectionPath={"/images/connectors/bigtable/service-connection.png"} />
