---
title: MongoDB Hybrid Runner | Collate NoSQL Database Integration
description: Connect MongoDB to Collate using the Hybrid Runner deployment. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/mongodb/hybrid-runner
