...
<MetadataIngestionUi connector={"MongoDB"} selectServicePath={"/images/connectors/mongodb/select-service.png"} addNewServicePath={"/images/connectors/mongodb/add-new-service.png"} serviceConnectionPath={"/images/connectors/mongodb/service-connection.png"} />
