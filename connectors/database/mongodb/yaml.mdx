...
<ContentSection id={6} title="Connection Options" lines="10-11">
...
<ContentSection id={7} title="Source Config" lines="13-15">
...
<ContentSection id={9} title="Workflow Configuration" lines="19-35">
...
<ContentSection id={2} title="Process PII Sensitive" lines="7">

**processPiiSensitive**: Optional configuration to automatically tag columns that might contain sensitive information.

</ContentSection>

<ContentSection id={3} title="Timeout Seconds" lines="8">

**timeoutSeconds**: Profiler Timeout in Seconds

</ContentSection>

<ContentSection id={4} title="Schema Filter Pattern" lines="9-14">

**schemaFilterPattern**: Regex to only fetch tables or databases that matches the pattern.

</ContentSection>

<ContentSection id={5} title="Table Filter Pattern" lines="15-20">

**tableFilterPattern**: Regex to only fetch tables or databases that matches the pattern.

</ContentSection>

<ContentSection id={6} title="Processor Configuration" lines="21-26">
...
<ContentSection id={7} title="Sink Configuration" lines="27-28">
...
<ContentSection id={8} title="Workflow Configuration" lines="29-32">
...
<ContentSection id={1} title="Import Necessary Modules" lines="2-6">
...
<ContentSection id={2} title="Default Arguments" lines="8-15">
...
<ContentSection id={3} title="Config" lines="17-18">

- **config**: Specifies config for the profiler as we prepare above.

</ContentSection>

<ContentSection id={4} title="Workflow Function" lines="20-30">
...
<ContentSection id={5} title="DAG Definition" lines="32-39">
