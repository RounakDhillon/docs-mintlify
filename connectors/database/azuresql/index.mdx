...
<MetadataIngestionUi connector={"AzureSQL"} selectServicePath={"/images/connectors/azuresql/select-service.png"} addNewServicePath={"/images/connectors/azuresql/add-new-service.png"} serviceConnectionPath={"/images/connectors/azuresql/service-connection.png"} />
