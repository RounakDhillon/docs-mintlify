...
slug: /connectors/database/azuresql/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="AzureSQL Troubleshooting"
    href="/connectors/database/azuresql/troubleshooting">
    Learn more about how to troubleshoot common AzureSQL connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
