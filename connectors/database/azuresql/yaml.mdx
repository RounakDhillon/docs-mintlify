...
description: Configure Azure SQL database connections in Collate with our comprehensive YAML setup guide. Step-by-step instructions for seamless data integration.
...
Configure the source type and service name for your AzureSQL connector.

</ContentSection>

<ContentSection id={2} title="Connection Type" lines="6">

**type**: Set to `AzureSQL` for AzureSQL connections.
...
<ContentSection id={7} title="Driver" lines="11">
...
<ContentSection id={8} title="Authentication Mode" lines="12-16">
...
<ContentSection id={9} title="Connection Options" lines="17">

**Connection Options (Optional)**: Enter the details for any additional connection options that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={10} title="Connection Arguments" lines="19">
...
<ContentSection id={11} title="Source Config" lines="21-64">

<SourceConfigDef />

</ContentSection>

<ContentSection id={12} title="Sink Configuration" lines="65-67">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={13} title="Workflow Configuration" lines="68-84">
...
<CodePanel fileName="azuresql_config.yaml">
...
<IngestionCli />
<Lineage connector="azuresql" />
<DataProfiler connector="azuresql" />
<AutoClassification connector="azuresql" />
<DataQuality />
## dbt Integration
<Columns cols={2}>
