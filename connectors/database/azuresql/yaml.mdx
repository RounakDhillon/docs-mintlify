...
<ContentSection id={8} title="Authentication Mode" lines="13-17">
...
<ContentSection id={11} title="Source Config" lines="22">

<SourceConfigDef />

</ContentSection>

<ContentSection id={12} title="Sink Configuration" lines="23">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={13} title="Workflow Configuration" lines="24">
