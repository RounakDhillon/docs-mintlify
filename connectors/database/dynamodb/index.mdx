...
<MetadataIngestionUi connector={"DynamoDB"} selectServicePath={"/images/connectors/dynamodb/select-service.png"} addNewServicePath={"/images/connectors/dynamodb/add-new-service.png"} serviceConnectionPath={"/images/connectors/dynamodb/service-connection.png"} />
