---
title: DynamoDB Hybrid Runner | Collate NoSQL Database Integration
description: Connect DynamoDB to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/dynamodb/hybrid-runner
...
<Columns cols={2}>
  <Card
    ...
    href="/connectors/database/dynamodb/troubleshooting">
    Learn more about how to troubleshoot common DynamoDB connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
