---
title: Doris Hybrid Runner | Collate Database Integration Guide
description: Connect Apache Doris to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/doris/hybrid-runner
...
- **sslKey**: Provide the path to ssl client private key file (ssl_key).
</Step>
...
<Columns cols={2}>
  <Card
    title="Doris Troubleshooting"
    href="/connectors/database/doris/troubleshooting">
    Learn more about how to troubleshoot common Doris connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
