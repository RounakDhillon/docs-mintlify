...
<MetadataIngestionUi connector={"Doris"} selectServicePath={"/images/connectors/doris/select-service.png"} addNewServicePath={"/images/connectors/doris/add-new-service.png"} serviceConnectionPath={"/images/connectors/doris/service-connection.png"} />
