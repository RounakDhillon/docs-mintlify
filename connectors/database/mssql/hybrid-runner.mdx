---
title: MSSQL Hybrid Runner | Collate SQL Server Integration Guide
description: Connect your Microsoft SQL Server to Collate using the Hybrid Runner deployment. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/mssql/hybrid-runner
