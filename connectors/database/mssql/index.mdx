...
<img src="/images/v1.9/connectors/mssql/remote-connection.png" alt="Remote Connection" />
...
<MetadataIngestionUi connector={"MSSQL"} selectServicePath={"/images/connectors/mssql/select-service.png"} addNewServicePath={"/images/connectors/mssql/add-new-service.png"} serviceConnectionPath={"/images/connectors/mssql/service-connection.png"} />
