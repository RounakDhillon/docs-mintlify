---
title: MSSQL Connector | Collate SQL Server Integration Guide
description: Connect your Microsoft SQL Server to Collate with our comprehensive MSSQL connector guide. Step-by-step setup, configuration, and metadata extraction.
slug: /connectors/database/mssql
sidebarTitle: Overview
---
import ReverseMetadata from '/snippets/connectors/database/mssql/reverse-metadata.mdx'
...
Configure and schedule MSSQL metadata and profiler workflows from the Collate UI:
...
- [Troubleshooting](/connectors/database/mssql/troubleshoot)
...
<Columns cols={2}>
  <Card
    title="MSSQL Troubleshooting"
    href="/connectors/database/mssql/troubleshoot">
