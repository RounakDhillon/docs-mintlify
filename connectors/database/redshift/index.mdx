...
<MetadataIngestionUi connector={"Redshift"} selectServicePath={"/images/connectors/redshift/select-service.png"} addNewServicePath={"/images/connectors/redshift/add-new-service.png"} serviceConnectionPath={"/images/connectors/redshift/service-connection.png"} />
...
<img src="/images/v1.9/connectors/ssl_connection.png" alt="SSL Configuration" height="450px" />
