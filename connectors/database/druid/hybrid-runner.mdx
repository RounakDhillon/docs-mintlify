---
title: Druid Hybrid Runner | Collate Real-Time Analytics Guide
description: Connect Apache Druid to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/druid/hybrid-runner
...
## Metadata Ingestion
<MetadataIngestionUi connector={"Druid"} selectServicePath={"/public/images/connectors/druid/select-service.png"} addNewServicePath={"/public/images/connectors/druid/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/druid/service-connection.png"} />
# Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    title="Druid Troubleshooting"
    href="/connectors/database/druid/troubleshooting">
    Learn more about how to troubleshoot common Druid connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
