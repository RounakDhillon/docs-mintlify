...
<MetadataIngestionUi connector={"Glue"} selectServicePath={"/images/connectors/glue/select-service.png"} addNewServicePath={"/images/connectors/glue/add-new-service.png"} serviceConnectionPath={"/images/connectors/glue/service-connection.png"} />
