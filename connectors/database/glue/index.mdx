---
title: AWS Glue Connector | Collate Data Integration Guide
description: Learn how to integrate AWS Glue with Collate using our comprehensive database connector guide. Step-by-step setup, configuration, and metadata extraction.
...
Configure and schedule Glue metadata and profiler workflows from the Collate UI:
