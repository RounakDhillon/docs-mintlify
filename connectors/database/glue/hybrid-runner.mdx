---
title: AWS Glue Hybrid Runner | Collate Data Integration Guide
description: Integrate AWS Glue with Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/glue/hybrid-runner
...
## Metadata Ingestion
<MetadataIngestionUi connector={"Glue"} selectServicePath={"/public/images/connectors/glue/select-service.png"} addNewServicePath={"/public/images/connectors/glue/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/glue/service-connection.png"} />
# Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    title="Glue Troubleshooting"
    href="/connectors/database/glue/troubleshooting">
    Learn more about how to troubleshoot common Glue connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
