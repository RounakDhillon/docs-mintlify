...
<ContentSection id={2} title="AWS Configuration" lines="7-21">
...
<ContentSection id={4} title="Connection Options" lines="9">

**Connection Options (Optional)**: Enter the details for any additional connection options that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={5} title="Connection Arguments" lines="11">
...
<ContentSection id={6} title="Source Config" lines="22-65">

<SourceConfigDef />

</ContentSection>

<ContentSection id={7} title="Sink Configuration" lines="66-68">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={8} title="Workflow Configuration" lines="69-85">
