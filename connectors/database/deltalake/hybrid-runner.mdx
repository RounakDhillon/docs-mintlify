---
title: Delta Lake Hybrid Runner | Collate Data Lake Integration
description: Connect Collate to Delta Lake using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/deltalake/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="Delta Lake Troubleshooting"
    href="/connectors/database/deltalake/troubleshooting">
