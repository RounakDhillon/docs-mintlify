---
title: DeltaLake Connector | Collate Data Lake Integration
description: Connect Collate to Delta Lake with our comprehensive database connector guide. Step-by-step setup, configuration, and metadata extraction instructions.
...
Configure and schedule Delta Lake metadata and profiler workflows from the Collate UI:
