...
<MetadataIngestionUi connector={"DeltaLake"} selectServicePath={"/images/connectors/deltalake/select-service.png"} addNewServicePath={"/images/connectors/deltalake/add-new-service.png"} serviceConnectionPath={"/images/connectors/deltalake/service-connection.png"} />
