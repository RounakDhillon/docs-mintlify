...
<ContentSection id={2} title="Metastore Configuration" lines="7-19">
...
<ContentSection id={3} title="App Name" lines="20">

**appName (Optional)**: Enter the app name of spark session.

</ContentSection>

<ContentSection id={4} title="Connection Options" lines="21-22">

**Connection Options (Optional)**: Enter the details for any additional connection options that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={5} title="Connection Arguments" lines="23-24">
...
<ContentSection id={6} title="Source Config" lines="25-27">

<SourceConfigDef />

</ContentSection>

<ContentSection id={7} title="Sink Configuration" lines="28-30">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={8} title="Workflow Configuration" lines="31-47">
...
<ContentSection id={2} title="AWS Configuration" lines="7-11">
...
<ContentSection id={3} title="Bucket Configuration" lines="12-13">
...
<ContentSection id={4} title="Source Config" lines="14-16">

<SourceConfigDef />

</ContentSection>

<ContentSection id={5} title="Sink Configuration" lines="17-19">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={6} title="Workflow Configuration" lines="20-36">
