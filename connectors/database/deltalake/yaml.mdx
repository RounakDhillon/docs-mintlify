...
<ContentSection id={4} title="Connection Options" lines="21">

**Connection Options (Optional)**: Enter the details for any additional connection options that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={5} title="Connection Arguments" lines="2">
...
<ContentSection id={2} title="AWS Configuration" lines="88">
...
<ContentSection id={3} title="Bucket Configuration" lines="88">
...
<ContentSection id={4} title="Source Config" lines="25-68">

<SourceConfigDef />

</ContentSection>

<ContentSection id={5} title="Sink Configuration" lines="69-71">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={6} title="Workflow Configuration" lines="72-88">
