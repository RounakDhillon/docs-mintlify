...
```
## Metadata Ingestion
<MetadataIngestionUi connector={"Synapse"} selectServicePath={"/public/images/connectors/synapse/select-service.png"} addNewServicePath={"/public/images/connectors/synapse/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/synapse/service-connection.png"} />
<Steps>
