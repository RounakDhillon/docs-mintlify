...
<MetadataIngestionUi connector={"Synapse"} selectServicePath={"/images/connectors/synapse/select-service.png"} addNewServicePath={"/images/connectors/synapse/add-new-service.png"} serviceConnectionPath={"/images/connectors/synapse/service-connection.png"} />
