...
<ContentSection id={7} title="SSL Configuration" lines="13-15">
...
<ContentSection id={8} title="Connection Options" lines="16-17">

**Connection Options (Optional)**: Enter the details for any additional connection options that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={9} title="Connection Arguments" lines="18-19">

**Connection Arguments (Optional)**: Enter the details for any additional connection arguments such as security or protocol configs that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={10} title="Source Config" lines="20-22">

<SourceConfigDef />

</ContentSection>

<ContentSection id={11} title="Sink Configuration" lines="23-25">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={12} title="Workflow Configuration" lines="26-42">
