...
<MetadataIngestionUi connector={"CockroachDB"} selectServicePath={"/images/connectors/cockroach/select-service.png"} addNewServicePath={"/images/connectors/cockroach/add-new-service.png"} serviceConnectionPath={"/images/connectors/cockroach/service-connection.png"} />
