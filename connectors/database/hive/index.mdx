...
<MetadataIngestionUi connector={"Hive"} selectServicePath={"/images/connectors/hive/select-service.png"} addNewServicePath={"/images/connectors/hive/add-new-service.png"} serviceConnectionPath={"/images/connectors/hive/service-connection.png"} />
...
<img src="/images/v1.9/connectors/ssl_argument.png" alt="SSL Configuration" height="450px" />
