---
title: Hive Hybrid Runner | Collate Big Data Integration Guide
description: Connect Apache Hive to Collate using the Hybrid Runner deployment. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/hive/hybrid-runner
...
## Metadata Ingestion
<MetadataIngestionUi connector={"Hive"} selectServicePath={"/public/images/connectors/hive/select-service.png"} addNewServicePath={"/public/images/connectors/hive/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/hive/service-connection.png"} />
## Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    title="Hive Troubleshooting"
    href="/connectors/database/hive/troubleshooting">
    Learn more about how to troubleshoot common Hive connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
