...
## Metadata Ingestion
<MetadataIngestionUi connector={"GCS Datalake"} selectServicePath={"/public/images/connectors/gcs-datalake/select-service.png"} addNewServicePath={"/public/images/connectors/gcs-datalake/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/gcs-datalake/service-connection.png"} />
<Steps>
