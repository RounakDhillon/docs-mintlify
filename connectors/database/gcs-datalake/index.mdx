...
<MetadataIngestionUi connector={"GCS Datalake"} selectServicePath={"/images/connectors/gcs-datalake/select-service.png"} addNewServicePath={"/images/connectors/gcs-datalake/add-new-service.png"} serviceConnectionPath={"/images/connectors/gcs-datalake/service-connection.png"} />
