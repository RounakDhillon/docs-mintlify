---
title: Snowflake Connector | Collate Cloud Data Warehouse
description: Connect Snowflake to Collate with our comprehensive database connector guide. Easy setup, metadata extraction, and data lineage tracking.
slug: /connectors/database/snowflake
sidebarTitle: SaaS/BYOC
---
import ReverseMetadata from '/snippets/connectors/database/snowflake/reverse-metadata.mdx'
...
<iframe width="800" height="450" src="https://www.youtube.com/embed/EfycmnM_hPs" title="Snowflake connector walkthrough video" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
...
- [Metadata Ingestion](#metadata-ingestion)
    - [Incremental Extraction](/how-to-guides/guide-for-data-users/ingestion/workflows/metadata/incremental-extraction/snowflake)
...
<Columns cols={2}>
  <Card
    title="Snowflake Troubleshooting"
    href="/connectors/database/snowflake/troubleshooting">
    Learn more about how to troubleshoot common Snowflake connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
