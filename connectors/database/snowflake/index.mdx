...
<IngestionModeTiles yamlPath="/snippets/connectors/database/snowflake/yaml" />
...
<MetadataIngestionUi connector={"Snowflake"} selectServicePath={"/images/connectors/snowflake/select-service.png"} addNewServicePath={"/images/connectors/snowflake/add-new-service.png"} serviceConnectionPath={"/images/connectors/snowflake/service-connection.png"} />
