...
description: 'Connect MySQL databases to Collate for automated metadata discovery, data profiling, and lineage tracking. Complete setup guide with authentication and SSL.'
---

# MySQL Database Connector

<CardGroup cols={3}>
  <Card title="Production Ready" icon="/images/icons/check.svg" color="#16a34a">
    Fully supported production connector
  </Card>
  <Card title="Metadata Discovery" icon="/images/icons/search.svg">
...
- **Auth Type**: Basic Auth or IAM based auth to connect to instances / cloud rds.
  ...
  - **IAM Based Auth**:
    ...
    <Accordion title="Assume Role Authentication Requirements">
...
The Reverse Metadata feature allows you to push metadata changes from Collate back to MySQL, ensuring your source system stays synchronized with any updates made in the data catalog.