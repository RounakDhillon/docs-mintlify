...
<ContentSection id={4} title="Security Token" lines="8">
...
<ContentSection id={5} title="Organization ID" lines="9">
...
<ContentSection id={6} title="SObject Name" lines="10">
...
<ContentSection id={7} title="Salesforce API Version" lines="11">
...
<ContentSection id={8} title="Salesforce Domain" lines="12">
...
<ContentSection id={9} title="Connection Options" lines="13-14">
...
<ContentSection id={10} title="Connection Arguments" lines="15-16">
...
<ContentSection id={11} title="Source Config" lines="17-19">

<SourceConfigDef />

</ContentSection>

<ContentSection id={12} title="Sink Configuration" lines="20-22">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={13} title="Workflow Configuration" lines="23-39">
