...
<MetadataIngestionUi connector={"Salesforce"} selectServicePath={"/images/connectors/salesforce/select-service.png"} addNewServicePath={"/images/connectors/salesforce/add-new-service.png"} serviceConnectionPath={"/images/connectors/salesforce/service-connection.png"} />
