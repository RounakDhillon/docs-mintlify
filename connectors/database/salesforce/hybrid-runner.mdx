---
title: Salesforce Connector | Collate CRM Integration Guide | Hybrid Runner
...
slug: /connectors/database/salesforce/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="Salesforce Troubleshooting"
    href="/connectors/database/salesforce/troubleshooting">
