...
<MetadataIngestionUi connector={"MariaDB"} selectServicePath={"/images/connectors/mariadb/select-service.png"} addNewServicePath={"/images/connectors/mariadb/add-new-service.png"} serviceConnectionPath={"/images/connectors/mariadb/service-connection.png"} />
