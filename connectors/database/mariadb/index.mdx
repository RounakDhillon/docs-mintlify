---
title: MariaDB Connector | Collate Database Integration Guide
description: Connect MariaDB to Collate with our comprehensive database connector guide. Easy setup, configuration steps, and metadata extraction for your data catalog.
...
Configure and schedule MariaDB metadata and profiler workflows from the Collate UI:
...
## Metadata Ingestion
<MetadataIngestionUi connector={"MariaDB"} selectServicePath={"/public/images/connectors/mariadb/select-service.png"} addNewServicePath={"/public/images/connectors/mariadb/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/mariadb/service-connection.png"} />
## Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    ...
    href="/connectors/database/mariadb/troubleshooting">
    Learn more about how to troubleshoot common MariaDB connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
