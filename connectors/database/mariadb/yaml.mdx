...
<ContentSection id={7} title="Connection Options" lines="12-13">
...
<ContentSection id={8} title="Connection Arguments" lines="14-15">
...
<ContentSection id={9} title="Source Config" lines="16-18">

<SourceConfigDef />

</ContentSection>

<ContentSection id={10} title="Sink Configuration" lines="19-21">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={11} title="Workflow Configuration" lines="22-38">
