...
<Card
    ...
    title="OpenMetadata 1.6.1 or later"
    href="/deployment"
  >
...
<MetadataIngestionUi connector={"Exasol"} selectServicePath={"/images/connectors/exasol/select-service.png"} addNewServicePath={"/images/connectors/exasol/add-new-service.png"} serviceConnectionPath={"/images/connectors/exasol/service-connection.png"} />
