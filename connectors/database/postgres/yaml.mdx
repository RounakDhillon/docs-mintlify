...
Configure the source type and service name for your PostgreSQL connector.
...
<ContentSection id={4} title="IAM Authentication" lines="10-16">
...
<ContentSection id={10} title="SSL Configuration" lines="24-26">
...
<ContentSection id={11} title="Source Config" lines="27-29">

<SourceConfigDef />

</ContentSection>

<ContentSection id={12} title="Sink Configuration" lines="30-32">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={13} title="Workflow Configuration" lines="33-49">
...
<CodePanel fileName="postgres_config.yaml">
...
<IngestionCli />
<QueryUsage connector="postgres" />
<Lineage connector="postgres" />
<DataProfiler connector="postgres" />
<AutoClassification connector="postgres" />
<DataQuality />
