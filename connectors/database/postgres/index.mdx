...
<MetadataIngestionUi connector={"Postgres"} selectServicePath={"/images/connectors/postgres/select-service.png"} addNewServicePath={"/images/connectors/postgres/add-new-service.png"} serviceConnectionPath={"/images/connectors/postgres/service-connection.png"} />
