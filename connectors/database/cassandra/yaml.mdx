...
<ContentSection id={5} title="Basic Authentication" lines="11">
...
<ContentSection id={6} title="DataStax Astra DB Configuration" lines="13-17">
...
<ContentSection id={7} title="Connection Arguments" lines="18-19">

**Connection Arguments (Optional)**: Enter the details for any additional connection arguments such as security or protocol configs that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={8} title="SSL Configuration" lines="20-23">
