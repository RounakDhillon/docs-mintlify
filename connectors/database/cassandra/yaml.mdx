...
<ContentSection id={6} title="DataStax Astra DB Configuration" lines="12-16">
...
<ContentSection id={7} title="Connection Arguments" lines="17-18">

**Connection Arguments (Optional)**: Enter the details for any additional connection arguments such as security or protocol configs that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={8} title="SSL Configuration" lines="19-21">
...
<ContentSection id={9} title="Source Config" lines="22-24">

<SourceConfigDef />

</ContentSection>

<ContentSection id={10} title="Sink Configuration" lines="25-27">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={11} title="Workflow Configuration" lines="28-44">
