...
<MetadataIngestionUi connector={"Cassandra"} selectServicePath={"/images/connectors/cassandra/select-service.png"} addNewServicePath={"/images/connectors/cassandra/add-new-service.png"} serviceConnectionPath={"/images/connectors/cassandra/service-connection.png"} />
