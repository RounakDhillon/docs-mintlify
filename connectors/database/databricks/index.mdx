...
<IngestionModeTiles yamlPath="/snippets/connectors/database/databricks/yaml" />
...
<MetadataIngestionUi connector={"Databricks"} selectServicePath={"/images/connectors/databricks/select-service.png"} addNewServicePath={"/images/connectors/databricks/add-new-service.png"} serviceConnectionPath={"/images/connectors/databricks/service-connection.png"} />
