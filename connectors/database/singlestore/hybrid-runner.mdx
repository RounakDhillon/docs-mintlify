---
title: SingleStore Hybrid Runner | Collate Scalable DB Guide
description: Connect SingleStore to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/singlestore/hybrid-runner
...
Configure and schedule SingleStore metadata and profiler workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="SingleStore Troubleshooting"
    href="/connectors/database/singlestore/troubleshooting">
    Learn more about how to troubleshoot common SingleStore connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
