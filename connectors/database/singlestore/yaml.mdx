...
description: Learn how to Configure Collate'sSingleStore database connector with YAML examples, connection parameters, and step-by-step setup instructions.
...
Configure the source type and service name for your SingleStore connector.
...
**databaseSchema**: Optional name to give to the database schema in OpenMetadata.
...
<ContentSection id={7} title="Connection Arguments" lines="13">
...
<ContentSection id={8} title="Source Config" lines="15">

<SourceConfigDef />

</ContentSection>

<ContentSection id={9} title="Sink Configuration" lines="17">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={10} title="Workflow Configuration" lines="19">
...
<CodePanel fileName="singlestore_config.yaml">
...
<IngestionCli />
<Lineage connector="singlestore" />
<DataProfiler connector="singlestore" />
<AutoClassification connector="singlestore" />
<DataQuality />
## dbt Integration
<Columns cols={2}>
