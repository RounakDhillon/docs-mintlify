...
<MetadataIngestionUi connector={"SingleStore"} selectServicePath={"/images/connectors/singlestore/select-service.png"} addNewServicePath={"/images/connectors/singlestore/add-new-service.png"} serviceConnectionPath={"/images/connectors/singlestore/service-connection.png"} />
