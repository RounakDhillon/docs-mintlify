...
<MetadataIngestionUi connector={"PinotDB"} selectServicePath={"/images/connectors/pinotdb/select-service.png"} addNewServicePath={"/images/connectors/pinotdb/add-new-service.png"} serviceConnectionPath={"/images/connectors/pinotdb/service-connection.png"} />
