...
<MetadataIngestionUi connector={"Impala"} selectServicePath={"/images/connectors/impala/select-service.png"} addNewServicePath={"/images/connectors/impala/add-new-service.png"} serviceConnectionPath={"/images/connectors/impala/service-connection.png"} />
...
<img src="/images/v1.9/connectors/ssl_Impala.png" alt="SSL Configuration" height="450px" />
