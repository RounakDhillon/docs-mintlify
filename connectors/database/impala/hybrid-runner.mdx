---
title: Impala Hybrid Runner | Collate SQL-on-Hadoop Integration
description: Connect Apache Impala to Collate using the Hybrid Runner deployment. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/impala/hybrid-runner
...
<Columns cols={2}>
  <Card
    ...
    href="/connectors/database/impala/troubleshooting">
    Learn more about how to troubleshoot common Impala connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
