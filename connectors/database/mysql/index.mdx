...
<MetadataIngestionUi connector={"MySQL"} selectServicePath={"/images/connectors/mysql/select-service.png"} addNewServicePath={"/images/connectors/mysql/add-new-service.png"} serviceConnectionPath={"/images/connectors/mysql/service-connection.png"} />
