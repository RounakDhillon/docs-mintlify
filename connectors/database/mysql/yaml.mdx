...
<ContentSection id={4} title="IAM Based Auth" lines="10-14">
...
<ContentSection id={5} title="Host and Port" lines="15">
...
<ContentSection id={7} title="Connection Options" lines="19-20">
...
<ContentSection id={8} title="Connection Arguments" lines="21-22">
...
<ContentSection id={9} title="Source Config" lines="23-25">
...
<ContentSection id={11} title="Workflow Configuration" lines="29-45">
