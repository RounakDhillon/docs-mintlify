...
- [Reverse Metadata](/how-to-guides/admin-guide/applications/reverse-metadata)
...
- You can learn more about how to configure and run the Lineage Workflow to extract Lineage data from [here](/how-to-guides/guide-for-data-users/ingestion/workflows/lineage)
...
Configure the source type and service name for your MySQL connector.
...
<ContentSection id={3} title="Basic Auth" lines="8-9">
...
<ContentSection id={4} title="IAM Based Auth" lines="12">
...
<ContentSection id={5} title="Host and Port" lines="13">

**Host and Port**: Enter the fully qualified hostname and port number for your MySQL deployment in the Host and Port field.

</ContentSection>

<ContentSection id={6} title="Database Schema" lines="16">

**databaseSchema**: databaseSchema of the data source. This is optional parameter, if you would like to restrict the metadata reading to a single databaseSchema. When left blank, OpenMetadata Ingestion attempts to scan all the databaseSchema.

</ContentSection>

<ContentSection id={7} title="Connection Options" lines="17">
...
<ContentSection id={8} title="Connection Arguments" lines="18">
...
<ContentSection id={9} title="Source Config" lines="23-66">

<SourceConfigDef />

</ContentSection>

<ContentSection id={10} title="Sink Configuration" lines="67-69">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={11} title="Workflow Configuration" lines="70-86">
...
<CodePanel fileName="mysql_config.yaml">
...
<IngestionCli />
<Lineage connector="mysql" />
<DataProfiler connector="mysql" />
<AutoClassification connector="mysql" />
<DataQuality />
