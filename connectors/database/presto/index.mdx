...
<MetadataIngestionUi connector={"Presto"} selectServicePath={"/images/connectors/presto/select-service.png"} addNewServicePath={"/images/connectors/presto/add-new-service.png"} serviceConnectionPath={"/images/connectors/presto/service-connection.png"} />
