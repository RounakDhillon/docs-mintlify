---
title: Presto Hybrid Runner | Collate Distributed SQL Guide
description: Connect Presto to Collate using the Hybrid Runner deployment. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/presto/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="Presto Troubleshooting"
    href="/connectors/database/presto/troubleshooting">
    Learn more about how to troubleshoot common Presto connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
