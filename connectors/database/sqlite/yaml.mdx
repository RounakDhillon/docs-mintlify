...
<ContentSection id={8} title="Connection Arguments" lines="14">
...
<ContentSection id={9} title="Source Config" lines="16">

<SourceConfigDef />

</ContentSection>

<ContentSection id={10} title="Sink Configuration" lines="18">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={11} title="Workflow Configuration" lines="21">
