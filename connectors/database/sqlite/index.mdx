...
<MetadataIngestionUi connector={"SQLite"} selectServicePath={"/images/connectors/sqlite/select-service.png"} addNewServicePath={"/images/connectors/sqlite/add-new-service.png"} serviceConnectionPath={"/images/connectors/sqlite/service-connection.png"} />
