---
title: SQLite Hybrid Runner | Collate Lightweight DB Integration
description: Connect SQLite to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/sqlite/hybrid-runner
...
Configure and schedule SQLite metadata and profiler workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    ...
    href="/connectors/database/sqlite/troubleshooting">
    Learn more about how to troubleshoot common SQLite connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
