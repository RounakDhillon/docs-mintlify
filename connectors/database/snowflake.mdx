...
<CardGroup cols={3}>
  <Card title="Complete Feature Set" icon="/images/icons/celebration.svg" color="#f59e0b">
    All features supported with zero limitations
  </Card>
  <Card title="Enterprise Ready" icon="/images/icons/puzzle.svg" color="#3b82f6">
    Account usage schema integration
  </Card>
  <Card title="Advanced Auth" icon="/images/icons/warning.svg" color="#8b5cf6">
