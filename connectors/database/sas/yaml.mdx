...
<ContentSection id={2} title="Server Host" lines="6">
...
<ContentSection id={5} title="Data Tables Configuration" lines="9-10">
...
<ContentSection id={6} title="Reports Configuration" lines="11-12">
...
<ContentSection id={7} title="Dataflows Configuration" lines="13-14">
...
<ContentSection id={8} title="Sink Configuration" lines="15-16">

To send the metadata to OpenMetadata, it needs to be specified as `type: metadata-rest`.

</ContentSection>

<ContentSection id={9} title="Workflow Configuration" lines="17-33">
