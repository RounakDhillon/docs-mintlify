...
<Card
    ...
    title="OpenMetadata 1.6 or later"
    href="/deployment"
  >
...
<MetadataIngestionUi connector={"Teradata"} selectServicePath={"/images/connectors/teradata/select-service.png"} addNewServicePath={"/images/connectors/teradata/add-new-service.png"} serviceConnectionPath={"/images/connectors/teradata/service-connection.png"} />
