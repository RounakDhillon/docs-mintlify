---
title: Teradata Hybrid Runner | Collate Data Warehouse Guide
description: Connect Teradata to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/teradata/hybrid-runner
...
Configure and schedule Teradata metadata and profiler workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="Teradata Troubleshooting"
    href="/connectors/database/teradata/troubleshooting">
    Learn more about how to troubleshoot common Teradata connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
