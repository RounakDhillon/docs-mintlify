...
<IngestionModeTiles yamlPath="/snippets/connectors/database/trino/yaml" />
...
## Metadata Ingestion
<MetadataIngestionUi connector={"Trino"} selectServicePath={"/images/connectors/trino/select-service.png"} addNewServicePath={"/images/connectors/trino/add-new-service.png"} serviceConnectionPath={"/images/connectors/trino/service-connection.png"} />
