---
title: Trino Hybrid Runner | Collate Distributed SQL Integration
description: Connect Trino to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/trino/hybrid-runner
...
Configure and schedule Trino metadata and profiler workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="Trino Troubleshooting"
    href="/connectors/database/trino/troubleshooting">
    Learn more about how to troubleshoot common Trino connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
