---
title: SAP HANA Connector | Collate High-Performance DB
description: Connect SAP HANA to Collate effortlessly with our comprehensive database connector guide. Setup instructions, configuration steps, and troubleshooting guidance.
...
Configure and schedule SAP HANA metadata and profiler workflows from the Collate UI:
...
## Metadata Ingestion
<MetadataIngestionUi connector={"SAP Hana"} selectServicePath={"/public/images/connectors/sap-hana/select-service.png"} addNewServicePath={"/public/images/connectors/sap-hana/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/sap-hana/service-connection.png"} />
## Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    title="SAP HANA Troubleshooting"
    href="/connectors/database/sap-hana/troubleshooting">
    Learn more about how to troubleshoot common SAP HANA connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
