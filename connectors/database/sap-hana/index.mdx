...
<MetadataIngestionUi connector={"SAP Hana"} selectServicePath={"/images/connectors/sap-hana/select-service.png"} addNewServicePath={"/images/connectors/sap-hana/add-new-service.png"} serviceConnectionPath={"/images/connectors/sap-hana/service-connection.png"} />
