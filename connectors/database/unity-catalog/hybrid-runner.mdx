---
title: Unity Catalog Hybrid Runner | Collate Data Governance
description: Connect Unity Catalog to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/unity-catalog/hybrid-runner
...
Configure and schedule Unity Catalog metadata workflow from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="Unity Catalog Troubleshooting"
    href="/connectors/database/unity-catalog/troubleshooting">
    Learn more about how to troubleshoot common Unity Catalog connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
