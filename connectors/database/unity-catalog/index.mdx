...
<IngestionModeTiles yamlPath="/snippets/connectors/database/unity-catalog/yaml" />
...
<MetadataIngestionUi connector={"Unity Catalog"} selectServicePath={"/images/connectors/unity-catalog/select-service.png"} addNewServicePath={"/images/connectors/unity-catalog/add-new-service.png"} serviceConnectionPath={"/images/connectors/unity-catalog/service-connection.png"} />
