---
title: SSAS Hybrid Runner | Collate SQL Server Integration Guide
description: Connect SSAS to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/database/ssas/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="SSAS Troubleshooting"
    href="/connectors/database/ssas/troubleshooting">
    Learn more about how to troubleshoot common SSAS connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
