...
<MetadataIngestionUi connector={"SSAS"} selectServicePath={"/images/connectors/ssas/select-service.png"} addNewServicePath={"/images/connectors/ssas/add-new-service.png"} serviceConnectionPath={"/images/connectors/ssas/service-connection.png"} />
