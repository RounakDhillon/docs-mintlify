---
title: SAP ERP Connector | Collate Enterprise Integration | Hybrid Runner
...
slug: /connectors/database/sap-erp/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="SAP ERP Troubleshooting"
    href="/connectors/database/sap-erp/troubleshooting">
    Learn more about how to troubleshoot common SAP ERP connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
