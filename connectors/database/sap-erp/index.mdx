...
<MetadataIngestionUi connector={"SAP ERP"} selectServicePath={"/images/connectors/sap-erp/select-service.png"} addNewServicePath={"/images/connectors/sap-erp/add-new-service.png"} serviceConnectionPath={"/images/connectors/sap-erp/service-connection.png"} />
