---
title: Setup SAP ERP APIs | Collate Integration Guide
...
sidebarTitle: Setup SAP ERP APIs
---
# Setup SAP ERP APIs
...
<img noZoom src="/public/images/connectors/sap-erp/data-definition-object.png" alt="Data Definition Object" />
...
<img noZoom src="/public/images/connectors/sap-erp/create-project.png" alt="Create Project" />
...
<img noZoom src="/public/images/connectors/sap-erp/add-reference.png" alt="Add Reference" />

The final step is to expose the generated code as OData service. This is the Register step.

<img noZoom src="/public/images/connectors/sap-erp/register-odata-service.png" alt="Register odata Service" />
...
<img noZoom src="/public/images/connectors/sap-erp/add-service-as-endpoint.png" alt="Add Service As Endpoint" />
