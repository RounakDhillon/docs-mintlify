...
description: Configure SAP ERP database connections in Collate with YAML. Complete setup guide, authentication options, and configuration examples for seamless metadata ingestion.
