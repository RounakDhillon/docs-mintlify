...
![Select a Service](/public/images/connectors/debug/debug1.png)
...
![Access Ingestion Tab](/public/images/connectors/debug/debug2.png)

4. **Enable Debug Logging**
   In the configuration dialog, enable the **Debug Log** option and click **Next**.

![Enable Debug Logging](/public/images/connectors/debug/debug3.png)

5. **Schedule and Submit**
   Configure the schedule if needed and click **Submit** to apply the changes.

![Schedule and Submit](/public/images/connectors/debug/debug4.png)
...
![Configure service connection](/public/images/connectors/datalake/troubleshoot-clientId.png)
...
<img noZoom src="/public/images/connectors/domo-database/client-id.png" alt="Client-id" />
...
<img noZoom src="/public/images/connectors/domo-database/access-token.png" alt="Access Token" />
...
<img noZoom src="/public/images/connectors/domo-database/scopes.jpeg" alt="Scopes" />
