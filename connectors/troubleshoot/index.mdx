...
<img noZoom src="/public/images/connectors/debug/debug1.png" alt="Select a Service" />
...
<img noZoom src="/public/images/connectors/debug/debug2.png" alt="Access Agents Tab" />

4. **Enable Debug Logging**
   In the configuration dialog, enable the **Debug Log** option and click **Next**.

<img noZoom src="/public/images/connectors/debug/debug3.png" alt="Enable Debug Logging" />

5. **Schedule and Submit**
   Configure the schedule if needed and click **Submit** to apply the changes.

<img noZoom src="/public/images/connectors/debug/debug4.png" alt="Schedule and Submit" />
...
<img noZoom src="/public/images/connectors/datalake/troubleshoot-clientId.png" alt="Configure service connection" />
...
<img noZoom src="/public/images/connectors/azuresql/autocommit.png" alt="autocommit" />
...
<img noZoom src="/public/images/connectors/azuresql/azure-firewall.png" alt="azure sql firewall rules" />
...
<img noZoom src="/public/images/connectors/databricks/select-sql-warehouse.png" alt="Select Sql Warehouse" />


Now click on sql Warehouse from the SQL Warehouses list.


<img noZoom src="/public/images/connectors/databricks/Open-sql-warehouse.png" alt="Open Sql Warehouse" />
...
<img noZoom src="/public/images/connectors/databricks/Connection-details.png" alt="Connection details" />


In Connection details section page click on Create a personal access token.

<img noZoom src="/public/images/connectors/databricks/Open-create-tocken-page.png" alt="Open create tocken" />
...
<img noZoom src="/public/images/connectors/databricks/Generate-token.png" alt="Generate tocken" />
...
<img noZoom src="/public/images/connectors/domodatabase/client-id.png" alt="Client-id" />
...
<img noZoom src="/public/images/connectors/domodatabase/access-token.png" alt="Access Token" />
...
<img noZoom src="/public/images/connectors/domodatabase/scopes.jpeg" alt="Scopes" />
...
<img noZoom src="/public/images/connectors/redshift/service-connection-arguments.png" alt="Configure service connection" />
...
<img noZoom src="/public/images/connectors/unitycatalog/select-sql-warehouse.png" alt="Select Sql Warehouse" />


Now click on sql Warehouse from the SQL Warehouses list.


<img noZoom src="/public/images/connectors/unitycatalog/Open-sql-warehouse.png" alt="Open Sql Warehouse" />
...
<img noZoom src="/public/images/connectors/unitycatalog/Connection-details.png" alt="Connection details" />


In Connection details section page click on Create a personal access token.

<img noZoom src="/public/images/connectors/unitycatalog/Open-create-token-page.png" alt="Open create token" />
...
<img noZoom src="/public/images/connectors/unitycatalog/Generate-token.png" alt="Generate token" />
