...
<img src="/images/v1.9/connectors/debug/debug1.png" alt="Select a Service" />
...
<img src="/images/v1.9/connectors/debug/debug2.png" alt="Access Agents Tab" />

4. **Enable Debug Logging**
   In the configuration dialog, enable the **Debug Log** option and click **Next**.

<img src="/images/v1.9/connectors/debug/debug3.png" alt="Enable Debug Logging" />

5. **Schedule and Submit**
   Configure the schedule if needed and click **Submit** to apply the changes.

<img src="/images/v1.9/connectors/debug/debug4.png" alt="Schedule and Submit" />
...
<img src="/images/v1.9/connectors/datalake/troubleshoot-clientId.png" alt="Configure service connection" />
...
<img src="/images/v1.9/connectors/azuresql/autocommit.png" alt="autocommit" />
...
<img src="/images/v1.9/connectors/azuresql/azure-firewall.png" alt="azure sql firewall rules" />
...
<img src="/images/v1.9/connectors/domodatabase/client-id.png" alt="Client-id" />
...
<img src="/images/v1.9/connectors/domodatabase/access-token.png" alt="Access Token" />
...
<img src="/images/v1.9/connectors/domodatabase/scopes.jpeg" alt="Scopes" />
...
<img src="/images/v1.9/connectors/redshift/service-connection-arguments.png" alt="Configure service connection" />
...
<img src="/images/v1.9/connectors/unitycatalog/select-sql-warehouse.png" alt="Select Sql Warehouse" />


Now click on sql Warehouse from the SQL Warehouses list.


<img src="/images/v1.9/connectors/unitycatalog/Open-sql-warehouse.png" alt="Open Sql Warehouse" />
...
<img src="/images/v1.9/connectors/unitycatalog/Connection-details.png" alt="Connection details" />


In Connection details section page click on Create a personal access token.

<img src="/images/v1.9/connectors/unitycatalog/Open-create-token-page.png" alt="Open create token" />
...
<img src="/images/v1.9/connectors/unitycatalog/Generate-token.png" alt="Generate token" />
