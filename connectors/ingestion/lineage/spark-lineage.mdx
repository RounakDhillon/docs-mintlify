...
<img src="/images/connectors/spark/spark-pipeline-service.png" alt="Spark Pipeline Service" />


 <img src="/images/connectors/spark/spark-pipeline-details.png" alt="Spark Pipeline Details" />



 <img src="/images/connectors/spark/spark-pipeline-lineage.png" alt="Spark Pipeline Lineage" />
...
<img src="/images/connectors/spark/spark-upload-jar.png" alt="Spark Upload Jar" />

Click on the "Install Now" button and choose `dbfs` mode and upload the `OpenMetadata Spark Agent` jar.

<img src="/images/connectors/spark/spark-upload-jar-2.png" alt="Spark Upload Jar" />

Once your jar is uploaded copy the path of the jar for the next steps.

<img src="/images/connectors/spark/spark-uploaded-jar.png" alt="Spark Upload Jar" />
...
<img src="/images/connectors/spark/prepare-script.png" alt="Prepare Script" />
...
<img src="/images/connectors/spark/spark-init-script.png" alt="Spark Init Script" />
...
<img src="/images/connectors/spark/spark-config-set.png" alt="Spark Set Config" />
...
<img src="/images/connectors/spark/glue-job-jar.png" alt="Glue Job Configure Jar" />
...
<img src="/images/connectors/spark/glue-job-params.png" alt="Glue Job Configure Params" />
