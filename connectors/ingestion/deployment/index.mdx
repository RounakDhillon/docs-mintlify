...
description: Learn how to deploy Collate ingestion connectors with step-by-step guides, configuration options, and best practices for seamless data integration.
slug: /connectors/ingestion/deployment
sidebarTitle: Ingestion Pipeline UI Deployment
---
...
<img noZoom src="/public/images/features/ingestion/ingestion-pipeline/ingestion-pipeline-system-context.drawio.png" alt="system context" />
...
<img noZoom src="/public/images/features/ingestion/ingestion-pipeline/ingestion-pipeline-software-system.drawio.png" alt="software system" />
...
<img noZoom src="/public/images/features/ingestion/ingestion-pipeline/ingestion-pipeline-container-IngestionPipeline.drawio.png" alt="container create" />
...
<img noZoom src="/public/images/features/ingestion/ingestion-pipeline/ingestion-pipeline-pipeline-service-container.drawio.png" alt="deploy" />
