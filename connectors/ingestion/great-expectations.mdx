---
title: Great Expectations | Collate Data Quality Integration
description: Integrate Great Expectations with Collate for automated data quality validation. Complete setup guide, connector configuration, and best practices.
...
<img alt="Great Expectations checkpoint file" />
...
<img noZoom src="/public/images/features/integrations/ge-config-yaml.gif" alt="Great Expectations config file" />
...
<img noZoom src="/public/images/features/integrations/ge-run-checkpoint.gif" alt="Run Great Expectations checkpoint" />
