...
<img src="/images/v1.9/features/integrations/ge-config-yaml.gif" alt="Great Expectations config file" />
...
<img src="/images/v1.9/features/integrations/ge-run-checkpoint.gif" alt="Run Great Expectations checkpoint" />
