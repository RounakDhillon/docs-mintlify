...
slug: /how-to-guides/guide-for-data-users/ingestion/workflows/dbt/configure-dbt-workflow
...
Follow the link [here](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/setup-multiple-dbt-projects) for instructions on setting up multiple dbt projects.
...
Click [here](https://docs.getdbt.com/guides/getting-started) to get started with dbt Cloud account setup if you have not done so already.
...
To know how to get the values for `Dbt Cloud Account Id`, `Dbt Cloud Project Id` and `Dbt Cloud Job Id` fields check [here](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/run-dbt-workflow-externally).
