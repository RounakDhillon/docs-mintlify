...
<img src="/images/v1.9/features/ingestion/workflows/dbt/dbt-features/dbt-query.webp" alt="dbt" />
...
<img src="/images/v1.9/features/ingestion/workflows/dbt/add-ingestion.webp" alt="add-ingestion" />
...
<img src="/images/v1.9/features/ingestion/workflows/dbt/aws-s3.webp" alt="aws-s3-bucket" />
...
<img src="/images/v1.9/features/ingestion/workflows/dbt/gcp-bucket-form.webp" alt="gcp-storage-bucket-form" />


**2.** Entering the path of file in which the GCS bucket credentials are stored.

<img src="/images/v1.9/features/ingestion/workflows/dbt/gcp-bucket-path.webp" alt="gcp-storage-bucket-path" />
...
<img src="/images/v1.9/features/ingestion/workflows/dbt/azure-config.webp" alt="azure-bucket" />
...
<img src="/images/v1.9/features/ingestion/workflows/dbt/local-storage.webp" alt="local-storage" />

#### 5. File Server

File server path of the `manifest.json`, `catalog.json` and `run_results.json` files stored on a file server directly provided.

<img src="/images/v1.9/features/ingestion/workflows/dbt/file_server.webp" alt="file-server" />
...
<img src="/images/v1.9/features/ingestion/workflows/dbt/dbt-cloud.webp" alt="dbt-cloud" />
...
<img src="/images/v1.9/features/ingestion/workflows/dbt/schedule-and-deploy.webp" alt="schedule-and-deploy" />
