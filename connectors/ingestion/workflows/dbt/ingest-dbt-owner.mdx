...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/ingest_dbt_owner/click-users-page.png" alt="click-users-page" />
<img noZoom src="/public/images/features/ingestion/workflows/dbt/ingest_dbt_owner/click-users-page1.png" alt="click-users-page" />

**2.** Click on the `Add User` button

<img noZoom src="/public/images/features/ingestion/workflows/dbt/ingest_dbt_owner/click-add-user.png" alt="click-add-user" />
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/ingest_dbt_owner/add-user-dbt.png" alt="add-user-dbt" />


#### Following steps shows adding a Team to OpenMetadata:
**1.** Click on the `Teams` section from homepage

<img noZoom src="/public/images/features/ingestion/workflows/dbt/ingest_dbt_owner/click-teams-page.png" alt="click-teams-page" />
 <img noZoom src="/public/images/features/ingestion/workflows/dbt/ingest_dbt_owner/click-teams-page2.png" alt="click-teams-page" />

**2.** Click on the `Add Team` button

<img noZoom src="/public/images/features/ingestion/workflows/dbt/ingest_dbt_owner/click-add-team.png" alt="click-add-team" />
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/ingest_dbt_owner/add-team-dbt.png" alt="add-team-dbt" />
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/ingest_dbt_owner/linked-user.png" alt="linked-user" />
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/dbt-features/dbt-update-owners.webp" alt="update-dbt-owners" />
