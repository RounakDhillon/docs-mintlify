...
slug: /how-to-guides/guide-for-data-users/ingestion/workflows/dbt/auto-ingest-dbt-core
sidebarTitle: Auto Ingest dbt Core Artifacts
---
...
|-----------|-------------|
| `openmetadata_host_port` | Collate server URL (must start with `https://`) |
...
2. **Configure additional dbt features** like [tags](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-tags), [tiers](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-tier), and [glossary](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/ingest-dbt-glossary)
3. **Set up data governance** policies and workflows
4. **Schedule regular ingestion** for keeping metadata up-to-date

For additional troubleshooting, refer to the [dbt Troubleshooting Guide](/how-to-guides/guide-for-data-users/ingestion/workflows/dbt/dbt-troubleshooting).