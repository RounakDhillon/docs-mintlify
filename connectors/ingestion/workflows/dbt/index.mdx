...
<Card
    icon="party-horn" iconType="solid"
    title="Auto Ingest dbt Artifacts (dbt-core)"
...
| :-------------------------- | :---------------------------------------- |
| Stage                       | PROD                                      |
| dbt Queries                 | <Icon name="check" />              |
| dbt Lineage                 | <Icon name="check" />              |
| dbt Tags                    | <Icon name="check" />              |
| dbt Tiers                   | <Icon name="check" />              |
| dbt Glossary                | <Icon name="check" />              |
| dbt Owner                   | <Icon name="check" />              |
| dbt Descriptions            | <Icon name="check" />              |
| dbt Tests                   | <Icon name="check" />              |
| dbt Exposures               | <Icon name="check" />              |
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/dbt-features/dbt-query.webp" alt="dbt-query" />
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/dbt-features/dbt-lineage.webp" alt="dbt-lineage" />
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/dbt-features/dbt-tags.png" alt="dbt-tags" />
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/dbt-features/dbt-owner.webp" alt="dbt-owner" />
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/dbt-features/dbt-descriptions.webp" alt="dbt-descriptions" />
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/dbt-features/dbt-tests.webp" alt="dbt-tests" />
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/dbt-features/dbt-tier.png" alt="dbt-tiers" />
...
<img noZoom src="/public/images/features/ingestion/workflows/dbt/dbt-features/dbt-glossary.png" alt="dbt-glossary" />
