...
<img src="/images/v1.9/features/ingestion/workflows/lineage/table-entity-page.png" alt="table-entity-page" />
...
<img src="/images/v1.9/features/ingestion/workflows/lineage/add-ingestion.png" alt="add-ingestion" />

### 2. Configure the Lineage Ingestion

Here you can enter the Lineage Ingestion details:

<img src="/images/v1.9/features/ingestion/workflows/lineage/configure-lineage-ingestion.png" alt="configure-lineage-ingestion" />
...
<img src="/images/v1.9/features/ingestion/workflows/lineage/scheule-and-deploy.png" alt="schedule-and-deploy" />
