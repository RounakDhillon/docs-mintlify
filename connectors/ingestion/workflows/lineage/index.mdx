...
<CardGroup cols={1}>
<Card title="Lineage Workflow through Query Logs" href="/connectors/ingestion/workflows/lineage/lineage-workflow-query-logs" >
...
<img noZoom src="/public/images/features/ingestion/workflows/lineage/table-entity-page.png" alt="table-entity-page" />
...
<img noZoom src="/public/images/features/ingestion/workflows/lineage/add-ingestion.png" alt="add-ingestion" />

### 2. Configure the Lineage Ingestion

Here you can enter the Lineage Ingestion details:

<img noZoom src="/public/images/features/ingestion/workflows/lineage/configure-lineage-ingestion.png" alt="configure-lineage-ingestion" />
...
<img noZoom src="/public/images/features/ingestion/workflows/lineage/scheule-and-deploy.png" alt="schedule-and-deploy" />
