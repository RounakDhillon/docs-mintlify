...
<Step title="3. Select the Service Type">
  ...
  <img noZoom src="/public/images/connectors/gcs/select-service.png" alt="Select Service" />
</Step>
...
from.
  ...
  <img noZoom src="/public/images/connectors/gcs/add-new-service.png" alt="Add New Service" />
</Step>
...
desired.
  ...
  <img noZoom src="/public/images/connectors/gcs/service-connection.png" alt="Configure service connection" />
</Step>
