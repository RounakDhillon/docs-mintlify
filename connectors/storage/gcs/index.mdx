...
<Step title="3. Select the Service Type">
  ...
  <img src="/images/v1.9/connectors/gcs/select-service.png" alt="Select Service" />
</Step>
...
from.
  ...
  <img src="/images/v1.9/connectors/gcs/add-new-service.png" alt="Add New Service" />
</Step>
...
desired.
  ...
  <img src="/images/v1.9/connectors/gcs/service-connection.png" alt="Configure service connection" />
</Step>
