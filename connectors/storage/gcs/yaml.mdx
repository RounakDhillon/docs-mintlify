...
<ContentSection id={1} title="gcpConfig:" lines="7-19">
...
<ContentSection id={2} title="Connection Options (Optional)" lines="24-25">
...
<ContentSection id={3} title="Connection Arguments (Optional)" lines="26-27">
