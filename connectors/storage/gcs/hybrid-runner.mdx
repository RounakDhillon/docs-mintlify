---
title: GCS Storage | Collate Cloud Storage Integration (Hybrid Runner)
...
slug: /connectors/storage/gcs/hybrid-runner
...
Configure and schedule GCS metadata workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="GCS Troubleshooting"
    href="/connectors/storage/gcs/troubleshooting">
    Learn more about how to troubleshoot common GCS connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
