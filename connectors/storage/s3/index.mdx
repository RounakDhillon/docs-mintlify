---
title: S3 Storage | Collate Cloud Storage Integration
...
## Metadata Ingestion
<Steps>
<Step title="1. Visit the Services Page">
...
<Step title="2. Create a New Service">
  Click on the 'Add New Service' button to start the Service creation.
  <img noZoom src="/public/images/connectors/create-new-service.png" alt="Create a new service" />
</Step>
<Step title="3. Select the Service Type">
  Select S3 as the service type and click Next.
  <img noZoom src="/public/images/connectors/s3/select-service.png" alt="Select Service" />
</Step>
<Step title="4. Name and Describe your Service">
...
from.
  <img noZoom src="/public/images/connectors/s3/add-new-service.png" alt="Add New Service" />
</Step>
<Step title="5. Configure the Service Connection">
  In this step, we will configure the connection settings required for
this connector. Please follow the instructions below to ensure that
you've configured the connector to read from your S3 service as
desired.
  <img noZoom src="/public/images/connectors/s3/service-connection.png" alt="Configure service connection" />
</Step>
