---
title: ADLS | Official Documentation (Hybrid Runner)
...
slug: /connectors/storage/adls/hybrid-runner
...
Configure and schedule ADLS metadata workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="ADLS Troubleshooting"
    href="/connectors/storage/adls/troubleshooting">
