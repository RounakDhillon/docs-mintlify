...
<ContentSection id={1} title="Azure Configuration" lines="7-12">

<AzureConfigDef />

</ContentSection>

<ContentSection id={2} title="Connection Options (Optional)" lines="13-14">
...
<ContentSection id={3} title="Connection Arguments (Optional)" lines="15-16">
