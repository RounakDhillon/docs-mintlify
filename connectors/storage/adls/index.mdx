...
<Step title="3. Select the Service Type">
  ...
  <img noZoom src="/public/images/connectors/adls/select-service.png" alt="Select Service" />
</Step>
...
from.
  ...
  <img noZoom src="/public/images/connectors/adls/add-new-service.png" alt="Add New Service" />
</Step>
...
desired.
  ...
  <img noZoom src="/public/images/connectors/adls/service-connection.png" alt="Configure service connection" />
</Step>
