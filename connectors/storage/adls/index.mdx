...
To visit the Services page, select Services from the Settings menu.
  ...
  <img src="/images/connectors/visit-services-page.png" alt="Visit Services Page" />
</Step>

<Step title="2. Create a New Service">
  Click on the 'Add New Service' button to start the Service creation.

  <img src="/images/connectors/create-new-service.png" alt="Create a new service" />
</Step>

<Step title="3. Select the Service Type">
  Select ADLS as the service type and click Next.

  <img src="/images/connectors/adls/select-service.png" alt="Select Service" />
</Step>
...
from.
  ...
  <img src="/images/connectors/adls/add-new-service.png" alt="Add New Service" />
</Step>
...
desired.
  ...
  <img src="/images/connectors/adls/service-connection.png" alt="Configure service connection" />
</Step>
