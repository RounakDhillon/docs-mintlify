---
title: Storage Services | Collate Cloud Storage Guide
slug: /connectors/storage
sidebarTitle: Overview
---

import ConnectorsList from '/snippets/connectors/storage/connectors-list.mdx'
...
<img noZoom src="/public/images/connectors/storage/s3-demo.png" alt="s3-demo" />

Then, if we click on the `collate-demo-storage` container, we'll see all the children defined in the manifest.

<img noZoom src="/public/images/connectors/storage/collate-demo-storage.png" alt="s3-demo" />
