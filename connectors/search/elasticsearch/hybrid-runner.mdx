---
title: Elasticsearch Hybrid Runner | Collate Search Services
description: Connect Elasticsearch to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/search/elasticsearch/hybrid-runner
