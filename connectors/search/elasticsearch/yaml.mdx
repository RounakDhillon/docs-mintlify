...
<CodePreview>
<ContentPanel>
<ContentSection id={1} title="hostPort" lines="1-6">
...
<ContentSection id={2} title="Basic Authentication" lines="7-9">
...
<ContentSection id={3} title="API Key Authentication" lines="10-11">
...
<ContentSection id={4} title="sslConfig" lines="12-21">
- **sslConfig**:
...
<ContentSection id={5} title="connectionTimeoutSecs" lines="22">
