...
<IngestionModeTiles yamlPath="/snippets/connectors/search/elasticsearch/yaml" />
...
<MetadataIngestionUi connector={"ElasticSearch"} selectServicePath={"/images/connectors/elasticsearch/select-service.png"} addNewServicePath={"/images/connectors/elasticsearch/add-new-service.png"} serviceConnectionPath={"/images/connectors/elasticsearch/service-connection.png"} />
