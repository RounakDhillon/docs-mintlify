...
<IngestionModeTiles yamlPath="/snippets/connectors/search/opensearch/yaml" />
...
<MetadataIngestionUi connector={"OpenSearch"} selectServicePath={"/images/connectors/opensearch/select-service.png"} addNewServicePath={"/images/connectors/opensearch/add-new-service.png"} serviceConnectionPath={"/images/connectors/opensearch/service-connection.png"} />
