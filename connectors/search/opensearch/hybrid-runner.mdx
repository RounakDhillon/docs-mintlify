---
title: OpenSearch Connector | Collate Search Integration (Hybrid Runner)
description: Connect Collate to OpenSearch with our comprehensive connector guide. Setup instructions, configuration options, and troubleshooting tips included.
slug: /connectors/search/opensearch/hybrid-runner
...
Configure and schedule OpenSearch metadata workflow from the Collate UI:
...
## Metadata Ingestion
<MetadataIngestionUi connector={"OpenSearch"} selectServicePath={"/public/images/connectors/opensearch/select-service.png"} addNewServicePath={"/public/images/connectors/opensearch/add-new-service.png"} serviceConnectionPath={"/public/images/connectors/opensearch/service-connection.png"} />
# Connection Details
<Steps>
...
<Columns cols={2}>
  <Card
    title="OpenSearch Troubleshooting"
    href="/connectors/search/opensearch/troubleshooting">
    Learn more about how to troubleshoot common OpenSearch connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
