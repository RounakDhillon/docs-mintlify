---
title: Google Drive Hybrid Runner | OpenMetadata Drive Integration
description: Connect Google Drive to OpenMetadata using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/drive/googledrive/hybrid-runner
...
Configure and schedule Google Drive metadata and profiler workflows from the Collate UI:
...
<MetadataIngestionUi connector="Google Drive" selectServicePath="/public/images/connectors/googledrive/select-service.png" addNewServicePath="/public/images/connectors/googledrive/add-new-service.png" serviceConnectionPath="/public/images/connectors/googledrive/service-connection.png" />
...
<Columns cols={2}>
  <Card
    ...
    href="/connectors/drive/googledrive/troubleshooting">
