...
<IngestionModeTiles yamlPath="/snippets/connectors/metadata/alationsink/yaml" />
...
<MetadataIngestionUi connector={"AlationSink"} selectServicePath={"/images/connectors/alationsink/select-service.png"} addNewServicePath={"/images/connectors/alationsink/add-new-service.png"} serviceConnectionPath={"/images/connectors/alationsink/service-connection.png"} />
