...
<ContentSection id={3} title="Authentication Type" lines="9-14">
...
<ContentSection id={4} title="Project Name" lines="15">

**projectName**: Project name to create the refreshToken. Can be anything.

</ContentSection>

<ContentSection id={5} title="Pagination Limit" lines="16">

**paginationLimit**: Pagination limit used for Alation APIs pagination

</ContentSection>

<ContentSection id={6} title="Datasource Links" lines="17-20">
...
<ContentSection id={7} title="Source Config" lines="21-23">

Configure the metadata ingestion type as DatabaseMetadata.

</ContentSection>

<ContentSection id={8} title="Sink Configuration" lines="24-26">
