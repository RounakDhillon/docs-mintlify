...
<ContentSection id={2} title="Host Port" lines="8">

**hostPort**: Host and port of the Alation instance.

</ContentSection>

<ContentSection id={3} title="Authentication Type" lines="9-16">
...
<ContentSection id={4} title="Alation Backend Database Connection" lines="17-31">
...
<ContentSection id={14} title="Alation Tag Classification Name" lines="41">
...
<ContentSection id={15} title="Connection Arguments" lines="42-45">
...
<ContentSection id={16} title="Source Config" lines="46-68">
