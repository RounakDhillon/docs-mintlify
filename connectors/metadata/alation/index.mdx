...
<IngestionModeTiles yamlPath="/snippets/connectors/metadata/alation/yaml" />
...
<MetadataIngestionUi connector={"Alation"} selectServicePath={"/images/connectors/alation/select-service.png"} addNewServicePath={"/images/connectors/alation/add-new-service.png"} serviceConnectionPath={"/images/connectors/alation/service-connection.png"} />
