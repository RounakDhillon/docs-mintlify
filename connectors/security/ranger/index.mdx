...
<MetadataIngestionUi connector={"Ranger"} selectServicePath={"/images/connectors/ranger/select-service.png"} addNewServicePath={"/images/connectors/ranger/add-new-service.png"} serviceConnectionPath={"/images/connectors/ranger/service-connection.png"} />
## Troubleshooting
