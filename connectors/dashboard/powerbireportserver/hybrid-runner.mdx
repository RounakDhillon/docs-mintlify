---
title: Run the PowerBI Report Server Hybrid Runner Connector Externally
description: Hybrid Runner - Deploy the ingestion agent in your environment for secure, private network metadata extraction from Power BI Report Server to Collate.
slug: /connectors/dashboard/powerbireportserver/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="PowerBI Report Server Troubleshooting"
    href="/connectors/dashboard/powerbireportserver/troubleshooting">
    Learn more about how to troubleshoot common PowerBI Report Server connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
