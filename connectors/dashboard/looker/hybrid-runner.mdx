---
title: Looker Hybrid Runner | Integrate BI with Collate Docs
description: Hybrid Runner - Deploy the ingestion agent in your environment for secure, private network metadata extraction from Looker dashboards to Collate.
slug: /connectors/dashboard/looker/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="Looker Troubleshooting"
    href="/connectors/dashboard/looker/troubleshooting">
