---
title: Looker Connector | Integrate BI with Collate Docs
description: Connect Looker dashboards to Collate with our comprehensive connector guide. Setup instructions, configuration steps, and metadata extraction tips.
