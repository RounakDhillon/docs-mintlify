...
<MetadataIngestionUi connector={"Looker"} selectServicePath={"/images/connectors/looker/select-service.png"} addNewServicePath={"/images/connectors/looker/add-new-service.png"} serviceConnectionPath={"/images/connectors/looker/service-connection.png"} />
