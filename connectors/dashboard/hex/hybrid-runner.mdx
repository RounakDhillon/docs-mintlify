---
title: Hex Hybrid Runner | OpenMetadata Integration Documentation
description: Connect Hex to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/dashboard/hex/hybrid-runner
...
Configure and schedule Hex metadata and profiler workflows from the Collate UI:
...
<Columns cols={2}>
  <Card
    title="Hex Troubleshooting"
    href="/connectors/dashboard/hex/troubleshooting">
