---
title: Redash Hybrid Runner | Collate Dashboard Integration
description: Connect Redash dashboards to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/dashboard/redash/hybrid-runner
