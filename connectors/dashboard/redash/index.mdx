...
<MetadataIngestionUi connector={"Redash"} selectServicePath={"/images/connectors/redash/select-service.png"} addNewServicePath={"/images/connectors/redash/add-new-service.png"} serviceConnectionPath={"/images/connectors/redash/service-connection.png"} />
