...
<MetadataIngestionUi connector={"ThoughtSpot"} selectServicePath={"/images/connectors/thoughtspot/select-service.png"} addNewServicePath={"/images/connectors/thoughtspot/add-new-service.png"} serviceConnectionPath={"/images/connectors/thoughtspot/service-connection.png"} />
