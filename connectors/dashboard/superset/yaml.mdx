...
description: Configure Collate'sApache Superset connector with YAML. Step-by-step setup guide for dashboard metadata integration and automated discovery.
...
<ContentSection id={3} title="For MySQL Connection:" lines="10">
...
<ContentSection id={4} title="For Postgres Connection:" lines="10">
...
<ContentSection id={5} title="Source Config" lines="27-69">

<SourceConfigDef />

</ContentSection>

<ContentSection id={6} title="Sink Configuration" lines="70-72">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={7} title="Workflow Configuration" lines="73-89">
