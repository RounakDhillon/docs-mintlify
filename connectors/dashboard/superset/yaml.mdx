...
<ContentSection id={2} title="hostPort" lines="4-7">
...
<ContentSection id={3} title="For MySQL Connection:" lines="7-11">
...
<ContentSection id={4} title="For Postgres Connection:" lines="11">
