...
<MetadataIngestionUi connector={"Superset"} selectServicePath={"/images/connectors/superset/select-service.png"} addNewServicePath={"/images/connectors/superset/add-new-service.png"} serviceConnectionPath={"/images/connectors/superset/service-connection.png"} />
...
1. To establish secure connections between OpenMetadata and Superset, navigate to the `Advanced Config` section. We need to update the `Certificate Path` and ensure that the certificates are accessible from the Airflow Server.
  ...
  <img src="/images/v1.9/connectors/ssl_superset.png" alt="Supertset API SSL Configuration" height="450px" />
...
<img src="/images/v1.9/connectors/ssl_superset_mysql.png" alt="MySQL SSL Configuration" height="450px" />
...
<img src="/images/v1.9/connectors/ssl_superset_postgres.png" alt="Postgres SSL Configuration" height="450px" />
