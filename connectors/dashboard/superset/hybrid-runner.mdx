---
title: Superset Hybrid Runner | Collate Dashboard Integration
description: Learn how to connect Apache Superset dashboards to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/dashboard/superset/hybrid-runner
...
<Step title="For Postgres Connection">
...
<Columns cols={2}>
  <Card
    ...
    href="/connectors/dashboard/superset/troubleshooting">
