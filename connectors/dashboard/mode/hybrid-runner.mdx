---
title: Mode Hybrid Runner | Collate Dashboard Integration Guide
description: Hybrid Runner - Deploy the ingestion agent in your environment for secure, private network metadata extraction from Mode Analytics dashboards to Collate.
slug: /connectors/dashboard/mode/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="Mode Troubleshooting"
    href="/connectors/dashboard/mode/troubleshooting">
    Learn more about how to troubleshoot common Mode connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
