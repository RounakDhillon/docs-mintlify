...
<MetadataIngestionUi connector={"QlikCloud"} selectServicePath={"/images/connectors/qlikcloud/select-service.png"} addNewServicePath={"/images/connectors/qlikcloud/add-new-service.png"} serviceConnectionPath={"/images/connectors/qlikcloud/service-connection.png"} />
