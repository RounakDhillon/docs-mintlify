---
title: Tableau Hybrid Runner | Collate Integration Guide
description: Connect Tableau dashboards to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/dashboard/tableau/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="Tableau Troubleshooting"
    href="/connectors/dashboard/tableau/troubleshooting">
