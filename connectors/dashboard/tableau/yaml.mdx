...
<ContentSection id={1} title="Source Configuration" lines="2-5">

Configure the source type and service name for your Tableau connector.

</ContentSection>

<ContentSection id={2} title="Authentication" lines="6-11">
...
<ContentSection id={3} title="Host Port" lines="12">

**hostPort**: URL or IP address of your installation of Tableau Server.

</ContentSection>

<ContentSection id={4} title="Site Name" lines="13">
...
<ContentSection id={5} title="Pagination Limit" lines="14">
...
<ContentSection id={6} title="SSL Configuration" lines="15-29">
...
<ContentSection id={7} title="Source Config" lines="30-31">
...
<ContentSection id={8} title="Sink Configuration" lines="32-33">

To send the metadata to OpenMetadata, it needs to be specified as `type: metadata-rest`.

</ContentSection>

<ContentSection id={9} title="Workflow Configuration" lines="34-38">
