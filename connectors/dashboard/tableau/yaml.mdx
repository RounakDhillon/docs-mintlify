...
<ContentSection id={6} title="SSL Configuration" lines="16-18">
...
<ContentSection id={8} title="Sink Configuration" lines="74-76">

To send the metadata to OpenMetadata, it needs to be specified as `type: metadata-rest`.

</ContentSection>

<ContentSection id={9} title="Workflow Configuration" lines="77-93">
