...
<ContentSection id={3} title="displayUrl" lines="7">
...
<ContentSection id={4} title="clientCertificate" lines="8-11">
...
<ContentSection id={5} title="Client Certificate Value" lines="12-16">
...
<ContentSection id={6} title="userId" lines="17">
**userId**: This field specifies the user directory of the user.
</ContentSection>
<ContentSection id={7} title="userDirectory" lines="18">
**userDirectory**: This field specifies the user directory of the user.
</ContentSection>
<ContentSection id={8} title="validateHostName" lines="19">
