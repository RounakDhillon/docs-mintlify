...
<Card
    ...
    title="OpenMetadata 1.1.1 or later"
    href="/deployment"
  >
...
<MetadataIngestionUi connector={"QlikSense"} selectServicePath={"/images/connectors/qliksense/select-service.png"} addNewServicePath={"/images/connectors/qliksense/add-new-service.png"} serviceConnectionPath={"/images/connectors/qliksense/service-connection.png"} />
...
<img src="/images/connectors/ssl_qlik_1.png" alt="SSL Configuration by local file path" height="450px" />

  <img src="/images/connectors/ssl_qlik_2.png" alt="SSL Configuration" height="450px" />
