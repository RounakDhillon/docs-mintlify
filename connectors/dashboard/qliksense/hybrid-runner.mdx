---
title: Qlik Sense Hybrid Runner | Collate Integration Guide
description: Connect QlikSense dashboards to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/dashboard/qliksense/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="Qlik Sense Troubleshooting"
    href="/connectors/dashboard/qliksense/troubleshooting">
    Learn more about how to troubleshoot common Qlik Sense connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
