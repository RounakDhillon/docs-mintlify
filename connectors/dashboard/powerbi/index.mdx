---
title: PowerBI Connector | Collate Integration Documentation
description: Connect Power BI to Collate with our comprehensive dashboard connector guide. Setup instructions, configuration tips, and metadata extraction made simple.
...
<iframe width="800" height="450" src="https://www.youtube.com/embed/Ul8PLcNENcw" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
...
While configuring PowerBI ingestion, you can choose whether to use the PowerBI Admin APIs or the PowerBI Non-Admin APIs to retrieve metadata. See below for the difference in their functionality:
...
<Columns cols={2}>
  <Card
    title="PowerBI Troubleshooting"
    href="/connectors/dashboard/powerbi/troubleshooting">
    Learn more about how to troubleshoot common PowerBI connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
