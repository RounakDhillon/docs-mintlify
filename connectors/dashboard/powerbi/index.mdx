...
<MetadataIngestionUi connector={"PowerBI"} selectServicePath={"/images/connectors/powerbi/select-service.png"} addNewServicePath={"/images/connectors/powerbi/add-new-service.png"} serviceConnectionPath={"/images/connectors/powerbi/service-connection.png"} />
