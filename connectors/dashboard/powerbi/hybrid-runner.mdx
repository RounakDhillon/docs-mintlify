---
title: PowerBI Hybrid Runner | Collate Integration Documentation
description: Hybrid Runner - Deploy the ingestion agent in your environment for secure, private network metadata extraction from Power BI dashboards to Collate.
slug: /connectors/dashboard/powerbi/hybrid-runner
...
While configuring the PowerBI ingestion you can choose whether to use the PowerBI Admin APIs to retrieve the metadata or use the PowerBI Non-Admin APIs. Please check below for the difference in their functionality:
