...
sidebarTitle: Lineage from pbit files
---
...
<img src="/public/images/connectors/powerbi/pbit-file-source.png" alt="pbit-file-sources" />

 ### Run Externally

Choose one of the configs for local, azure, s3 and gcs by modifying `pbitFilesSource` from below yaml and run the connector by following steps [here](/connectors/dashboard/powerbi/hybrid-runner).
