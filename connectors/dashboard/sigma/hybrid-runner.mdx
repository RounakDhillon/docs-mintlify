---
title: Sigma Hybrid Runner | Collate Dashboard Integration Guide
description: Connect Sigma Analytics to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/dashboard/sigma/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="Sigma Troubleshooting"
    href="/connectors/dashboard/sigma/troubleshooting">
    Learn more about how to troubleshoot common Sigma connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
