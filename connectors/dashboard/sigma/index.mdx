...
<MetadataIngestionUi connector={"Sigma"} selectServicePath={"/images/connectors/sigma/select-service.png"} addNewServicePath={"/images/connectors/sigma/add-new-service.png"} serviceConnectionPath={"/images/connectors/sigma/service-connection.png"} />
