...
<MetadataIngestionUi connector={"QuickSight"} selectServicePath={"/images/connectors/quicksight/select-service.png"} addNewServicePath={"/images/connectors/quicksight/add-new-service.png"} serviceConnectionPath={"/images/connectors/quicksight/service-connection.png"} />
