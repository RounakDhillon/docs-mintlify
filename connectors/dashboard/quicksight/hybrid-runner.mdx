---
title: QuickSight Hybrid Runner | Collate Dashboard Integration
description: Connect Amazon QuickSight to Collate using the Hybrid Runner. Deploy the ingestion agent in your environment for secure, private network metadata extraction.
slug: /connectors/dashboard/quicksight/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="QuickSight Troubleshooting"
    href="/connectors/dashboard/quicksight/troubleshooting">
    Learn more about how to troubleshoot common QuickSight connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
