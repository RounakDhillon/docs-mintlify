---
title: Metabase Hybrid Runner | Collate Dashboard Integration
description: Hybrid Runner - Deploy the ingestion agent in your environment for secure, private network metadata extraction from Metabase dashboards to Collate.
slug: /connectors/dashboard/metabase/hybrid-runner
