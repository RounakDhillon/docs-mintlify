...
<MetadataIngestionUi connector={"Metabase"} selectServicePath={"/images/connectors/metabase/select-service.png"} addNewServicePath={"/images/connectors/metabase/add-new-service.png"} serviceConnectionPath={"/images/connectors/metabase/service-connection.png"} />
