---
title: Lightdash Hybrid Runner | Collate Dashboard Integration
description: Hybrid Runner - Deploy the ingestion agent in your environment for secure, private network metadata extraction from Lightdash dashboards to Collate.
slug: /connectors/dashboard/lightdash/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="Lightdash Troubleshooting"
    href="/connectors/dashboard/lightdash/troubleshooting">
    Learn more about how to troubleshoot common Lightdash connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
