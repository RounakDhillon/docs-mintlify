---
title: MicroStrategy Hybrid Runner | Collate Integration Guide
description: Hybrid Runner - Deploy the ingestion agent in your environment for secure, private network metadata extraction from MicroStrategy dashboards to Collate.
slug: /connectors/dashboard/microstrategy/hybrid-runner
...
<Columns cols={2}>
  <Card
    title="MicroStrategy Troubleshooting"
    href="/connectors/dashboard/microstrategy/troubleshooting">
    Learn more about how to troubleshoot common MicroStrategy connector issues and resolve configuration or ingestion errors.
  </Card>
</Columns>
